...
var R$1 = /^[_a-zA-Z][_a-zA-Z0-9]*$/, P$1 = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return __extends(n, e), n.prototype.$ = function(t, e, r) {
 ...
 */ function B$1(t) {
    ...
    return new V$1(e.seconds, e.nanos);
}
...
function Y$1(t, e) {
    ...
    var n = X$1(t), r = X$1(e), i = Se(n.seconds, r.seconds);
...
e) {
    ...
    return __extends(n, e), n.prototype.at = function(t, e) {
        ...
        return this.Et(t), this.Rt.Tt(t) ? new Dt(this.key, k$1.min()) : t;
    }, n.prototype.Pt = function(t) {
        return null;
    }, n.prototype.isEqual = function(t) {
 ...
 */ var ie = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, ae.fs(e, n)), new t(k$1.min(), r, re(), Kt(), ee());
    }, t;
}(), ae = /** @class */ function() {
    function t(
    /**
 ...
 */ var ve = {
    ...
    /** Creates an api.Document from key and fields (but no create/update time) */ t.prototype.Ri = function(t, e) {
        ...
        if ("targetChange" in t) {
            ...
            d.document;
            var y = this.Z(d.document), v = d.readTime ? this.fromVersion(d.readTime) : k$1.min(), m = new Dt(y, v), g = d.removedTargetIds || [];
            e = new he([], g, m.key, m);
    ...
    t.prototype.Mn = function(t, e) {
        ...
        return this.Dn.xn(t, e).next((function(r) {
            ...
            return i.forEach((function(t, e) {
                ...
                e || (e = new Dt(t, k$1.min())), o = o.me(t, e);
            })), o;
        }));
    }, 
    /**
...
var $e = /** @class */ function() {
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this._h = k$1.min(), this.Dn = t.fh(n), this.dh = t.wh(), this.Th = t.Eh(), this.Ih = new Ce(this.dh, this.Dn, this.persistence.Rh()), 
        this.ah.mh(this.Ih)
    ...
    /* Accept locally generated Mutations and commit them to storage. */ t.prototype.gh = function(t) {
        var e, n = this, r = V$1.now(), i = t.reduce((function(t, e) {
            return t.add(e.key);
        }), ee());
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            u.push(s.getEntries(o, h).next((function(t) {
                e.cs.forEach((function(i, h) {
                    ...
                    // cache.
                                        h instanceof Dt && h.version.isEqual(k$1.min()) ? (
    ...
    t.prototype.ao = function(t, e) {
        ...
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.no(o, t.ee()).next((function(t) {
                ...
                return n.ah.Bn(o, t, e ? r : k$1.min(), e ? i : ee());
            })).next((function(t) {
                return {
                    documents: t,
                    co: i
...
var Ze = /** @class */ function() {
    ...
    return t.do = function(t, e) {
        return O$1.N(t.key, e.key) || Se(t.po, e.po);
    }, 
    /** Compare by ID then by key */ t.To = function(t, e) {
        return Se(t.po, e.po) || O$1.N(t.key, e.key);
    }, t;
}();
...
function Gn(t, e) {
    ...
    return function(t, e) {
        ...
        if (t instanceof V$1) {
            ...
            var r = new V$1(t.seconds, 1e3 * Math.floor(t.nanoseconds / 1e3));
            return {
...
function Qn(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof V$1 || t instanceof Ln || t instanceof Nn || t instanceof Mn || t instanceof Dn);
}
 ...
 */ var Xn = /** @class */ function() {
    ...
    return __extends(n, e), n.prototype.ma = function(t) {
...
n) {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.Fc.tc(t, "rejected", r), e = this.Mc.get(t), (i = e && e.key) ? (o = (o = new Gt(O$1.N)).me(i, new Dt(i, k$1.min())), 
                    s = ee().add(i), u = new ue(k$1.min(), 
    ...
    return t.prototype.mh = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.te() || n.isEqual(k$1.min()) ? this.pl(t, e) : this.Vl.qn(t, r).next((function(o) {
            var u = i.yl(e, o);
    ...
    return t.prototype.vl = function(t) {
        ...
        // because it precedes all other segments in an ordered traversal.
                O$1.et(i) || (i = i.child(""));
        var o = new tn(new O$1(i), 0), s = new Wt(Se);
...
var Dr = /** @class */ function() {
    ...
    return t.prototype.j_ = function(t) {
        ...
        var e = X$1(t), n = new V$1(e.seconds, e.nanos);
    ...
    function t(t) {
        ...
        hn("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Xe.hh; else {
            if (t.cacheSizeBytes !== Vr && t.cacheSizeBytes < Xe.rh) throw new I$1(E$1.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Xe.rh);
 ...
 */        if (!n || "string" != typeof n) throw new I$1(E$1.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        return this.tf(), new Mr(new St(U$1.H, t), this, 
        /* converter= */ null);
    ...
    return __extends(n, e), n.prototype.where = function(t, e, r) {
        ...
        void 0 === e || "asc" === e) r = "asc" /* ASCENDING */; else {
            if ("desc" !== e) throw new I$1(E$1.INVALID_ARGUMENT, "Function Query.orderBy() has unknown direction '" + e + "', expected 'asc' or 'desc'.");
            r = "desc" /* DESCENDING */;
        }
    ...
    /** Helper function to create a bound from a document or fields */ n.prototype.Mf = function(t, e, n, i) {
        if (yn(t, 1, e), e instanceof Lr) return nn(t, __spreadArrays([ e ], n), 1), this.Lf(t, e.yf, i);
        var o = [ e ].concat(n);
    ...
    return t.prototype.Sf = function(t, e, n) {
        var r;
        if (t.Y()) {
            if ("array-contains" /* ARRAY_CONTAINS */ === e || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e) throw new I$1(E$1.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + e + "' queries on FieldPath.documentId().");
            if ("in" /* IN */ === e) {
                this.Cf(n, e);
    ...
    t.prototype.Lf = function(t, e, n) {
        if (!e) throw new I$1(E$1.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + t + "().");
        ...
        for (var r = [], i = 0, o = this.vf.orderBy; i < o.length; i++) {
            var s = o[i];
            if (s.field.Y()) r.push(Z$1(this.xo, e.key)); else {
                var u = e.field(s.field);
                if (j(u)) throw new I$1(E$1.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + s.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === u) {
                    var a = s.field.j();
                    throw new I$1(E$1.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + a + "' (used as the orderBy) does not exist.");
                }
                r.push(u);
            }
        }
    ...
    t.prototype.Df = function(t) {
        if ("string" == typeof t) {
            ...
            return Z$1(this.xo, new O$1(e));
        }
        if (t instanceof Mn) return Z$1(this.xo, t.Bo);
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        if (e && this.Bf.hs) throw new I$1(E$1.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, St.Wt(t), n, r) || this).jf = t, t.length % 2 != 1) throw new I$1(E$1.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.j() + " has " + t.length);
        return i;
    }
...
var Hr = Wr(Sr, "Use firebase.firestore() instead."), Yr = Wr(Ur, "Use firebase.firestore().runTransaction() instead."), Kr = Wr(Rr, "Use firebase.firestore().batch() instead."), Xr = Wr(Pr, "Use firebase.firestore().doc() instead."), $r = Wr(Lr), Jr = Wr(qr), Zr = Wr(Mr), ti = Wr(Cr), ei = Wr(Fr, "Use firebase.firestore().collection() instead."), ni = Wr(Pn, "Use FieldValue.<field>() instead."), ri = Wr(Nn, "Use Blob.fromUint8Array() or Blob.fromBase64String() instead."), ii = {
     ...
     */    return t.prototype.ud = function(t, e) {
        ...
        var n = [ this.ad, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], i = esm_1(), o = {
        ...
        return N(esm_4.EventType.OPEN, (function() {
            ...
            }("Connection", "WebChannel transport errored:", t), b.hd(new I$1(E$1.UNAVAILABLE, "The operation could not be completed")));
