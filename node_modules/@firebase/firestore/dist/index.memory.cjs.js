...
var h = {
    ...
    return t.prototype.getToken = function() {
        var t = this, e = this.m, n = this.forceRefresh;
        ...
        // request is outstanding.
            ...
            return t.m !== e ? (fe("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (ye("string" == typeof n.accessToken), new f(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.A = function() {
        ...
        return ye(null === t || "string" == typeof t), new a(t);
    }, t;
}(), d = /** @class */ function() {
    function t(t, e) {
    ...
    return t.now = function() {
        ...
        return this.seconds === t.seconds ? ge(this.nanoseconds, t.nanoseconds) : ge(this.seconds, t.seconds);
    }, t.prototype.isEqual = function(t) {
...
var b = /^[_a-zA-Z][_a-zA-Z0-9]*$/, _ = /** @class */ function(t) {
    function n() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return e.__extends(n, t), n.prototype.$ = function(t, e, r) {
...
/** Extracts the backend's type order for the provided value. */ function R(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? k(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : de();
}
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function L(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return we(t.arrayValue.values || [], e.arrayValue.values || [], L);
...
function O(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = ge(x(t.latitude), x(e.latitude));
            return 0 !== n ? n : ge(x(t.longitude), x(e.longitude));
...
function q(t, e) {
    if ("string" == typeof t && "string" == typeof e && t.length === e.length) return ge(t, e);
    var n = C(t), r = C(e), i = ge(n.seconds, r.seconds);
    return 0 !== i ? i : ge(n.nanos, r.nanos);
}
...
/** Returns true if `value` is an IntegerValue . */ function B(t) {
 ...
 * limitations under the License.
 */
/** Transforms a value into a server-generated timestamp. */ var H = /** @class */ function() {
    function t() {}
...
var Y = /** @class */ function() {
    ...
    return t.prototype.ot = function(t, e) {
        ...
        return e instanceof t && we(this.elements, e.elements, L);
    }, t;
}(), K = /** @class */ function() {
    function t(t) {
        this.elements = t;
    ...
    return t.prototype.ot = function(t, e) {
        ...
        return B(n) && B(this.ct) ? this.serializer.lt(r) : this.serializer._t(r);
    }, t.prototype.at = function(t, e) {
        return e;
    }, 
    /**
 ...
 */ var J = /** @class */ function() {
    ...
    return t.prototype.ft = function(t) {
        ...
        return we(this.fields, t.fields, (function(t, e) {
            return t.isEqual(e);
        }));
    }, t;
}(), Z = /** @class */ function() {
...
e) {
    ...
    return e.__extends(n, t), n.prototype.at = function(t, e) {
        ...
        return t instanceof n && this.key.isEqual(t.key) && we(this.fieldTransforms, t.fieldTransforms, (function(t, e) {
            return t.isEqual(e);
    ...
    return e.__extends(n, t), n.prototype.at = function(t, e) {
        ...
        return this.Et(t), this.Rt.Tt(t) ? new yt(this.key, m.min()) : t;
    }, n.prototype.Pt = function(t) {
        return null;
    }, n.prototype.isEqual = function(t) {
...
var ft, lt, pt = function(t, e) {
    ...
    // in the Lite client become tree-shakeable.
        ...
        get: function() {
            if (null === this.Bt) {
                ...
                t.Y() || this.Bt.push(new Tt(t)), this.Bt.push(new Tt(_.X(), "asc" /* ASCENDING */)); else {
     ...
     */    return e.__extends(n, t), n.create = function(t, e, r) {
        ...
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new Et(t, r) : "in" /* IN */ === e ? new It(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Nt(t, r) : new n(t, e, r);
    }, n.prototype.matches = function(t) {
        var e = t.field(this.field);
        // Only compare types with matching backend order (such as double and int).
                return null !== e && R(this.value) === R(e) && this.fe(O(e, this.value));
        ...
        return this.field.j() + this.op.toString() + M(this.value);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n && this.op === t.op && this.field.isEqual(t.field) && L(this.value, t.value);
    }, n.prototype.toString = function() {
        return this.field.j() + " " + this.op + " " + M(this.value);
    }, n;
    ...
    t.prototype._e = function(t, e) {
        for (var n = 0, r = 0; r < this.position.length; r++) {
            ...
            if (n = i.field.Y() ? E.N(E.Z(o.referenceValue), e.key) : O(o, e.field(i.field)), 
     ...
     */ , s) {
        void 0 === i && (i = m.min()), void 0 === o && (o = m.min()), void 0 === s && (s = T.ht), 
 ...
 */ function St(t) {
    ...
    return le("GRPC error has no .code"), h.UNKNOWN;
    switch (t) {
      case ft.OK:
        return h.OK;
...
var Ut = /** @class */ function() {
    ...
    // Returns a copy of the map, with the specified key/value added or replaced.
        ...
        return new t(this.N, this.root.me(e, n, this.N).Ae(null, null, Lt.Pe, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.N, this.root.remove(e, this.N).Ae(null, null, Lt.Pe, null, null));
    }, 
    ...
    t.prototype.be = function() {
        return new Rt(this.root, null, this.N, !1);
    }, t.prototype.ve = function(t) {
        return new Rt(this.root, t, this.N, !1);
    }, t.prototype.Se = function() {
        return new Rt(this.root, null, this.N, !0);
    }, t.prototype.Ce = function(t) {
        return new Rt(this.root, t, this.N, !0);
    }, t;
}(), Rt = /** @class */ function() {
    function t(t, e, n, r) {
        this.De = r, this.Fe = [];
    ...
    t.prototype.me = function(t, e, n) {
        ...
        return (r = i < 0 ? r.Ae(null, null, null, r.left.me(t, e, n), null) : 0 === i ? r.Ae(null, e, null, null, null) : r.Ae(null, null, null, null, r.right.me(t, e, n))).Oe();
...
var Pt = /** @class */ function() {
    ...
    /** Finds the least element greater than or equal to `elem`. */ t.prototype.Ke = function(t) {
        ...
        return new Ot(this.data.be());
    }, t.prototype.ve = function(t) {
        return new Ot(this.data.ve(t));
    }, 
...
var jt = new Ut(E.N), Bt = new Pt(E.N);
 ...
 */ var Wt = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.Xe = Ft(), this.Je = new Ut(this.N)
        /**
    ...
    return t.prototype.track = function(t) {
        ...
        0 /* Added */ !== t.type && 3 /* Metadata */ === n.type ? this.ts = this.ts.me(e, t) : 3 /* Metadata */ === t.type && 1 /* Removed */ !== n.type ? this.ts = this.ts.me(e, {
            type: n.type,
            doc: t.doc
        }) : 2 /* Modified */ === t.type && 2 /* Modified */ === n.type ? this.ts = this.ts.me(e, {
            type: 2 /* Modified */ ,
            doc: t.doc
        }) : 2 /* Modified */ === t.type && 0 /* Added */ === n.type ? this.ts = this.ts.me(e, {
            type: 0 /* Added */ ,
            doc: t.doc
        }) : 1 /* Removed */ === t.type && 0 /* Added */ === n.type ? this.ts = this.ts.remove(e) : 1 /* Removed */ === t.type && 2 /* Modified */ === n.type ? this.ts = this.ts.me(e, {
            type: 1 /* Removed */ ,
            doc: n.doc
        }) : 0 /* Added */ === t.type && 1 /* Removed */ === n.type ? this.ts = this.ts.me(e, {
            type: 2 /* Modified */ ,
            doc: t.doc
        }) : 
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, Xt.fs(e, n)), new t(m.min(), r, Qt(), Mt(), Gt());
    }, t;
}(), Xt = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = T.ht), void 0 === r && (r = null), this.state = t, this.targetIds = e, 
    ...
    t.prototype.Ss = function() {
        ...
        })), new Xt(this.Vs, this.ps, t, e, n);
    }, 
    /**
     * Resets the document changes and sets `hasPendingChanges` to false.
     */
    t.prototype.Cs = function() {
        this.ys = !1, this.Ps = re();
    ...
    return t.prototype.Bs = function(t) {
        for (var e = 0, n = t.Is; e < n.length; e++) {
            var r = n[e];
            t.Rs instanceof dt ? this.Us(r, t.Rs) : t.Rs instanceof yt && this.Qs(r, t.key, t.Rs);
        }
    ...
    t.prototype.zs = function(t) {
        var e = t.targetId, n = t.ms.count, r = this.Ys(e);
        if (r) {
            var i = r.target;
            if (i.qt()) if (0 === n) {
    ...
    t.prototype.Js = function(t) {
        ...
        var i = new Kt(t, n, this.xs, this.qs, r);
        return this.qs = Mt(), this.Ms = ne(), this.xs = new Pt(ge), i;
    }, 
    /**
    ...
    t.prototype.Us = function(t, e) {
        if (this.Hs(t)) {
            ...
            this.Gs(t).Ds(e.key, n), this.qs = this.qs.me(e.key, e), this.Ms = this.Ms.me(e.key, this.ti(e.key).add(t));
        }
    }, 
    /**
    ...
    t.prototype.Qs = function(t, e, n) {
        if (this.Hs(t)) {
            ...
            r.Fs(e), this.Ms = this.Ms.me(e, this.ti(e).delete(t)), n && (this.qs = this.qs.me(e, n));
        }
    ...
    t.prototype.Ns = function(t) {
        ...
        var e = this.ks.get(t);
        return e || (e = new te, this.ks.set(t, e)), e;
    }, t.prototype.ti = function(t) {
        var e = this.Ms.get(t);
        return e || (e = new Pt(ge), this.Ms = this.Ms.me(t, e)), e;
    }, 
    /**
    ...
    t.prototype.Hs = function(t) {
        ...
        return e || fe("WatchChangeAggregator", "Detected inactive target", t), e;
    }, 
    /**
    ...
    t.prototype.Ks = function(t) {
        var e = this;
        this.ks.set(t, new te), this.Os.ei(t).forEach((function(n) {
 ...
 */ var ie = {
    ...
    return t.prototype.ni = function(t) {
        var e = void 0 === t.code ? h.UNKNOWN : St(t.code);
    ...
    t.prototype.ci = function(t) {
        return this.options.hi ? (ye(void 0 === t || "string" == typeof t), T.fromBase64String(t || "")) : (ye(void 0 === t || t instanceof Uint8Array), 
        T.fromUint8Array(t || new Uint8Array));
    }, t.prototype.toVersion = function(t) {
        return this.D(t.D());
    }, t.prototype.fromVersion = function(t) {
        return ye(!!t), m.v(this.v(t));
        ...
        // in the local target cache.
                return 4 === e.length ? w.H : this.wi(e);
    ...
    /** Creates an api.Document from key and fields (but no create/update time) */ t.prototype.Ri = function(t, e) {
        ...
        if ("targetChange" in t) {
            ...
            t.documentRemove;
            var b = t.documentRemove;
            b.document;
            var _ = this.Z(b.document), E = b.removedTargetIds || [];
            e = new $t([], E, _, null);
        } else {
            ...
            var I = t.filter;
            I.targetId;
            var N = I.count || 0, A = new Vt(N), T = I.targetId;
            e = new Jt(T, A);
        }
        return e;
        ...
        if (t.transform) {
            ...
            return ye(!0 === n.exists), new ot(u, a);
        }
        if (t.verify) {
        ...
        var n = this;
        return t && t.length > 0 ? (ye(void 0 !== e), t.map((function(t) {
            return n.Oi(t, e);
        }))) : [];
    }, t.prototype.Ci = function(t) {
        var e = t.transform;
        ...
        var e = null;
        if ("setToServerValue" in t) ye("REQUEST_TIME" === t.setToServerValue), e = H.instance; else if ("appendMissingElements" in t) {
            var n = t.appendMissingElements.values || [];
            e = new Y(n);
        } else if ("removeAllFromArray" in t) {
            var r = t.removeAllFromArray.values || [];
            e = new K(r);
        } else "increment" in t ? e = new X(this, t.increment) : de();
        var i = _.J(t.fieldPath);
        return new Z(i, e);
        ...
        if (0 !== t.length) {
            var n = t.map((function(t) {
                return t instanceof wt ? e.Yi(t) : de();
            }));
    ...
    t.prototype.Zi = function(t) {
        ...
        return new Tt(this.on(t.field), this.sn(t.direction));
    }, t.prototype.Ji = function(t) {
 ...
 */ var me = /** @class */ function() {
    ...
    return t.cn = function() {
        ...
        ; n.length < 20; ) for (var r = ae.nt().ln(40), i = 0; i < r.length; ++i) 
...
/** Helper to compare arrays using isEqual(). */ function we(t, e, n) {
...
function(t, e, n, r, i) {
    ...
    return Object.defineProperty(t.prototype, "_n", {
        ...
        return ge(this.projectId, t.projectId) || ge(this.database, t.database);
    }, t;
}(), Ee = /** @class */ function() {
    function t(t) {
        this.fn = t, 
    ...
    t.prototype.En = function(t) {
        ...
        return this.batchId === t.batchId && we(this.mutations, t.mutations, (function(t, e) {
            return t.isEqual(e);
        })) && we(this.baseMutations, t.baseMutations, (function(t, e) {
            return t.isEqual(e);
        }));
    }, t;
}(), Ne = /** @class */ function() {
    ...
    return t.from = function(e, n, r) {
        ...
        for (var i = jt, o = e.mutations, s = 0; s < o.length; s++) i = i.me(o[s].key, r[s].version);
    ...
    t.prototype.Mn = function(t, e) {
        ...
        return this.Dn.xn(t, e).next((function(r) {
            var i = n.kn(t, e, r), o = Mt();
            return i.forEach((function(t, e) {
                // TODO(http://b/32275378): Don't conflate missing / deleted.
                e || (e = new yt(t, m.min())), o = o.me(t, e);
            })), o;
        }));
    }, 
    /**
    ...
    t.prototype.Bn = function(t, e, n) {
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Hn(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    ...
                    r = f instanceof dt ? r.me(h, f) : r.remove(h);
                }
            }));
        })).next((function() {
        ...
        return this.Cn.getEntries(t, r).next((function(t) {
            return t.forEach((function(t, e) {
                null !== e && e instanceof dt && (h = h.me(t, e));
            })), h;
        }));
    }, t;
}(), De = /** @class */ function() {
...
/** Represents the database ID a Firestore client is associated with. */ Ve.er = -1;
...
var ke = function() {
    ...
    t.prototype.lr = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && fe("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.or + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
    ...
    return t.prototype.Ir = function(t, e) {
        return this.Er.add(e), Ae.resolve();
    }, t.prototype.jn = function(t, e) {
        return Ae.resolve(this.Er.getEntries(e));
    }, t;
}(), Re = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.q(), n = t.O(), r = this.index[e] || new Pt(w.N), i = !r.has(n);
 ...
 * limitations under the License.
 */
/** Verifies whether `e` is an IndexedDbTransactionError. */ function Pe(t) {
 ...
 */ var Oe = /** @class */ function() {
    function t(t, e, n, r, i) {
        this.Pr = t, this.ir = e, this.Vr = n, this.op = r, this.pr = i, this.yr = new ke, 
    ...
    t.prototype.cancel = function(t) {
        null !== this.br && (this.clearTimeout(), this.yr.reject(new c(h.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    function t() {
        ...
        this.kr = new Se(this, "async_queue_retry" /* AsyncQueueRetry */), 
    ...
    t.prototype.Wr = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.Br(), this.Fr ? [ 3 /*break*/ , 2 ] : (this.Fr = !0, (n = ae.nt().window) && n.removeEventListener("visibilitychange", this.qr), 
                    [ 4 /*yield*/ , this.Qr(t) ]);
    ...
    t.prototype.jr = function(t) {
                ...
                return e.__awaiter(n, void 0, void 0, (function() {
                    ...
                    return e.__generator(this, (function(e) {
                        switch (e.label) {
                          ...
                          case 1:
                            return e.sent(), r.resolve(), this.kr.reset(), [ 3 /*break*/ , 3 ];

                          case 2:
                            if (!Pe(n = e.sent())) throw r.resolve(), n;
                            // Failure will be handled by AsyncQueue
                                                        return fe("AsyncQueue", "Operation failed with retryable error: " + n), 
                            this.kr.lr(i), [ 3 /*break*/ , 3 ];
        ...
        var e = this, n = this.Cr.then((function() {
            return e.Lr = !0, t().catch((function(t) {
                ...
                throw e.$r = t, e.Lr = !1, le("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
    ...
    t.prototype.dr = function(t, e, n) {
        ...
        var i = Oe.gr(this, t, e, n, (function(t) {
            return r.Gr(t);
        }));
 ...
 */
function Me(t, e) {
    if (le("AsyncQueue", e + ": " + t), Pe(t)) return new c(h.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
Ce.nh = -1, Ce.rh = 1048576, Ce.hh = 41943040, Ce.sh = 10, Ce.ih = 1e3, Ce.oh = new Ce(Ce.hh, Ce.sh, Ce.ih), 
Ce.DISABLED = new Ce(Ce.nh, 0, 0);
...
var xe = /** @class */ function() {
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this._h = m.min(), this.Dn = t.fh(n), this.dh = t.wh(), this.Th = t.Eh(), this.Ih = new Te(this.dh, this.Dn, this.persistence.Rh()), 
        this.ah.mh(this.Ih)
    ...
    t.prototype.Ah = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return n = this.Dn, r = this.Ih, [ 4 /*yield*/ , this.persistence.runTransaction("Handle user change", "readonly", (function(e) {
                        // Swap out the mutation queue, grabbing the pending mutation batches
                        // before and after.
                        var i;
                        return o.Dn.Ph(e).next((function(s) {
                            return i = s, n = o.persistence.fh(t), 
                            // Recreate our LocalDocumentsView using the new
                            // MutationQueue.
                            r = new Te(o.dh, n, o.persistence.Rh()), n.Ph(e);
                        })).next((function(t) {
                  ...
                  case 1:
                    return i = e.sent(), [ 2 /*return*/ , (this.Dn = n, this.Ih = r, this.ah.mh(this.Ih), 
                    i) ];
                }
            }));
        }));
    ...
    t.prototype.$h = function(t) {
        ...
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", (function(n) {
            ...
            return e.Dn.Lh(n, t).next((function(t) {
                return ye(null !== t), r = t.keys(), e.Dn.Oh(n, t);
            })).next((function() {
                return e.Dn.Nh(n);
            })).next((function() {
                return e.Ih.qn(n, r);
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            u.push(s.getEntries(o, h).next((function(t) {
                e.cs.forEach((function(i, h) {
                    ...
                    // access.
                    s.jh(i, r), a = a.me(i, h)) : null == c || h.version.S(c.version) > 0 || 0 === h.version.S(c.version) && c.hasPendingWrites ? (s.Gh(h, r), 
                    a = a.me(i, h)) : fe("LocalStore", "Ignoring outdated watch update for ", i, ". Current version:", c.version, " Watch version:", h.version), 
    ...
    t.Qh = function(t, e, n) {
        ...
        return ye(e.resumeToken.rt() > 0), 0 === t.resumeToken.rt() || (
        // Don't allow resume token changes to be buffered indefinitely. This
        // allows us to be reasonably up-to-date after a crash and avoids needing
        // to loop over all active queries on shutdown. Especially in the browser
        // we may not get time to do anything interesting while the current tab is
        // closing.
        e.Te.C() - t.Te.C() >= this.Yh || n.ws.size + n.Ts.size + n.Es.size > 0);
    }, 
    /**
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return e.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(e) {
                        return Ae.forEach(t, (function(t) {
                            return Ae.forEach(t.Kn, (function(n) {
                                return c.persistence.Kh.Jh(e, t.targetId, n);
                            })).next((function() {
                                return Ae.forEach(t.zn, (function(n) {
                  ...
                  case 2:
                    if (!Pe(n = e.sent())) throw n;
                    // If `notifyLocalViewChanges` fails, we did not advance the sequence
                    // number for the documents that were included in this transaction.
                    // This might trigger them to be deleted earlier than they otherwise
                    // would have, but it should not invalidate the integrity of the data.
                                        return fe("LocalStore", "Failed to update sequence numbers: " + n), 
                    [ 3 /*break*/ , 3 ];
    ...
    t.prototype.io = function(t) {
        ...
        return this.persistence.runTransaction("Allocate target", "readwrite", (function(n) {
            ...
            return e.Th.no(n, t).next((function(i) {
                ...
                r = i, Ae.resolve(r)) : e.Th.ro(n).next((function(i) {
                    return r = new Dt(t, i, 0 /* Listen */ , n.Uh), e.Th.ho(n, r).next((function() {
                        return r;
                    }));
                }));
            }));
            ...
            return (null === r || n.Te.S(r.Te) > 0) && (e.uh = e.uh.me(n.targetId, n), e.lh.set(t, n.targetId)), 
            n;
        }));
    }, 
    /**
    ...
    t.prototype.no = function(t, e) {
        var n = this.lh.get(e);
        return void 0 !== n ? Ae.resolve(this.uh.get(n)) : this.Th.no(t, e);
    }, 
    /**
    ...
    t.prototype.oo = function(t, e) {
        ...
        return this.persistence.runTransaction("Release target", i, (function(t) {
            return e ? Ae.resolve() : n.persistence.Kh.removeTarget(t, r);
        })).then((function() {
    ...
    t.prototype.ao = function(t, e) {
        ...
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.no(o, t.ee()).next((function(t) {
                ...
                return n.ah.Bn(o, t, e ? r : m.min(), e ? i : Gt());
            })).next((function(t) {
                return {
                    documents: t,
                    co: i
        ...
        var r = this, i = e.batch, o = i.keys(), s = Ae.resolve();
        return o.forEach((function(r) {
            s = s.next((function() {
                return n.On(t, r);
            })).next((function(t) {
                var o = t, s = e.Rn.get(r);
                ye(null !== s), (!o || o.version.S(s) < 0) && ((o = i.at(r, o, e)) && 
 ...
 */ function Fe(t) {
    return e.__awaiter(this, void 0, void 0, (function() {
        return e.__generator(this, (function(e) {
            ...
            return fe("LocalStore", "Unexpectedly lost primary lease"), [ 2 /*return*/ ];
        }));
    }));
}
...
var je = /** @class */ function() {
    function t() {
        ...
        this.fo = new Pt(Be.do), 
        // A set of outstanding references to a document sorted by target id.
        this.wo = new Pt(Be.To)
    ...
    t.prototype.mo = function(t) {
        var e = this, n = E.EMPTY, r = new Be(n, t), i = new Be(n, t + 1), o = [];
        ...
        var e = E.EMPTY, n = new Be(e, t), r = new Be(e, t + 1), i = Gt();
        return this.wo.Ge([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.Vo = function(t) {
        var e = new Be(t, 0), n = this.fo.Ke(e);
    ...
    return t.do = function(t, e) {
        return E.N(t.key, e.key) || ge(t.po, e.po);
    }, 
    /** Compare by ID then by key */ t.To = function(t, e) {
        return ge(t.po, e.po) || E.N(t.key, e.key);
    }, t;
}();
 ...
 */
function Ge(t, e) {
    if (0 !== e.length) throw new c(h.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + an(e.length, "argument") + ".");
}
 ...
 */ function ze(t, e, n) {
    if (e.length !== n) throw new c(h.INVALID_ARGUMENT, "Function " + t + "() requires " + an(n, "argument") + ", but was called with " + an(e.length, "argument") + ".");
}
 ...
 */ function Qe(t, e, n) {
    if (e.length < n) throw new c(h.INVALID_ARGUMENT, "Function " + t + "() requires at least " + an(n, "argument") + ", but was called with " + an(e.length, "argument") + ".");
}
 ...
 */ function We(t, e, n, r) {
    if (e.length < n || e.length > r) throw new c(h.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + an(e.length, "argument") + ".");
}
 ...
 */ function Je(t, e, n, r) {
    if (!e.some((function(t) {
        return t === r;
    }))) throw new c(h.INVALID_ARGUMENT, "Invalid value " + en(r) + " provided to function " + t + "() for its " + un(n) + " argument. Acceptable values: " + e.join(", "));
    return r;
}

/** Helper to validate the type of a provided input. */ function Ze(t, e, n, r) {
    if (!("object" === e ? tn(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = en(r);
...
/** Returns a string describing the type / value of the provided input. */ function en(t) {
...
function nn(t, e, n) {
    if (void 0 === n) throw new c(h.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + un(e) + " argument, but it was undefined.");
}
 ...
 */ function on(t, e, n, r) {
    var i = en(r);
    return new c(h.INVALID_ARGUMENT, "Function " + t + "() requires its " + un(n) + " argument to be a " + e + ", but it was: " + i);
}

function sn(t, e, n) {
    if (n <= 0) throw new c(h.INVALID_ARGUMENT, "Function " + t + "() requires its " + un(e) + " argument to be a positive number, but it was: " + n + ".");
}

/** Converts a number to its english word representation */ function un(t) {
    switch (t) {
      case 1:
        return "first";
 ...
 * limitations under the License.
 */
/** Helper function to assert Uint8Array is available at runtime. */ function hn() {
    if ("undefined" == typeof Uint8Array) throw new c(h.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function cn() {
    if (!ae.nt().yo) throw new c(h.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ var fn = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        ze("Blob.fromBase64String", arguments, 1), He("Blob.fromBase64String", "string", 1, e), 
        cn();
        try {
        ...
        if (ze("Blob.fromUint8Array", arguments, 1), hn(), !(e instanceof Uint8Array)) throw on("Blob.fromUint8Array", "Uint8Array", 1, e);
        return new t(T.fromUint8Array(e));
    }, t.prototype.toBase64 = function() {
        return ze("Blob.toBase64", arguments, 0), cn(), this.bo.toBase64();
    }, t.prototype.toUint8Array = function() {
        return ze("Blob.toUint8Array", arguments, 0), hn(), this.bo.toUint8Array();
    }, t.prototype.toString = function() {
    ...
    !function(t, e, n, r) {
        if (!(e instanceof Array) || e.length < 1) throw new c(h.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + an(1, "element") + ".");
    }(0, t);
    for (var e = 0; e < t.length; ++e) if (He("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new c(h.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
    this.vo = new _(t);
}, pn = /** @class */ function(t) {
    /**
    ...
    return e.__extends(n, t), n.documentId = function() {
        ...
        if (!(t instanceof n)) throw on("isEqual", "FieldPath", 1, t);
 ...
 */
var dn = new RegExp("[~\\*/\\[\\]]"), yn = function() {
    /** A pointer to the implementing class. */
    this.Co = this;
}, vn = /** @class */ function(t) {
    function n(e) {
        var n = this;
        return (n = t.call(this) || this).Do = e, n;
    }
    return e.__extends(n, t), n.prototype.Fo = function(t) {
...
}(yn), mn = /** @class */ function(t) {
    function n(e) {
        var n = this;
        return (n = t.call(this) || this).Do = e, n;
    }
    return e.__extends(n, t), n.prototype.Fo = function(t) {
        return new Z(t.path, H.instance);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n;
    }, n;
}(yn), gn = /** @class */ function(t) {
    function n(e, n) {
        var r = this;
        return (r = t.call(this) || this).Do = e, r.Lo = n, r;
    }
    return e.__extends(n, t), n.prototype.Fo = function(t) {
        ...
        return new Z(t.path, r);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    }, n;
}(yn), wn = /** @class */ function(t) {
    function n(e, n) {
        var r = this;
        return (r = t.call(this) || this).Do = e, r.Lo = n, r;
    }
...
}(yn), bn = /** @class */ function(t) {
    function n(e, n) {
        var r = this;
        return (r = t.call(this) || this).Do = e, r.ko = n, r;
    }
    return e.__extends(n, t), n.prototype.Fo = function(t) {
        var e = new kn({
            No: 3 /* Argument */ ,
            methodName: this.Do
        }, t.ii, t.serializer, t.ignoreUndefinedProperties), n = Un(this.ko, e), r = new X(t.serializer, n);
        return new Z(t.path, r);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    }, n;
}(yn), _n = /** @class */ function(t) {
    function n() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return e.__extends(n, t), n.delete = function() {
        return Ge("FieldValue.delete", arguments), new En(new vn("FieldValue.delete"));
    }, n.serverTimestamp = function() {
        return Ge("FieldValue.serverTimestamp", arguments), new En(new mn("FieldValue.serverTimestamp"));
    }, n.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return Qe("FieldValue.arrayUnion", arguments, 1), new En(new gn("FieldValue.arrayUnion", t));
    }, n.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return Qe("FieldValue.arrayRemove", arguments, 1), new En(new wn("FieldValue.arrayRemove", t));
    }, n.increment = function(t) {
        return He("FieldValue.increment", "number", 1, t), ze("FieldValue.increment", arguments, 1), 
        new En(new bn("FieldValue.increment", t));
    }, n;
}(yn), En = /** @class */ function(t) {
    function n(e) {
        var n = this;
        return (n = t.call(this) || this).Co = e, n.Do = e.Do, n;
    }
    return e.__extends(n, t), n.prototype.Fo = function(t) {
        return this.Co.Fo(t);
    }, n.prototype.isEqual = function(t) {
...
}(_n), In = /** @class */ function() {
    function t(t, e) {
        if (ze("GeoPoint", arguments, 2), He("GeoPoint", "number", 1, t), He("GeoPoint", "number", 2, e), 
     ...
     */
    t.prototype.g = function(t) {
        return ge(this.qo, t.qo) || ge(this.Mo, t.Mo);
    }, t;
}(), Nn = /^__.*__$/, An = function(t, e, n) {
...
/** A "context" object passed around while parsing user data. */ var kn = /** @class */ function() {
    ...
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Vn(this.No) && Nn.test(t)) throw this.$o('Document fields cannot begin and end with "__"');
    }, t;
}(), Sn = /** @class */ function() {
    function t(t, e, n) {
        this.ii = t, this.ignoreUndefinedProperties = e, this.serializer = n || ae.nt().Yo(t)
        /** Parse document data from a set() call. */;
    }
    return t.prototype.Xo = function(t, e, n) {
        void 0 === n && (n = {});
        var r = this.Jo(n.merge || n.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , t);
        Pn("Data must be an object, but it was:", r, e);
        var i, o, s = Rn(e, r);
        if (n.merge) i = new J(r.Vt), o = r.fieldTransforms; else if (n.mergeFields) {
            for (var u = [], a = 0, f = n.mergeFields; a < f.length; a++) {
                var l = f[a], p = void 0;
                if (l instanceof ln) p = l.vo; else {
                    if ("string" != typeof l) throw de();
                    p = qn(t, l);
                }
        ...
        return new Tn(new at(s), i, o);
    }, 
    /** Parse update data from an update() call. */ t.prototype.Zo = function(t, e) {
        var n = this.Jo(1 /* Update */ , t);
        Pn("Data must be an object, but it was:", n, e);
        var r = [], i = new ht;
        N(e, (function(e, o) {
            var s = qn(t, e), u = n.Ko(s);
            if (o instanceof yn && o.Co instanceof vn) 
    ...
    /** Parse update data from a list of field/value arguments. */ t.prototype.ta = function(t, e, n, r) {
        ...
        for (var u = 0; u < r.length; u += 2) o.push(On(t, r[u])), s.push(r[u + 1]);
        // We iterate in reverse order to pick the last value for a field if the
        // user specified the field multiple times.
        for (var a = [], f = new ht, l = o.length - 1; l >= 0; --l) if (!Mn(a, o[l])) {
            var p = o[l], d = s[l], y = i.Ko(p);
            if (d instanceof yn && d.Co instanceof vn) 
            // Add it to the field mask, but don't add anything to updateData.
            a.push(p); else {
                var v = Un(d, y);
        ...
        var m = new J(a);
        return new Dn(f.gt(), m, i.fieldTransforms);
    }, 
    ...
    t.prototype.ea = function(t, e, n) {
        return void 0 === n && (n = !1), Un(e, this.Jo(n ? 4 /* ArrayArgument */ : 3 /* Argument */ , t));
    }, t;
}();
 ...
 */
function Un(t, e) {
    if (Ln(t)) return Pn("Unsupported field value:", e, t), Rn(t, e);
    if (t instanceof yn) 
    ...
    return function(t, e) {
        ...
        if (!Vn(e.No)) throw e.$o(t.Do + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        throw e.$o("Unsupported field value: " + en(t));
    }(t, e);
}
...
function Rn(t, e) {
    ...
    e.path && e.path.length > 0 && e.Vt.push(e.path) : N(t, (function(t, r) {
        var i = Un(r, e.Go(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
...
function Ln(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof v || t instanceof In || t instanceof fn || t instanceof An || t instanceof yn);
}
 ...
 */ function On(t, e) {
    if (e instanceof ln) return e.vo;
 ...
 */ function qn(t, n) {
    try {
        return function(t) {
            if (t.search(dn) >= 0) throw new c(h.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (pn.bind.apply(pn, e.__spreadArrays([ void 0 ], t.split("."))));
            } catch (e) {
 ...
 */ var Cn = /** @class */ function() {
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.ra = 0, this.ha = null, this.stream = null, this.kr = new Se(t, e)
        /**
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.kr.reset() : n && n.code === h.RESOURCE_EXHAUSTED ? (
                    // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
                    le(n.toString()), le("Using maximum backoff delay to prevent overloading the backend."), 
                    this.kr.cr()) : n && n.code === h.UNAUTHENTICATED && 
    ...
    t.prototype.wa = function() {}, t.prototype.auth = function() {
        ...
        this.stream = this.ma(t), this.stream.Aa((function() {
            n((function() {
    ...
    t.prototype.Ra = function(t) {
        ...
        return fe("PersistentStream", "close with error: " + t), this.stream = null, this.close(3 /* Error */ , t);
    }, 
    /**
    ...
    t.prototype.Ea = function(t) {
        ...
        return function(n) {
            e.sr.Sr((function() {
                return e.ra === t ? n() : (fe("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return e.__extends(n, t), n.prototype.ma = function(t) {
    ...
    function n(e, n, r, i, o) {
        ...
        /**
             ...
             * next request.
             */
        s.lastStreamToken = T.ht, s;
    }
    return e.__extends(n, t), Object.defineProperty(n.prototype, "ba", {
        /**
    ...
    n.prototype.start = function() {
        this.ga = !1, this.lastStreamToken = T.ht, t.prototype.start.call(this);
        ...
        // The first response is always the handshake response
                return ye(!t.writeResults || 0 === t.writeResults.length), this.ga = !0, 
        this.listener.Ca();
    }, 
    /**
...
}(Cn), jn = /** @class */ function(t) {
    function n(e, n, r) {
        var i = this;
        return (i = t.call(this) || this).ia = e, i.credentials = n, i.serializer = r, i.Na = !1, 
        i;
    }
    return e.__extends(n, t), n.prototype.$a = function() {
        if (this.Na) throw new c(h.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    ...
    return t.prototype.Ua = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(i) {
                switch (i.label) {
                  case 0:
                    if (this.Qa(), this.mutations.length > 0) throw new c(h.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                        ...
                        return e.__awaiter(this, void 0, void 0, (function() {
                            ...
                            return e.__generator(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return r = ve(t), i = {
                                        database: r.serializer.Ii,
                                        documents: n.map((function(t) {
                                            return r.serializer.di(t);
                                        }))
                                    }, [ 4 /*yield*/ , r.Oa("BatchGetDocuments", i) ];
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((n = i.sent()).forEach((function(t) {
                        t instanceof yt || t instanceof dt ? r.Wa(t) : de();
                    })), n) ];
                }
            }));
        }));
        ...
        this.write([ new st(t, this.Rt(t)) ]), this.Ba.add(t);
            ...
            return e.__generator(this, (function(r) {
                switch (r.label) {
                  case 0:
                    ...
                    t.forEach((function(t, e) {
                        var r = new E(w.G(e));
                        n.mutations.push(new ut(r, n.Rt(r)));
                  ...
                  case 1:
                    // For each mutation, note that the doc was written.
                    return r.sent(), this.Ma = !0, [ 2 /*return*/ ];
                }
            }));
        }));
    ...
    t.prototype.Rt = function(t) {
        ...
        return !this.Ba.has(t) && e ? et.updateTime(e) : et.dt();
    }, 
    /**
    ...
    t.prototype.set = function(t) {
        ...
        this.za ? (le(e), this.za = !1) : fe("OnlineStateTracker", e);
    ...
    n, r, i, o) {
        ...
        /**
             ...
             * again.
             */
        this.ru = !1, this.hu = o, this.hu.ou((function(t) {
            r.Sr((function() {
                return e.__awaiter(s, void 0, void 0, (function() {
                    return e.__generator(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return this.au() ? (fe("RemoteStore", "Restarting streams for network reachability change."), 
        ...
        this.lu = function(t, e, n) {
            var r = ve(t);
            return new xn(e, r.ia, r.credentials, r.serializer, n);
        }(this.ka, r, {
            ...
            var r = ve(t);
            return new Fn(e, r.ia, r.credentials, r.serializer, n);
        }(this.ka, r, {
    ...
    /** Re-enables the network. Idempotent. */ t.prototype.enableNetwork = function() {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            return e.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return this.au() ? (this.mu() ? this.Au() : this.cu.set("Unknown" /* Unknown */), 
    ...
    t.prototype.disableNetwork = function() {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            return e.__generator(this, (function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    return t.sent(), this.su.length > 0 && (fe("RemoteStore", "Stopping write stream with " + this.su.length + " pending writes"), 
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            return e.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return fe("RemoteStore", "RemoteStore shutting down."), this.networkEnabled = !1, 
                    [ 4 /*yield*/ , this.Vu() ];
    ...
    t.prototype.vu = function(t) {
        ...
        this.nu = new ee(this), this.lu.start(), this.cu.Ya();
    }, 
    /**
    ...
    t.prototype.mu = function() {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    if (this.cu.set("Online" /* Online */), !(t instanceof Zt && 2 /* Removed */ === t.state && t.cause)) 
                    // Mark the client as online since we got a message from the server
                    return [ 3 /*break*/ , 6 ];
                    e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 3, , 5 ]), [ 4 /*yield*/ , this.Cu(t) ];

                  case 2:
                    return e.sent(), [ 3 /*break*/ , 5 ];

                  case 3:
                    return r = e.sent(), fe("RemoteStore", "Failed to remove targets %s: %s ", t.targetIds.join(","), r), 
                    [ 4 /*yield*/ , this.Du(r) ];
                  ...
                  case 6:
                    if (t instanceof $t ? this.nu.Bs(t) : t instanceof Jt ? this.nu.zs(t) : this.nu.Ws(t), 
                    n.isEqual(m.min())) return [ 3 /*break*/ , 13 ];
                    e.label = 7;

                  case 7:
                    return e.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , this.eu.qh() ];

                  case 8:
                    return i = e.sent(), n.S(i) >= 0 ? [ 4 /*yield*/ , this.Fu(n) ] : [ 3 /*break*/ , 10 ];
                  ...
                  case 11:
                    return fe("RemoteStore", "Failed to raise snapshot:", o = e.sent()), [ 4 /*yield*/ , this.Du(o) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(i) {
                switch (i.label) {
                  ...
                  case 1:
                    // Disable network and raise offline snapshots
                    return i.sent(), this.cu.set("Offline" /* Offline */), n || (
                    ...
                    this.Pr.jr((function() {
                        return e.__awaiter(r, void 0, void 0, (function() {
                            return e.__generator(this, (function(t) {
                                switch (t.label) {
                                  case 0:
                                    return fe("RemoteStore", "Retrying IndexedDB access"), [ 4 /*yield*/ , n() ];

                                  case 1:
                                    return t.sent(), this.ru = !1, [ 4 /*yield*/ , this.Ru() ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return r < i.length ? (o = i[r], this.iu.has(o) ? [ 4 /*yield*/ , this.Su.$u(o, n) ] : [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 5 ];

                  case 2:
                    e.sent(), this.iu.delete(o), this.nu.removeTarget(o), e.label = 3;
    ...
    t.prototype.Pu = function() {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    t = this.su.length > 0 ? this.su[this.su.length - 1].batchId : -1, e.label = 1;
                  ...
                  case 2:
                    return e.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , this.eu.to(t) ];

                  case 3:
                    return null === (n = e.sent()) ? (0 === this.su.length && this.wu.la(), [ 3 /*break*/ , 7 ]) : (t = n.batchId, 
                    this.Ou(n), [ 3 /*break*/ , 6 ]);

                  case 4:
                    return r = e.sent(), [ 4 /*yield*/ , this.Du(r) ];
    ...
    t.prototype.Ou = function(t) {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                ...
                for (t = 0, n = this.su; t < n.length; t++) r = n[t], this.wu.va(r.mutations);
                return [ 2 /*return*/ ];
            }));
        }));
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return r = this.su.shift(), i = Ne.from(r, t, n), [ 4 /*yield*/ , this.Nu((function() {
                        return o.Su.xu(i);
                    })) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return kt(r = t.code) && r !== h.ABORTED ? (n = this.su.shift(), 
                    // In this case it's also unlikely that the server itself is melting
                    // down -- this was just a bad request so inhibit backoff on the next
                    // restart.
                    this.wu.ca(), [ 4 /*yield*/ , this.Nu((function() {
                        return i.Su.Uu(n.batchId, t);
                    })) ]) : [ 3 /*break*/ , 3 ];
            ...
            return e.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    ...
                    fe("RemoteStore", "RemoteStore restarting streams for new credential"), [ 4 /*yield*/ , this.uu() ]) : [ 3 /*break*/ , 2 ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 2:
                    return (n = t) ? [ 3 /*break*/ , 4 ] : [ 4 /*yield*/ , this.Vu() ];

                  case 3:
                    e.sent(), n = this.cu.set("Unknown" /* Unknown */), e.label = 4;
    ...
    function t() {
        this.zu = new Qn, this.Yu = {}, this.Su = null, this.Ga = null, this.Xn = null;
    }
    return t.prototype.Xu = function(t) {
        ...
        return this.zu = new Qn, Promise.resolve();
    ...
    e) {
        ...
        this.ns = Gt(), this.cc = new Wt(t.se.bind(t));
    }
    ...
    t.prototype._c = function(t, e) {
        var n = this, r = e ? e.fc : new Ht, i = e ? e.cc : this.cc, o = e ? e.ns : this.ns, s = i, u = !1, a = this.query.oe() && i.size === this.query.limit ? i.last() : null, h = this.query.ae() && i.size === this.query.limit ? i.first() : null;
    ...
    t.prototype.Tc = function(t, e, n) {
        ...
        return this.ac = u, 0 !== o.length || a ? {
            snapshot: new Yt(this.query, t.cc, i, o, t.ns, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            Rc: s
        } : {
            Rc: s
    ...
    t.prototype.Ec = function(t) {
        ...
        // updating many documents.
                var e = this.uc;
        this.uc = Gt(), this.cc.forEach((function(e) {
            t.Ac(e.key) && (t.uc = t.uc.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.uc.has(e) || n.push(new Yn(e));
        })), this.uc.forEach((function(t) {
            e.has(t) || n.push(new Hn(t));
        })), n;
    }, 
    /**
    ...
    t.prototype.Vc = function() {
        return Yt.os(this.query, this.cc, this.ns, 0 /* Local */ === this.ac);
    }, t;
}(), Xn = /** @class */ function() {
    function t(t, e, n, r) {
        this.Pr = t, this.ka = e, this.updateFunction = n, this.yr = r, this.pc = 5, this.kr = new Se(this.Pr, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.yc = function() {
        ...
        this.kr.lr((function() {
            return e.__awaiter(t, void 0, void 0, (function() {
                var t, n, r = this;
                return e.__generator(this, (function(e) {
                    return t = new Bn(this.ka), (n = this.bc(t)) && n.then((function(e) {
                        r.Pr.Sr((function() {
        ...
        try {
            ...
            return !D(e) && e.catch && e.then ? e : (this.yr.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
        ...
        if ("FirebaseError" === t.name) {
            ...
            var e = t.code;
            return "aborted" === e || "failed-precondition" === e || !kt(e);
        }
        return !1;
    }, t;
}(), $n = function(
...
n) {
    ...
    r, i, o) {
        ...
        this.$c = null, this.Lc = new Ee((function(t) {
            return t.canonicalId();
        })), this.Oc = new Map, 
        /**
        ...
        /**
             ...
             */
        this.Mc = new Map, this.xc = new je, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.Bc = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Uc = new Map, this.Qc = Le.Ar(), this.onlineState = "Unknown" /* Unknown */;
    }
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    n = i.targetId, this.Fc.Zu(n), r = i.view.Vc(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , this.eu.io(t.ee()) ];

                  case 2:
                    return o = e.sent(), s = this.Fc.Zu(o.targetId), n = o.targetId, [ 4 /*yield*/ , this.Gc(t, n, "current" === s) ];

                  case 3:
                    r = e.sent(), this.Wc && this.Dc.listen(o), e.label = 4;
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return i = e.sent(), o = new Kn(t, i.co), s = o._c(i.documents), u = Xt.fs(n, r && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.Tc(s, 
                    /* updateLimboDocuments= */ this.Wc, u), this.Hc(n, a.Rc), h = new $n(t, n, o), 
                    [ 2 /*return*/ , (this.Lc.set(t, h), this.Oc.has(n) ? this.Oc.get(n).push(t) : this.Oc.set(n, [ t ]), 
                    a.snapshot) ];
                }
            }));
        }));
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    // to the target.
                    return this.jc("unlisten()"), n = this.Lc.get(t), (r = this.Oc.get(n.targetId)).length > 1 ? [ 2 /*return*/ , (this.Oc.set(n.targetId, r.filter((function(e) {
                        return !e.isEqual(t);
                    }))), void this.Lc.delete(t)) ] : this.Wc ? (
                    // We need to remove the local query target first to allow us to verify
                    // whether any other client is still interested in this target.
                    this.Fc.ec(n.targetId), this.Fc.rc(n.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , this.eu.oo(n.targetId, /*keepPersistedTargetData=*/ !1).then((function() {
                        i.Fc.ic(n.targetId), i.Dc.bu(n.targetId), i.Kc(n.targetId);
                    })).catch(Fe) ]) : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    return this.Kc(n.targetId), [ 4 /*yield*/ , this.eu.oo(n.targetId, 
    ...
    t.prototype.write = function(t, n) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.jc("write()"), e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , this.eu.gh(t) ];

                  case 2:
                    return r = e.sent(), this.Fc.Xu(r.batchId), this.zc(r.batchId, n), [ 4 /*yield*/ , this.Yc(r.vh) ];

                  case 3:
                    return e.sent(), [ 4 /*yield*/ , this.Dc.Pu() ];

                  case 4:
                    return e.sent(), [ 3 /*break*/ , 6 ];

                  case 5:
                    return i = e.sent(), o = Me(i, "Failed to persist write"), n.reject(o), [ 3 /*break*/ , 6 ];
    ...
    t.prototype.runTransaction = function(t, e, n) {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.jc("applyRemoteEvent()"), e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.eu.Mh(t) ];
                  ...
                  case 2:
                    ...
                    t.as.forEach((function(t, e) {
                        ...
                        ye(t.ws.size + t.Ts.size + t.Es.size <= 1), t.ws.size > 0 ? n.Cc = !0 : t.Ts.size > 0 ? ye(n.Cc) : t.Es.size > 0 && (ye(n.Cc), 
                        n.Cc = !1));
                    })), [ 4 /*yield*/ , this.Yc(n, t) ];
    ...
    t.prototype.mc = function(t, e) {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.Fc.tc(t, "rejected", n), r = this.Mc.get(t), (i = r && r.key) ? (o = (o = new Ut(E.N)).me(i, new yt(i, m.min())), 
                    s = Gt().add(i), u = new Kt(m.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new Pt(ge), o, s), [ 4 /*yield*/ , this.Mh(u) ]) : [ 3 /*break*/ , 2 ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.jc("applySuccessfulWrite()"), n = t.batch.batchId, e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.eu.Sh(t) ];
                  ...
                  case 2:
                    ...
                    this.Zc(n, /*error=*/ null), this.tl(n), this.Fc.Ju(n, "acknowledged"), [ 4 /*yield*/ , this.Yc(r) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.jc("rejectFailedWrite()"), e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.eu.$h(t) ];
                  ...
                  case 2:
                    ...
                    // listen events.
                    this.Zc(t, n), this.tl(t), this.Fc.Ju(t, "rejected", n), [ 4 /*yield*/ , this.Yc(r) ];
    ...
    t.prototype.el = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.Dc.au() || fe("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                    e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.eu.kh() ];

                  case 2:
                    return -1 === (n = e.sent()) ? [ 2 /*return*/ , void t.resolve() ] : ((r = this.Uc.get(n) || []).push(t), 
                    this.Uc.set(n, r), [ 3 /*break*/ , 4 ]);

                  case 3:
                    return i = e.sent(), o = Me(i, "Initialization of waitForPendingWrites() operation failed"), 
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.sl = function(t) {
        ...
        n || (n = new Ut(ge)), n = n.me(t, e), this.Bc[this.currentUser.s()] = n;
    }, 
    /**
    ...
    t.prototype.Zc = function(t, e) {
        ...
        this.Oc.delete(t), this.Wc && this.xc.mo(t).forEach((function(t) {
            n.xc.Vo(t) || 
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof Hn ? (this.xc.Jh(i.key, t), this.rl(i)) : i instanceof Yn ? (fe("SyncEngine", "Document no longer in limbo: " + i.key), 
        ...
        var e = t.key;
        this.qc.get(e) || (fe("SyncEngine", "New document in limbo: " + e), this.kc.push(e), 
        this.Jc());
    }, 
    /**
    ...
    t.prototype.Jc = function() {
        for (;this.kc.length > 0 && this.qc.size < this.Nc; ) {
            ...
            this.Mc.set(e, new Jn(t)), this.qc = this.qc.me(t, e), this.Dc.listen(new Dt(gt.Wt(t.path).ee(), e, 2 /* LimboResolution */ , Ve.er));
        }
    }, 
    // Visible for testing
    ...
    t.prototype.ol = function() {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return r = [], i = [], o = [], this.Lc.forEach((function(e, u) {
                        o.push(Promise.resolve().then((function() {
                            ...
                            var e = n && n.as.get(u.targetId), o = u.view.Tc(t, 
                            /* updateLimboDocuments= */ s.Wc, e);
                            if (s.Hc(u.targetId, o.Rc), o.snapshot) {
                                s.Wc && s.Fc.tc(u.targetId, o.snapshot.fromCache ? "not-current" : "current"), r.push(o.snapshot);
                                var a = De.Yn(u.targetId, o.snapshot);
                                i.push(a);
                            }
                        })));
                  ...
                  case 1:
                    return e.sent(), this.$c.Va(r), [ 4 /*yield*/ , this.eu.Xh(i) ];
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    ...
                    this.Fc.Ah(t, n.ph, n.yh), [ 4 /*yield*/ , this.Yc(n.Vh) ];
        ...
        var e = this.Mc.get(t);
        if (e && e.Cc) return Gt().add(e.key);
        var n = Gt(), r = this.Oc.get(t);
        if (!r) return n;
    ...
    function t(t) {
        this.Su = t, this.cl = new Ee((function(t) {
            return t.canonicalId();
    ...
    return t.prototype.listen = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    if (n = t.query, r = !1, (i = this.cl.get(n)) || (r = !0, i = new tr), !r) return [ 3 /*break*/ , 4 ];
                    e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 3, , 4 ]), o = i, [ 4 /*yield*/ , this.Su.listen(n) ];

                  case 2:
                    return o.al = e.sent(), [ 3 /*break*/ , 4 ];

                  case 3:
                    return s = e.sent(), u = Me(s, "Initialization of query '" + t.query + "' failed"), 
                    [ 2 /*return*/ , void t.onError(u) ];

                  case 4:
                    return this.cl.set(n, i), i.ul.push(t), 
                    // Run global snapshot listeners if a consistent snapshot has been emitted.
                    t.mc(this.onlineState), i.al && t._l(i.al) && this.fl(), [ 2 /*return*/ ];
                }
            }));
        }));
    }, t.prototype.bu = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            var n, r, i, o;
            return e.__generator(this, (function(e) {
                return n = t.query, r = !1, (i = this.cl.get(n)) && (o = i.ul.indexOf(t)) >= 0 && (i.ul.splice(o, 1), 
                r = 0 === i.ul.length), r ? [ 2 /*return*/ , (this.cl.delete(n), this.Su.bu(n)) ] : [ 2 /*return*/ ];
            }));
        }));
    ...
    return t.prototype._l = function(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new Yt(t.query, t.docs, t.ss, e, t.ns, t.fromCache, t.rs, 
            /* excludesMetadataChanges= */ !0);
        }
        var o = !1;
        return this.El ? this.Rl(t) && (this.Tl.next(t), o = !0) : this.ml(t, this.onlineState) && (this.Al(t), 
        o = !0), this.Il = t, o;
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.mc = function(t) {
        ...
        t = Yt.os(t.query, t.docs, t.ns, t.fromCache), this.El = !0, this.Tl.next(t);
    }, t;
}(), rr = /** @class */ function() {
    function t() {}
    return t.prototype.mh = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.te() || n.isEqual(m.min()) ? this.pl(t, e) : this.Vl.qn(t, i).next((function(s) {
            var u = o.yl(e, s);
            return (e.oe() || e.ae()) && o.wc(e.xt, u, i, n) ? o.pl(t, e) : (ce() <= r.LogLevel.DEBUG && fe("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), e.toString()), 
            o.Vl.Bn(t, e, n).next((function(t) {
    ...
    t.prototype.wc = function(t, e, n, r) {
        ...
        return ce() <= r.LogLevel.DEBUG && fe("IndexFreeQueryEngine", "Using full collection scan to execute query:", e.toString()), 
        this.Vl.Bn(t, e, m.min());
    }, t;
}(), ir = /** @class */ function() {
    function t(t, e) {
        this.Fn = t, this.Kh = e, 
        ...
        this.bl = new Pt(Be.do);
    }
    return t.prototype.vl = function(t) {
        return Ae.resolve(0 === this.Dn.length);
        ...
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.bl = this.bl.add(new Be(a.key, i)), this.Fn.Ir(t, a.key.path.O());
        }
        return Ae.resolve(o);
    }, t.prototype.Lh = function(t, e) {
        return Ae.resolve(this.Sl(e));
    }, t.prototype.eo = function(t, e) {
        var n = e + 1, r = this.Cl(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Ae.resolve(this.Dn.length > i ? this.Dn[i] : null);
    }, t.prototype.kh = function() {
        return Ae.resolve(0 === this.Dn.length ? -1 : this.gl - 1);
    }, t.prototype.Ph = function(t) {
        return Ae.resolve(this.Dn.slice());
        ...
        // because it precedes all other segments in an ordered traversal.
                E.et(i) || (i = i.child(""));
        var o = new Be(new E(i), 0), s = new Pt(ge);
        ...
        var r = this.bl;
        return Ae.forEach(e.mutations, (function(i) {
        ...
        var n = new Be(e, 0), r = this.bl.Ke(n);
        return Ae.resolve(e.isEqual(r && r.key));
    }, t.prototype.Nh = function(t) {
        return this.Dn.length, Ae.resolve();
    }, 
    /**
    ...
    t.prototype.jh = function(t) {
        ...
        return Ae.resolve(n ? n.Ol : null);
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = Ct();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
            r = r.me(t, e ? e.Ol : null);
        })), Ae.resolve(r);
    }, t.prototype.Bn = function(t, e, n) {
        ...
        ; o.$e(); ) {
            ...
            c.S(n) <= 0 || h instanceof dt && e.matches(h) && (r = r.me(h.key, h));
        }
        return Ae.resolve(r);
    }, t.prototype.kl = function(t, e) {
        return Ae.forEach(this.docs, (function(t) {
            return e(t);
        }));
 ...
 */
or.ql = /** @class */ function(t) {
    function n(e) {
        var n = this;
        return (n = t.call(this) || this).jl = e, n;
    }
    return e.__extends(n, t), n.prototype.Tc = function(t) {
        var e = this, n = [];
    ...
    t.prototype.On = function(t, e) {
        this.Ul();
        var n = this.vh.get(e);
        return void 0 !== n ? Ae.resolve(n) : this.Ql(t, e);
    }, 
    /**
...
var sr = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.Kl = new je, this.targetCount = 0, this.zl = Le.mr();
    }
    return t.prototype.js = function(t, e) {
        ...
        return Ae.resolve(this.lastRemoteSnapshotVersion);
    }, t.prototype.Yl = function(t) {
        return Ae.resolve(this.Hl);
    }, t.prototype.ro = function(t) {
        return this.highestTargetId = this.zl.next(), Ae.resolve(this.highestTargetId);
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.zl = new Le(e), this.highestTargetId = e), t.sequenceNumber > this.Hl && (this.Hl = t.sequenceNumber);
    }, t.prototype.ho = function(t, e) {
        return this.Xl(e), this.targetCount += 1, Ae.resolve();
    }, t.prototype.Wh = function(t, e) {
        return this.Xl(e), Ae.resolve();
        ...
        return this.Gl.forEach((function(s, u) {
            ...
            i++);
        })), Ae.vn(o).next((function() {
            return i;
        }));
    }, t.prototype.e_ = function(t) {
        return Ae.resolve(this.targetCount);
    }, t.prototype.no = function(t, e) {
        var n = this.Gl.get(e) || null;
        return Ae.resolve(n);
    }, t.prototype.Bh = function(t, e, n) {
        return this.Kl.Eo(e, n), Ae.resolve();
        ...
        return this.Kl.mo(e), Ae.resolve();
    }, t.prototype.uo = function(t, e) {
        var n = this.Kl.Po(e);
        return Ae.resolve(n);
    }, t.prototype.Vo = function(t, e) {
        return Ae.resolve(this.Kl.Vo(e));
    }, t;
}(), ur = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.s_ = {}, this.i_ = new Ve(0), this.n_ = !1, this.n_ = !0, this.Kh = t(this), 
        this.Th = new sr(this), this.Fn = new Ue, this.Cn = new or(this.Fn, (function(t) {
            return e.Kh.r_(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this.s_[t.s()];
        return e || (e = new ir(this.Fn, this.Kh), this.s_[t.s()] = e), e;
        ...
        var r = this;
        fe("MemoryPersistence", "Starting transaction:", t);
        var i = new ar(this.i_.next());
        ...
        return Ae.Sn(Object.values(this.s_).map((function(n) {
            return function() {
                return n.Vo(t, e);
            };
        })));
    ...
    function n(e) {
        var n = this;
        return (n = t.call(this) || this).Uh = e, n;
    }
    /**
    ...
    return t.T_ = function(e) {
        ...
        return this.d_.Jh(n, e), this.E_.delete(n), Ae.resolve();
    }, t.prototype.Zh = function(t, e, n) {
        return this.d_.Zh(n, e), this.E_.add(n), Ae.resolve();
    }, t.prototype.Nl = function(t, e) {
        return this.E_.add(e), Ae.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        this.d_.mo(e.targetId).forEach((function(t) {
            return n.E_.add(t);
        }));
        ...
        // Remove newly orphaned documents.
                return Ae.forEach(this.E_, (function(r) {
...
}(), cr = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", fr = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.Fc = this.R_(t), this.persistence = this.m_(t), [ 4 /*yield*/ , this.persistence.start() ];

                  case 1:
                    return e.sent(), this.A_ = this.P_(t), this.eu = this.V_(t), this.Dc = this.p_(t), 
                    this.Su = this.y_(t), this.g_ = this.b_(t), this.Fc.Ga = function(t) {
                        return n.Su.mc(t, 1 /* SharedClientState */);
                    }, this.Dc.Su = this.Su, [ 4 /*yield*/ , this.eu.start() ];

                  case 2:
                    return e.sent(), [ 4 /*yield*/ , this.Fc.start() ];

                  case 3:
                    return e.sent(), [ 4 /*yield*/ , this.Dc.start() ];

                  case 4:
                    return e.sent(), [ 4 /*yield*/ , this.Dc.ju(this.Su.Wc) ];
        ...
        return new er(this.Su);
    }, t.prototype.P_ = function(t) {
        return null;
    }, t.prototype.V_ = function(t) {
        return new xe(this.persistence, new rr, t.v_);
    }, t.prototype.m_ = function(t) {
        if (t.C_.S_) throw new c(h.FAILED_PRECONDITION, cr);
        return new ur(hr.T_);
    }, t.prototype.p_ = function(t) {
        var e = this;
        return new zn(this.eu, t.ka, t.Pr, (function(t) {
            return e.Su.mc(t, 0 /* RemoteStore */);
        }), t.platform.D_());
    }, t.prototype.R_ = function(t) {
        return new Wn;
    }, t.prototype.y_ = function(t) {
        return new Zn(this.eu, this.Dc, t.ka, this.Fc, t.v_, t.Nc);
    }, t.prototype.clearPersistence = function(t) {
        throw new c(h.FAILED_PRECONDITION, cr);
    }, t;
}(), lr = /** @class */ function() {
    function t(t, e, n, 
    /**
     ...
     */
    r) {
        this.platform = t, this.F_ = e, this.credentials = n, this.Pr = r, this.clientId = me.cn()
        /**
    ...
    return t.prototype.start = function(t, e) {
        ...
        return this.credentials._((function(s) {
            if (!o) return o = !0, fe("FirestoreClient", "Initializing. user=", s.uid), n.N_(t, e, s, i).then(r.resolve, r.reject);
            n.Pr.jr((function() {
                return n.Wu(s);
            }));
        })), 
     ...
     *     succeeded.
     */
    t.prototype.N_ = function(t, n, r, i) {
        return e.__awaiter(this, void 0, void 0, (function() {
            var o, s, u, a, h = this;
            return e.__generator(this, (function(c) {
                switch (c.label) {
                  case 0:
                    return c.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , this.platform.L_(this.F_) ];

                  case 1:
                    return o = c.sent(), s = this.platform.Yo(this.F_.ii), u = function(t, e, n) {
                        return new jn(t, e, n);
                  ...
                  case 2:
                    return c.sent(), this.persistence = t.persistence, this.Fc = t.Fc, this.eu = t.eu, 
     ...
     */
    t.prototype.$a = function() {
        if (this.Pr.Mr) throw new c(h.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.Wu = function(t) {
        return this.Pr.Hr(), fe("FirestoreClient", "Credential Changed. Current user: " + t.uid), 
        this.Su.Wu(t);
    }, 
    ...
    t.prototype.waitForPendingWrites = function() {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(i) {
                switch (i.label) {
                  case 0:
                    return this.$a(), n = new ke, [ 4 /*yield*/ , this.Pr.enqueue((function() {
                        return e.__awaiter(r, void 0, void 0, (function() {
                            var r, i, o;
                            return e.__generator(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return e.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.eu.so(t) ];

                                  case 1:
                                    return (r = e.sent()) instanceof dt ? n.resolve(r) : r instanceof yt ? n.resolve(null) : n.reject(new c(h.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                    [ 3 /*break*/ , 3 ];

                                  case 2:
                                    return i = e.sent(), o = Me(i, "Failed to get document '" + t + " from cache"), 
                    ...
                    return this.$a(), n = new ke, [ 4 /*yield*/ , this.Pr.enqueue((function() {
                        return e.__awaiter(r, void 0, void 0, (function() {
                            ...
                            return e.__generator(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return e.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.eu.ao(t, 
                                    /* usePreviousResults= */ !0) ];

                                  case 1:
                                    return r = e.sent(), i = new Kn(t, r.co), o = i._c(r.documents), s = i.Tc(o, 
                                    /* updateLimboDocuments= */ !1), n.resolve(s.snapshot), [ 3 /*break*/ , 3 ];

                                  case 2:
                                    return u = e.sent(), a = Me(u, "Failed to execute query '" + t + " against cache"), 
...
var yr = /** @class */ function() {
    ...
    return t.prototype.j_ = function(t) {
        ...
        return new In(x(t.latitude), x(t.longitude));
    }, t.prototype.Y_ = function(t) {
        var e = this;
        ...
        var e = w.G(t);
        ye(ue(e));
        var n = new _e(e.get(1), e.get(3)), r = new E(e.L(5));
        return n.isEqual(this.ii) || 
        // TODO(b/64130202): Somehow support foreign references.
        le("Document " + r + " contains a document reference within a different database (" + n.projectId + "/" + n.database + ") which is not supported. It will be treated as a reference in the current database (" + this.ii.projectId + "/" + this.ii.database + ") instead."), 
        this.W_(r);
    }, t;
}(), vr = Ce.nh, mr = /** @class */ function() {
    function t(t) {
        var e, n, r, i;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new c(h.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else Ke("settings", "non-empty string", "host", t.host), this.host = t.host, Xe("settings", "boolean", "ssl", t.ssl), 
        this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (rn("settings", t, [ "host", "ssl", "credentials", "timestampsInSnapshots", "cacheSizeBytes", "experimentalForceLongPolling", "ignoreUndefinedProperties" ]), 
        Xe("settings", "object", "credentials", t.credentials), this.credentials = t.credentials, 
        Xe("settings", "boolean", "timestampsInSnapshots", t.timestampsInSnapshots), Xe("settings", "boolean", "ignoreUndefinedProperties", t.ignoreUndefinedProperties), 
        // Nobody should set timestampsInSnapshots anymore, but the error depends on
        // whether they set it to true or false...
        !0 === t.timestampsInSnapshots ? le("The setting 'timestampsInSnapshots: true' is no longer required and should be removed.") : !1 === t.timestampsInSnapshots && le("Support for 'timestampsInSnapshots: false' will be removed soon. You must update your code to handle Timestamp objects."), 
        ...
        Xe("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Ce.hh; else {
            if (t.cacheSizeBytes !== vr && t.cacheSizeBytes < Ce.rh) throw new c(h.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Ce.rh);
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        Xe("settings", "boolean", "experimentalForceLongPolling", t.experimentalForceLongPolling), 
    ...
    function t(n, r, i) {
        var o = this;
        if (void 0 === i && (i = new fr), this.J_ = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.Z_ = new qe, this.INTERNAL = {
            delete: function() {
            ...
            var s = n;
            this.J_ = s, this.xo = t.sf(s), this.if = s.name, this.nf = new p(r);
        } else {
            var u = n;
            if (!u.projectId) throw new c(h.INVALID_ARGUMENT, "Must provide projectId");
            this.xo = new _e(u.projectId, u.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.if = "[DEFAULT]", this.nf = new l;
        }
        this.rf = i, this.hf = new mr({});
    }
    return Object.defineProperty(t.prototype, "af", {
        get: function() {
            return this.uf || (
            // Lazy initialize UserDataReader once the settings are frozen
            this.uf = new Sn(this.xo, this.hf.ignoreUndefinedProperties)), this.uf;
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.settings = function(t) {
        ze("Firestore.settings", arguments, 1), He("Firestore.settings", "object", 1, t);
        var e = new mr(t);
        if (this.ef && !this.hf.isEqual(e)) throw new c(h.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        ...
        var e, n;
        if (this.ef) throw new c(h.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1, i = !1;
        if (t && (void 0 !== t.experimentalTabSynchronization && le("The 'experimentalTabSynchronization' setting will be removed. Use 'synchronizeTabs' instead."), 
        r = null !== (n = null !== (e = t.synchronizeTabs) && void 0 !== e ? e : t.experimentalTabSynchronization) && void 0 !== n && n, 
        i = !!t.experimentalForceOwningTab && t.experimentalForceOwningTab, r && i)) throw new c(h.INVALID_ARGUMENT, "The 'experimentalForceOwningTab' setting cannot be used with 'synchronizeTabs'.");
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            var t, n = this;
            return e.__generator(this, (function(r) {
                if (void 0 !== this.ef && !this.ef.q_) throw new c(h.FAILED_PRECONDITION, "Persistence cannot be cleared after this Firestore instance is initialized.");
                return t = new ke, [ 2 /*return*/ , (this.Z_.xr((function() {
                    return e.__awaiter(n, void 0, void 0, (function() {
                        var n, r;
                        return e.__generator(this, (function(e) {
                            switch (e.label) {
                              case 0:
                                return e.trys.push([ 0, 2, , 3 ]), n = this.ff(), [ 4 /*yield*/ , this.rf.clearPersistence(n) ];
        ...
        if (this.tf(), dr(t)) return this.wf(t);
        He("Firestore.onSnapshotsInSync", "function", 1, t);
        var e = {
            next: t
        };
        return this.wf(e);
        ...
        return new be(this.xo, this.if, this.hf.host, this.hf.ssl, this.hf.forceLongPolling);
    }, t.prototype.lf = function(t, e) {
        var n = this.ff();
        return this.ef = new lr(ae.nt(), n, this.nf, this.Z_), this.ef.start(t, e);
    }, t.sf = function(t) {
 ...
 */        if (!n || "string" != typeof n) throw new c(h.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        get: function() {
            if (!this.J_) throw new c(h.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.J_;
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.collection = function(t) {
        return ze("Firestore.collection", arguments, 1), He("Firestore.collection", "non-empty string", 1, t), 
        this.tf(), new Dr(w.G(t), this, 
        /* converter= */ null);
    }, t.prototype.doc = function(t) {
        return ze("Firestore.doc", arguments, 1), He("Firestore.doc", "non-empty string", 1, t), 
        this.tf(), _r.Tf(w.G(t), this, 
        /* converter= */ null);
    }, t.prototype.collectionGroup = function(t) {
        if (ze("Firestore.collectionGroup", arguments, 1), He("Firestore.collectionGroup", "non-empty string", 1, t), 
        ...
        return this.tf(), new Ar(new gt(w.H, t), this, 
        /* converter= */ null);
    }, t.prototype.runTransaction = function(t) {
        var e = this;
        return ze("Firestore.runTransaction", arguments, 1), He("Firestore.runTransaction", "function", 1, t), 
        this.tf().transaction((function(n) {
            return t(new wr(e, n));
        }));
    }, t.prototype.batch = function() {
        return this.tf(), new br(this);
        ...
        var e;
        ze("Firestore.setLogLevel", arguments, 1), Je("setLogLevel", [ "debug", "error", "silent", "warn", "info", "verbose" ], 1, t), 
    ...
    return t.prototype.get = function(t) {
        ...
        var n = Ur("Transaction.get", t, this.If);
        return this.Rf.Ua([ n.Bo ]).then((function(t) {
            if (!t || 1 !== t.length) return de();
            var r = t[0];
            if (r instanceof yt) return new Ir(e.If, n.Bo, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Uo);
            if (r instanceof dt) return new Ir(e.If, n.Bo, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Uo);
            throw de();
        }));
        ...
        var r = Ur("Transaction.set", t, this.If);
        n = Vr("Transaction.set", n);
        var i = Lr(r.Uo, e, "Transaction.set"), o = i[0], s = i[1], u = this.If.af.Xo(s, o, n);
        return this.Rf.set(r.Bo, u), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return "string" == typeof e || e instanceof pn ? (Qe("Transaction.update", arguments, 3), 
        r = Ur("Transaction.update", t, this.If), i = this.If.af.ta("Transaction.update", e, n, o)) : (ze("Transaction.update", arguments, 2), 
        r = Ur("Transaction.update", t, this.If), i = this.If.af.Zo("Transaction.update", e)), 
        this.Rf.update(r.Bo, i), this;
    }, t.prototype.delete = function(t) {
        ze("Transaction.delete", arguments, 1);
        var e = Ur("Transaction.delete", t, this.If);
    ...
    return t.prototype.set = function(t, e, n) {
        We("WriteBatch.set", arguments, 2, 3), this.Pf();
        var r = Ur("WriteBatch.set", t, this.If);
        n = Vr("WriteBatch.set", n);
        var i = Lr(r.Uo, e, "WriteBatch.set"), o = i[0], s = i[1], u = this.If.af.Xo(s, o, n);
        return this.mf = this.mf.concat(u.Qo(r.Bo, et.dt())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.Pf(), "string" == typeof e || e instanceof pn ? (Qe("WriteBatch.update", arguments, 3), 
        r = Ur("WriteBatch.update", t, this.If), i = this.If.af.ta("WriteBatch.update", e, n, o)) : (ze("WriteBatch.update", arguments, 2), 
        r = Ur("WriteBatch.update", t, this.If), i = this.If.af.Zo("WriteBatch.update", e)), 
        this.mf = this.mf.concat(i.Qo(r.Bo, et.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        ze("WriteBatch.delete", arguments, 1), this.Pf();
        var e = Ur("WriteBatch.delete", t, this.If);
        return this.mf = this.mf.concat(new st(e.Bo, et.dt())), this;
    }, t.prototype.commit = function() {
        return this.Pf(), this.Af = !0, this.mf.length > 0 ? this.If.tf().write(this.mf) : Promise.resolve();
    }, t.prototype.Pf = function() {
        if (this.Af) throw new c(h.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), _r = /** @class */ function(t) {
    function n(e, n, r) {
        var i = this;
        return (i = t.call(this, n.xo, e, r) || this).Bo = e, i.firestore = n, i.Uo = r, 
        i.ef = i.firestore.tf(), i;
    }
    return e.__extends(n, t), n.Tf = function(t, e, r) {
        if (t.length % 2 != 0) throw new c(h.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t.j() + " has " + t.length);
        return new n(new E(t), e, r);
        ...
        get: function() {
            return new Dr(this.Bo.path.O(), this.firestore, this.Uo);
        },
        enumerable: !0,
        configurable: !0
        ...
        if (ze("DocumentReference.collection", arguments, 1), He("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new c(h.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = w.G(t);
        return new Dr(this.Bo.path.child(e), this.firestore, 
        /* converter= */ null);
    }, n.prototype.isEqual = function(t) {
        if (!(t instanceof n)) throw on("isEqual", "DocumentReference", 1, t);
        return this.firestore === t.firestore && this.Bo.isEqual(t.Bo) && this.Uo === t.Uo;
    }, n.prototype.set = function(t, e) {
        We("DocumentReference.set", arguments, 1, 2), e = Vr("DocumentReference.set", e);
        var n = Lr(this.Uo, t, "DocumentReference.set"), r = n[0], i = n[1], o = this.firestore.af.Xo(i, r, e);
        return this.ef.write(o.Qo(this.Bo, et.dt()));
    }, n.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof pn ? (Qe("DocumentReference.update", arguments, 2), 
        n = this.firestore.af.ta("DocumentReference.update", t, e, r)) : (ze("DocumentReference.update", arguments, 1), 
        n = this.firestore.af.Zo("DocumentReference.update", t)), this.ef.write(n.Qo(this.Bo, et.exists(!0)));
    }, n.prototype.delete = function() {
        return ze("DocumentReference.delete", arguments, 0), this.ef.write([ new st(this.Bo, et.dt()) ]);
        ...
        "object" != typeof t[i] || dr(t[i]) || (rn("DocumentReference.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        Xe("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++);
        var o = {
            includeMetadataChanges: r.includeMetadataChanges
        };
        return dr(t[i]) ? n = t[i] : (He("DocumentReference.onSnapshot", "function", i, t[i]), 
        Ye("DocumentReference.onSnapshot", "function", i + 1, t[i + 1]), Ye("DocumentReference.onSnapshot", "function", i + 2, t[i + 2]), 
        n = {
            next: t[i],
            error: t[i + 1],
            complete: t[i + 2]
        ...
        var i = new pr({
            next: function(t) {
                if (e.next) {
                    ...
                    e.next(new Ir(n.firestore, n.Bo, r, t.fromCache, t.hasPendingWrites, n.Uo));
                }
            },
            error: r
        }), o = this.ef.listen(gt.Wt(this.Bo.path), i, t);
        return function() {
            i.U_(), n.ef.bu(o);
        };
    }, n.prototype.get = function(t) {
        var e = this;
        return We("DocumentReference.get", arguments, 0, 1), Sr("DocumentReference.get", t), 
        new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.tf().M_(e.Bo).then((function(t) {
                n(new Ir(e.firestore, e.Bo, t, 
                /*fromCache=*/ !0, t instanceof dt && t.At, e.Uo));
            }), r) : e.pf(n, r, t);
        }));
    ...
    return t.prototype.data = function(t) {
        var e = this;
        if (We("DocumentSnapshot.data", arguments, 0, 1), t = kr("DocumentSnapshot.data", t), 
        this.yf) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.Uo) {
                var n = new Nr(this.If, this.Bo, this.yf, this.gf, this.bf, 
                /* converter= */ null);
                return this.Uo.fromFirestore(n, t);
            }
            return new yr(this.If.xo, this.If.Ef(), t.serverTimestamps || "none", (function(t) {
                return new _r(t, e.If, /* converter= */ null);
            })).j_(this.yf.Ot());
        }
    }, t.prototype.get = function(t, e) {
        var n = this;
        if (We("DocumentSnapshot.get", arguments, 1, 2), e = kr("DocumentSnapshot.get", e), 
        this.yf) {
            var r = this.yf.data().field(On("DocumentSnapshot.get", t));
            if (null !== r) return new yr(this.If.xo, this.If.Ef(), e.serverTimestamps || "none", (function(t) {
                return new _r(t, n.If, n.Uo);
            })).j_(r);
        }
        ...
        get: function() {
            return new _r(this.Bo, this.If, this.Uo);
        },
        enumerable: !0,
        configurable: !0
        ...
        get: function() {
            return new Er(this.bf, this.gf);
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw on("isEqual", "DocumentSnapshot", 1, e);
...
}(Ir), Ar = /** @class */ function(t) {
    function n(e, n, r) {
        var i = this;
        return (i = t.call(this, n.xo, n.af, e) || this).vf = e, i.firestore = n, i.Uo = r, 
        i;
    }
    return e.__extends(n, t), n.prototype.where = function(t, e, r) {
        ze("Query.where", arguments, 3), nn("Query.where", 3, r);
        // Enumerated from the WhereFilterOp type in index.d.ts.
        var i = Je("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ ], 2, e), o = On("Query.where", t), s = this.Sf(o, i, r);
        return new n(this.vf.Ht(s), this.firestore, this.Uo);
    }, n.prototype.orderBy = function(t, e) {
        var r;
        if (We("Query.orderBy", arguments, 1, 2), Ye("Query.orderBy", "non-empty string", 2, e), 
        void 0 === e || "asc" === e) r = "asc" /* ASCENDING */; else {
            if ("desc" !== e) throw new c(h.INVALID_ARGUMENT, "Function Query.orderBy() has unknown direction '" + e + "', expected 'asc' or 'desc'.");
            r = "desc" /* DESCENDING */;
        }
        var i = On("Query.orderBy", t), o = this.Nf(i, r);
        return new n(this.vf.Kt(o), this.firestore, this.Uo);
    }, n.prototype.limit = function(t) {
        return ze("Query.limit", arguments, 1), He("Query.limit", "number", 1, t), sn("Query.limit", 1, t), 
        new n(this.vf.zt(t), this.firestore, this.Uo);
    }, n.prototype.limitToLast = function(t) {
        return ze("Query.limitToLast", arguments, 1), He("Query.limitToLast", "number", 1, t), 
        sn("Query.limitToLast", 1, t), new n(this.vf.Yt(t), this.firestore, this.Uo);
    }, n.prototype.startAt = function(t) {
        for (var e = [], r = 1; r < arguments.length; r++) e[r - 1] = arguments[r];
        Qe("Query.startAt", arguments, 1);
        var i = this.Mf("Query.startAt", t, e, 
        /*before=*/ !0);
        return new n(this.vf.Xt(i), this.firestore, this.Uo);
    }, n.prototype.startAfter = function(t) {
        for (var e = [], r = 1; r < arguments.length; r++) e[r - 1] = arguments[r];
        Qe("Query.startAfter", arguments, 1);
        var i = this.Mf("Query.startAfter", t, e, 
        /*before=*/ !1);
        return new n(this.vf.Xt(i), this.firestore, this.Uo);
    }, n.prototype.endBefore = function(t) {
        for (var e = [], r = 1; r < arguments.length; r++) e[r - 1] = arguments[r];
        Qe("Query.endBefore", arguments, 1);
        var i = this.Mf("Query.endBefore", t, e, 
        /*before=*/ !0);
        return new n(this.vf.Jt(i), this.firestore, this.Uo);
    }, n.prototype.endAt = function(t) {
        for (var e = [], r = 1; r < arguments.length; r++) e[r - 1] = arguments[r];
        Qe("Query.endAt", arguments, 1);
        var i = this.Mf("Query.endAt", t, e, 
        /*before=*/ !1);
        return new n(this.vf.Jt(i), this.firestore, this.Uo);
    }, n.prototype.isEqual = function(t) {
        if (!(t instanceof n)) throw on("isEqual", "Query", 1, t);
        return this.firestore === t.firestore && this.vf.isEqual(t.vf) && this.Uo === t.Uo;
    }, n.prototype.withConverter = function(t) {
        return new n(this.vf, this.firestore, t);
    }, 
    /** Helper function to create a bound from a document or fields */ n.prototype.Mf = function(t, n, r, i) {
        if (nn(t, 1, n), n instanceof Ir) return ze(t, e.__spreadArrays([ n ], r), 1), this.Lf(t, n.yf, i);
        var o = [ n ].concat(r);
        return this.Of(t, o, i);
    }, n.prototype.onSnapshot = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        We("Query.onSnapshot", arguments, 1, 4);
        var n, r = {}, i = 0;
        return "object" != typeof t[i] || dr(t[i]) || (rn("Query.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        Xe("Query.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++), dr(t[i]) ? n = t[i] : (He("Query.onSnapshot", "function", i, t[i]), Ye("Query.onSnapshot", "function", i + 1, t[i + 1]), 
        Ye("Query.onSnapshot", "function", i + 2, t[i + 2]), n = {
            next: t[i],
            error: t[i + 1],
            complete: t[i + 2]
        }), this.kf(this.vf), this.Vf(r, n);
    }, n.prototype.Vf = function(t, e) {
        var n = this, r = function(t) {
            console.error("Uncaught Error in onSnapshot:", t);
        };
        ...
        var i = new pr({
            next: function(t) {
                e.next && e.next(new Tr(n.firestore, n.vf, t, n.Uo));
            },
            error: r
        ...
        var e = this;
        return We("Query.get", arguments, 0, 1), Sr("Query.get", t), this.kf(this.vf), new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.tf().x_(e.vf).then((function(t) {
                n(new Tr(e.firestore, e.vf, t, e.Uo));
            }), r) : e.pf(n, r, t);
        }));
    }, n.prototype.pf = function(t, e, n) {
        var r = this.Vf({
    ...
    function t(t, e, n) {
        this.xo = t, this.af = e, this.vf = n;
    }
    return t.prototype.Sf = function(t, e, n) {
        var r;
        if (t.Y()) {
            if ("array-contains" /* ARRAY_CONTAINS */ === e || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e) throw new c(h.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + e + "' queries on FieldPath.documentId().");
            if ("in" /* IN */ === e) {
                this.Cf(n, e);
        ...
        } else "in" /* IN */ !== e && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== e || this.Cf(n, e), 
        r = this.af.ea("Query.where", n, 
        // We only allow nested arrays for IN queries.
        /** allowArrays = */ "in" /* IN */ === e);
        var a = wt.create(t, e, r);
        return this.Ff(a), a;
    }, t.prototype.Nf = function(t, e) {
        if (null !== this.vf.startAt) throw new c(h.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.vf.endAt) throw new c(h.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
        var n = new Tt(t, e);
        return this.$f(n), n;
    }, 
    /**
    ...
    t.prototype.Lf = function(t, e, n) {
        if (!e) throw new c(h.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + t + "().");
        ...
        // results.
        for (var r = [], i = 0, o = this.vf.orderBy; i < o.length; i++) {
            var s = o[i];
            if (s.field.Y()) r.push(j(this.xo, e.key)); else {
                var u = e.field(s.field);
                if (k(u)) throw new c(h.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + s.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === u) {
                    var a = s.field.j();
                    throw new c(h.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + a + "' (used as the orderBy) does not exist.");
                }
                r.push(u);
            }
        }
    ...
    t.prototype.Of = function(t, e, n) {
        ...
        for (var i = [], o = 0; o < e.length; o++) {
            ...
            if (r[o].field.Y()) {
                ...
                if (!this.vf.le() && -1 !== s.indexOf("/")) throw new c(h.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + t + "() must be a plain document ID, but '" + s + "' contains a slash.");
                var u = this.vf.path.child(w.G(s));
    ...
    t.prototype.Df = function(t) {
        if ("string" == typeof t) {
            ...
            if (!this.vf.le() && -1 !== t.indexOf("/")) throw new c(h.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + t + "' contains a '/' character.");
            var e = this.vf.path.child(w.G(t));
            ...
            return j(this.xo, new E(e));
        }
        if (t instanceof An) return j(this.xo, t.Bo);
        throw new c(h.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + en(t) + ".");
    }, 
    /**
    ...
    function t(t, e, n, r) {
        this.If = t, this.xf = e, this.Bf = n, this.Uo = r, this.Uf = null, this.Qf = null, 
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        var n = this;
        We("QuerySnapshot.forEach", arguments, 1, 2), He("QuerySnapshot.forEach", "function", 1, t), 
        this.Bf.docs.forEach((function(r) {
            t.call(e, n.Wf(r));
        }));
    }, Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new Ar(this.xf, this.If, this.Uo);
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.docChanges = function(t) {
        t && (rn("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), Xe("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
        var e = !(!t || !t.includeMetadataChanges);
        if (e && this.Bf.hs) throw new c(h.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function(t, e, n, r) {
            if (n.ss.M()) {
                ...
                return n.docChanges.map((function(e) {
                    var o = new Nr(t, e.doc.key, e.doc, n.fromCache, n.ns.has(e.doc.key), r);
                    return e.doc, {
                        type: "added",
                        doc: o,
                        oldIndex: -1,
            ...
            return n.docChanges.filter((function(t) {
                ...
                var i = new Nr(t, e.doc.key, e.doc, n.fromCache, n.ns.has(e.doc.key), r), s = -1, u = -1;
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw on("isEqual", "QuerySnapshot", 1, e);
        return this.If === e.If && this.xf.isEqual(e.xf) && this.Bf.isEqual(e.Bf) && this.Uo === e.Uo;
    }, t.prototype.Wf = function(t) {
        return new Nr(this.If, t.key, t, this.metadata.fromCache, this.Bf.ns.has(t.key), this.Uo);
    }, t;
}(), Dr = /** @class */ function(t) {
    function n(e, n, r) {
        var i = this;
        if ((i = t.call(this, gt.Wt(e), n, r) || this).jf = e, e.length % 2 != 1) throw new c(h.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + e.j() + " has " + e.length);
        return i;
    }
    return e.__extends(n, t), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.M() ? null : new _r(new E(t), this.firestore, 
            /* converter= */ null);
        },
        enumerable: !0,
        configurable: !0
        ...
        We("CollectionReference.doc", arguments, 0, 1), 
        // We allow omission of 'pathString' but explicitly prohibit passing in both
        // 'undefined' and 'null'.
        0 === arguments.length && (t = me.cn()), He("CollectionReference.doc", "non-empty string", 1, t);
        var e = w.G(t);
        return _r.Tf(this.vf.path.child(e), this.firestore, this.Uo);
    }, n.prototype.add = function(t) {
        ze("CollectionReference.add", arguments, 1), He("CollectionReference.add", "object", 1, this.Uo ? this.Uo.toFirestore(t) : t);
        var e = this.doc();
        return e.set(t).then((function() {
            return e;
        }));
    }, n.prototype.withConverter = function(t) {
        return new n(this.jf, this.firestore, t);
    }, n;
}(Ar);
...
function Vr(t, e) {
    ...
    if (rn(t, e, [ "merge", "mergeFields" ]), Xe(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new c(h.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + en(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new c(h.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + en(r[o]));
        }(t, e, n, r, i);
    }(t, "mergeFields", "a string or a FieldPath", e.mergeFields, (function(t) {
        return "string" == typeof t || t instanceof pn;
...
function kr(t, e) {
    return void 0 === e ? {} : (rn(t, e, [ "serverTimestamps" ]), $e(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function Sr(t, e) {
    Ye(t, "object", 1, e), e && (rn(t, e, [ "source" ]), $e(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
function Ur(t, e, n) {
    ...
    throw on(t, "DocumentReference", 1, e);
}
...
var Or = Pr(gr, "Use firebase.firestore() instead."), qr = Pr(wr, "Use firebase.firestore().runTransaction() instead."), Mr = Pr(br, "Use firebase.firestore().batch() instead."), Cr = Pr(_r, "Use firebase.firestore().doc() instead."), xr = Pr(Ir), Fr = Pr(Nr), jr = Pr(Ar), Br = Pr(Tr), Gr = Pr(Dr, "Use firebase.firestore().collection() instead."), zr = Pr(_n, "Use FieldValue.<field>() instead."), Qr = Pr(fn, "Use Blob.fromUint8Array() or Blob.fromBase64String() instead."), Wr = {
    Firestore: Or,
    GeoPoint: In,
    Timestamp: v,
    Blob: Qr,
    ...
    FieldPath: pn,
    FieldValue: zr,
    setLogLevel: gr.setLogLevel,
    CACHE_SIZE_UNLIMITED: vr
}, Hr = /** @class */ function() {
    function t() {}
    ...
    return t.prototype.ou = function(t) {
        ...
        for (var t = 0, e = this.Yf; t < e.length; t++) {
            (0, e[t])(0 /* AVAILABLE */);
        }
    ...
    Commit: "commit"
}, $r = "gl-js/ fire/" + u, Jr = /** @class */ function() {
    function t(t) {
        this.ii = t.ii;
     ...
     */    return t.prototype.ud = function(t, e) {
        ...
        return new Promise((function(o, u) {
                ...
                try {
                    switch (a.getLastErrorCode()) {
                      case s.ErrorCode.NO_ERROR:
                        ...
                        fe("Connection", "XHR received:", JSON.stringify(e)), o(e);
                        break;

                      case s.ErrorCode.TIMEOUT:
                        fe("Connection", 'RPC "' + t + '" timed out'), u(new c(h.DEADLINE_EXCEEDED, "Request time out"));
                        break;

                      case s.ErrorCode.HTTP_ERROR:
                        var n = a.getStatus();
                        if (fe("Connection", 'RPC "' + t + '" failed with status:', n, "response text:", a.getResponseText()), 
                        n > 0) {
                        ...
                        fe("Connection", 'RPC "' + t + '" failed'), u(new c(h.UNAVAILABLE, "Connection failed."));
                        break;
            ...
            r.ud(p, n), a.send(i, "POST", l, p, 15);
        }));
    }, t.prototype.Oa = function(t, e, n) {
        // The REST API automatically aggregates all of the streamed results, so we
        // can just use the normal invoke() method.
        return this.La(t, e, n);
    }, t.prototype.Pa = function(t, n) {
        var o = [ this.ad, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], a = s.createWebChannelTransport(), f = {
        ...
        this.ud(f.initMessageHeaders, n), 
        ...
        var l = o.join("");
        fe("Connection", "Creating WebChannel: " + l + " " + f);
        var p = a.createWebChannel(l, f), d = !1, y = !1, v = new Kr({
            Zf: function(t) {
                y ? fe("Connection", "Not sending because WebChannel is closed:", t) : (d || (fe("Connection", "Opening WebChannel transport."), 
                p.open(), d = !0), fe("Connection", "WebChannel sending:", t), p.send(t));
            },
            td: function() {
                return p.close();
            }
        ...
        return m(s.WebChannel.EventType.OPEN, (function() {
            y || fe("Connection", "WebChannel transport opened.");
        })), m(s.WebChannel.EventType.CLOSE, (function() {
            y || (y = !0, fe("Connection", "WebChannel transport closed"), v.hd());
        })), m(s.WebChannel.EventType.ERROR, (function(t) {
            y || (y = !0, function(t) {
                for (var n = [], i = 1; i < arguments.length; i++) n[i - 1] = arguments[i];
            ...
            }("Connection", "WebChannel transport errored:", t), v.hd(new c(h.UNAVAILABLE, "The operation could not be completed")));
        })), m(s.WebChannel.EventType.MESSAGE, (function(t) {
            var e;
            if (!y) {
                var n = t.data[0];
                ye(!!n);
                ...
                if (i) {
                    fe("Connection", "WebChannel received error:", i);
                    ...
                    y = !0, v.hd(new c(s, u)), p.close();
                } else fe("Connection", "WebChannel received:", n), v.od(n);
            }
        })), setTimeout((function() {
...
ae.an(new (/** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "document", {
        ...
        return Promise.resolve(new Jr(t));
    }, t.prototype.D_ = function() {
        return Yr.Jf() ? new Yr : new Hr;
...
}())), Zr(n), exports.__PRIVATE_registerFirestore = Zr;
