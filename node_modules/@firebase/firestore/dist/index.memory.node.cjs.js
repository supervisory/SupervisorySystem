...
var DatastoreImpl = /** @class */ (function (_super) {
    ...
    DatastoreImpl.prototype.verifyNotTerminated = function () {
        if (this.terminated) {
...
var UserDataReader = /** @class */ (function () {
    ...
    UserDataReader.prototype.parseSetData = function (methodName, input, options) {
        if (options === void 0) { options = {}; }
        var context = this.createContext(options.merge || options.mergeFields
            ? 2 /* MergeSet */
            : 0 /* Set */, methodName);
...
var Transaction$1 = /** @class */ (function () {
    ...
    Transaction$1.prototype.set = function (documentRef, value, options) {
        ...
        var parsed = this._firestore._dataReader.parseSetData(functionName, convertedValue, options);
...
var DocumentReference = /** @class */ (function (_super) {
    ...
    DocumentReference.prototype.set = function (value, options) {
        ...
        var parsed = this.firestore._dataReader.parseSetData(functionName, convertedValue, options);
...
var BaseQuery = /** @class */ (function () {
    function BaseQuery(_databaseId, _dataReader, _query) {
        this._databaseId = _databaseId;
        this._dataReader = _dataReader;
        this._query = _query;
    }
    BaseQuery.prototype.createFilter = function (fieldPath, op, value) {
        var fieldValue;
        if (fieldPath.isKeyField()) {
            ...
            fieldValue = this._dataReader.parseQueryValue('Query.where', value, 
    ...
    BaseQuery.prototype.createOrderBy = function (fieldPath, direction) {
     ...
     * server timestamp.
     */
    BaseQuery.prototype.boundFromDocument = function (methodName, doc, before) {
        if (!doc) {
     ...
     */
    BaseQuery.prototype.boundFromFields = function (methodName, values, before) {
        ...
        for (var i = 0; i < values.length; i++) {
            ...
            if (orderByComponent.field.isKeyField()) {
                ...
                var wrapped = this._dataReader.parseQueryValue(methodName, rawValue);
                components.push(wrapped);
            }
        }
        return new Bound(components, before);
    };
    BaseQuery.prototype.validateHasExplicitOrderByForLimitToLast = function (query) {
     ...
     */
    BaseQuery.prototype.parseDocumentIdValue = function (documentIdValue) {
     ...
     * array requirements.
     */
    BaseQuery.prototype.validateDisjunctiveFilterElements = function (value, operator) {
    ...
    BaseQuery.prototype.validateNewFilter = function (filter) {
        if (filter instanceof FieldFilter) {
    ...
    BaseQuery.prototype.validateNewOrderBy = function (orderBy) {
    ...
    BaseQuery.prototype.validateOrderByAndInequalityMatch = function (inequality, orderBy) {
...
var Query$1 = /** @class */ (function (_super) {
    ...
    function Query$1(_query, firestore, _converter) {
        var _this = _super.call(this, firestore._databaseId, firestore._dataReader, _query) || this;
        _this._query = _query;
        _this.firestore = firestore;
        _this._converter = _converter;
        return _this;
    ...
    Query$1.prototype.where = function (field, opStr, value) {
        ...
        var filter = this.createFilter(fieldPath, op, value);
    ...
    Query$1.prototype.orderBy = function (field, directionStr) {
        ...
        var orderBy = this.createOrderBy(fieldPath, direction);
