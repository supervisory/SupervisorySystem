...
class UserDataReader {
    ...
    parseSetData(methodName, input, options = {}) {
        const context = this.createContext(options.merge || options.mergeFields
            ? 2 /* MergeSet */
            : 0 /* Set */, methodName);
...
class Transaction$1 {
    ...
    set(documentRef, value, options) {
        ...
        const parsed = this._firestore._dataReader.parseSetData(functionName, convertedValue, options);
...
class DocumentReference extends DocumentKeyReference {
    ...
    set(value, options) {
        ...
        const parsed = this.firestore._dataReader.parseSetData(functionName, convertedValue, options);
...
class BaseQuery {
    constructor(_databaseId, _dataReader, _query) {
        this._databaseId = _databaseId;
        this._dataReader = _dataReader;
        this._query = _query;
    }
    createFilter(fieldPath, op, value) {
        let fieldValue;
    ...
    createOrderBy(fieldPath, direction) {
...
class Query$1 extends BaseQuery {
