...
var E = {
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.m !== e ? (Ne("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (De("string" == typeof n.accessToken), new N(n.accessToken, t.currentUser)) : null;
...
var R = /^[_a-zA-Z][_a-zA-Z0-9]*$/, P = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.$ = function(t, e, r) {
    ...
    n.J = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new I(E.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                ...
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new I(E.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new I(E.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n;
}(S);

/** A dot-separated path for navigating sub-objects within a document. */ P.H = new P([]);
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Q(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return Ue(t.arrayValue.values || [], e.arrayValue.values || [], Q);
...
function H(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = Se($(t.latitude), $(e.latitude));
            return 0 !== n ? n : Se($(t.longitude), $(e.longitude));
...
function Y(t, e) {
    ...
    var n = X(t), r = X(e), i = Se(n.seconds, r.seconds);
    return 0 !== i ? i : Se(n.nanos, r.nanos);
}
...
function K(t) {
    return function t(e) {
        ...
        O.Z(r).toString()) : "geoPointValue" in e ? "geo(" + (n = e.geoPointValue).latitude + "," + n.longitude + ")" : "arrayValue" in e ? function(e) {
...
var st = /** @class */ function() {
    ...
    return t.prototype.ot = function(t, e) {
        ...
        return e instanceof t && Ue(this.elements, e.elements, Q);
    }, t;
}(), ut = /** @class */ function() {
    function t(t) {
        this.elements = t;
    ...
    t.prototype.ut = function(t) {
        ...
        return e instanceof t && Q(this.ct, e.ct);
...
e) {
     ...
     */
    t.It = function(t) {
        return t instanceof _t ? t.version : k.min();
    }, t;
}(), yt = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
    ...
    return t(n, e), n.prototype.at = function(t, e) {
        ...
        return this.Et(t), this.Rt.Tt(t) ? new Dt(this.key, k.min()) : t;
    }, n.prototype.Pt = function(t) {
        return null;
    }, n.prototype.isEqual = function(t) {
...
var Nt, At, Tt = function(t, e) {
    ...
    return t.prototype.canonicalId = function() {
        ...
        return O.et(this.path) && null === this.collectionGroup && 0 === this.filters.length;
    }, t;
}(), St = /** @class */ function() {
    /**
    ...
    // in the Lite client become tree-shakeable.
        ...
        get: function() {
            if (null === this.Bt) {
                ...
                t.Y() || this.Bt.push(new Ct(t)), this.Bt.push(new Ct(P.X(), "asc" /* ASCENDING */)); else {
    ...
    t.prototype.canonicalId = function() {
        ...
        return !F(this.limit) && "F" /* First */ === this.xt;
    }, t.prototype.ae = function() {
        return !F(this.limit) && "L" /* Last */ === this.xt;
    ...
    t.prototype.ee = function() {
        ...
        var e = t.key.path;
        return null !== this.collectionGroup ? t.key.tt(this.collectionGroup) && this.path.B(e) : O.et(this.path) ? this.path.isEqual(e) : this.path.U(e);
    }, 
    /**
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        if (t.Y()) return "in" /* IN */ === e ? new Pt(t, r) : new Rt(t, e, r);
        if (nt(r)) {
        ...
        // Only compare types with matching backend order (such as double and int).
                return null !== e && z(this.value) === z(e) && this.fe(H(e, this.value));
        ...
        return this.field.j() + this.op.toString() + K(this.value);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n && this.op === t.op && this.field.isEqual(t.field) && Q(this.value, t.value);
    }, n.prototype.toString = function() {
        return this.field.j() + " " + this.op + " " + K(this.value);
    }, n;
}((function() {})), Rt = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, r) || this).key = O.Z(r.referenceValue), i;
    }
    return t(n, e), n.prototype.matches = function(t) {
        var e = O.N(t.key, this.key);
        return this.fe(e);
    }, n;
    ...
    return t(n, e), n.prototype.matches = function(t) {
        var e = t.field(this.field);
        return et(e) && W(e.arrayValue, this.value);
    }, n;
    ...
    return t(n, e), n.prototype.matches = function(t) {
        ...
        return !(!et(n) || !n.arrayValue.values) && n.arrayValue.values.some((function(t) {
            return W(e.value.arrayValue, t);
        }));
    }, n;
}(Ut), Mt = /** @class */ function() {
    function t(t, e) {
    ...
    t.prototype._e = function(t, e) {
        for (var n = 0, r = 0; r < this.position.length; r++) {
            ...
            if (n = i.field.Y() ? O.N(O.Z(o.referenceValue), e.key) : H(o, e.field(i.field)), 
    ...
    return t.prototype.compare = function(t, e) {
        var n = this.de ? O.N(t.key, e.key) : function(t, e, n) {
            var r = e.field(t), i = n.field(t);
            return null !== r && null !== i ? H(r, i) : _e();
        }(this.field, t, e);
        switch (this.dir) {
          case "asc" /* ASCENDING */ :
            return n;
     ...
     */ , s) {
        void 0 === i && (i = k.min()), void 0 === o && (o = k.min()), void 0 === s && (s = C.ht), 
...
var Gt = /** @class */ function() {
    ...
    // Returns a copy of the map, with the specified key/value added or replaced.
        ...
        return new t(this.N, this.root.me(e, n, this.N).Ae(null, null, Qt.Pe, null, null));
    }, 
...
var Zt = new Gt(O.N), te = new Wt(O.N);
 ...
 */ var ie = /** @class */ function() {
    ...
    function t(t) {
        ...
        this.N = t ? function(e, n) {
            return t(e, n) || O.N(e.key, n.key);
        } : function(t, e) {
            return O.N(t.key, e.key);
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, ae.fs(e, n)), new t(k.min(), r, re(), Kt(), ee());
    }, t;
}(), ae = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    return t.prototype.Bs = function(t) {
        for (var e = 0, n = t.Is; e < n.length; e++) {
            var r = n[e];
            t.Rs instanceof _t ? this.Us(r, t.Rs) : t.Rs instanceof Dt && this.Qs(r, t.key, t.Rs);
        }
    ...
    t.prototype.Js = function(t) {
        ...
        return this.qs = Kt(), this.Ms = de(), this.xs = new Wt(Se), i;
    }, 
    /**
    ...
    t.prototype.Ns = function(t) {
        ...
        var e = this.Ms.get(t);
        return e || (e = new Wt(Se), this.Ms = this.Ms.me(t, e)), e;
    }, 
    /**
 ...
 */ var ve = {
    ...
    return t.prototype.ni = function(t) {
        var e = void 0 === t.code ? E.UNKNOWN : Bt(t.code);
    ...
    t.prototype.ci = function(t) {
        return this.options.hi ? (De(void 0 === t || "string" == typeof t), C.fromBase64String(t || "")) : (De(void 0 === t || t instanceof Uint8Array), 
        C.fromUint8Array(t || new Uint8Array));
    }, t.prototype.toVersion = function(t) {
        return this.D(t.D());
    }, t.prototype.fromVersion = function(t) {
        return De(!!t), k.v(this.v(t));
        ...
        // in the local target cache.
                return 4 === e.length ? U.H : this.wi(e);
    }, Object.defineProperty(t.prototype, "Ii", {
        get: function() {
            return new U([ "projects", this.ii.projectId, "databases", this.ii.database ]).j();
        },
        enumerable: !0,
        configurable: !0
    ...
    /** Creates an api.Document from key and fields (but no create/update time) */ t.prototype.Ri = function(t, e) {
        ...
        if ("targetChange" in t) {
            ...
            d.document;
            var y = this.Z(d.document), v = d.readTime ? this.fromVersion(d.readTime) : k.min(), m = new Dt(y, v), g = d.removedTargetIds || [];
            e = new he([], g, m.key, m);
        ...
        return e.targetIds && e.targetIds.length ? k.min() : e.readTime ? this.fromVersion(e.readTime) : k.min();
    }, t.prototype.vi = function(t) {
        var e, n = this;
        ...
        var c = null;
        return n.endAt && (c = this.Hi(n.endAt)), new St(e, i, u, s, a, "F" /* First */ , h, c).ee();
...
function Ne(t) {
    ...
    if (Ee.logLevel <= s.DEBUG) {
        var i = e.map(Te);
        Ee.debug.apply(Ee, r([ "Firestore (" + w + "): " + t ], i));
    }
}

function Ae(t) {
    for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
    if (Ee.logLevel <= s.ERROR) {
        var i = e.map(Te);
        Ee.error.apply(Ee, r([ "Firestore (" + w + "): " + t ], i));
    }
}
...
function(t, e, n, r, i) {
    ...
    return t.from = function(e, n, r) {
        ...
        for (var i = Zt, o = e.mutations, s = 0; s < o.length; s++) i = i.me(o[s].key, r[s].version);
    ...
    t.prototype.Bn = function(t, e, n) {
        ...
        return this.Nn(t, new O(e)).next((function(t) {
            var e = Jt();
            return t instanceof _t && (e = e.me(t.key, t)), e;
        }));
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Hn(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    ...
                    r = f instanceof _t ? r.me(h, f) : r.remove(h);
                }
            }));
        })).next((function() {
        ...
        return this.Cn.getEntries(t, r).next((function(t) {
            return t.forEach((function(t, e) {
                null !== e && e instanceof _t && (h = h.me(t, e));
            })), h;
        }));
    }, t;
}(), Fe = /** @class */ function() {
...
var je = function() {
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.q(), n = t.O(), r = this.index[e] || new Wt(U.N), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.q(), n = t.O(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new Wt(U.N)).W();
    }, t;
}(), Qe = /** @class */ function() {
    function t(t) {
        this.Rr = t;
 ...
 */
function Ke(t, e) {
    if (Ae("AsyncQueue", e + ": " + t), We(t)) return new I(E.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
var $e = /** @class */ function() {
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this._h = k.min(), this.Dn = t.fh(n), this.dh = t.wh(), this.Th = t.Eh(), this.Ih = new Ce(this.dh, this.Dn, this.persistence.Rh()), 
        this.ah.mh(this.Ih)
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = this.Dn, r = this.Ih, [ 4 /*yield*/ , this.persistence.runTransaction("Handle user change", "readonly", (function(n) {
                        ...
                        return o.Dn.Ph(n).next((function(s) {
                            ...
                            // MutationQueue.
                            r = new Ce(o.dh, e, o.persistence.Rh()), e.Ph(n);
                        })).next((function(t) {
                  ...
                  case 1:
                    return i = n.sent(), [ 2 /*return*/ , (this.Dn = e, this.Ih = r, this.ah.mh(this.Ih), 
                    i) ];
                }
            }));
        }));
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            u.push(s.getEntries(o, h).next((function(t) {
                e.cs.forEach((function(i, h) {
                    ...
                    // cache.
                                        h instanceof Dt && h.version.isEqual(k.min()) ? (
                    ...
                    a = a.me(i, h)) : Ne("LocalStore", "Ignoring outdated watch update for ", i, ". Current version:", c.version, " Watch version:", h.version), 
    ...
    t.Qh = function(t, e, n) {
        ...
        return De(e.resumeToken.rt() > 0), 0 === t.resumeToken.rt() || (
    ...
    t.prototype.ao = function(t, e) {
        ...
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.no(o, t.ee()).next((function(t) {
                ...
                return n.ah.Bn(o, t, e ? r : k.min(), e ? i : ee());
            })).next((function(t) {
                return {
                    documents: t,
                    co: i
...
var Ze = /** @class */ function() {
    ...
    t.prototype.mo = function(t) {
        var e = this, n = O.EMPTY, r = new tn(n, t), i = new tn(n, t + 1), o = [];
        ...
        var e = O.EMPTY, n = new tn(e, t), r = new tn(e, t + 1), i = ee();
    ...
    return t.do = function(t, e) {
        return O.N(t.key, e.key) || Se(t.po, e.po);
    }, 
    /** Compare by ID then by key */ t.To = function(t, e) {
        return Se(t.po, e.po) || O.N(t.key, e.key);
    }, t;
}();
 ...
 */
function en(t, e) {
    if (0 !== e.length) throw new I(E.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + bn(e.length, "argument") + ".");
}
 ...
 */ function nn(t, e, n) {
    if (e.length !== n) throw new I(E.INVALID_ARGUMENT, "Function " + t + "() requires " + bn(n, "argument") + ", but was called with " + bn(e.length, "argument") + ".");
}
 ...
 */ function rn(t, e, n) {
    if (e.length < n) throw new I(E.INVALID_ARGUMENT, "Function " + t + "() requires at least " + bn(n, "argument") + ", but was called with " + bn(e.length, "argument") + ".");
}
 ...
 */ function on(t, e, n, r) {
    if (e.length < n || e.length > r) throw new I(E.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + bn(e.length, "argument") + ".");
}
...
function cn(t, e, n, r, i) {
    void 0 !== r && function(t, e, n, r, i) {
        ...
        var h = dn(r);
        throw new I(E.INVALID_ARGUMENT, "Invalid value " + h + " provided to function " + t + '() for option "' + n + '". Acceptable values: ' + o.join(", "));
    }(t, 0, n, r, i);
}
 ...
 */ function fn(t, e, n, r) {
    if (!e.some((function(t) {
        return t === r;
    }))) throw new I(E.INVALID_ARGUMENT, "Invalid value " + dn(r) + " provided to function " + t + "() for its " + wn(n) + " argument. Acceptable values: " + e.join(", "));
    return r;
}
...
function yn(t, e, n) {
    if (void 0 === n) throw new I(E.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + wn(e) + " argument, but it was undefined.");
}
 ...
 */ function mn(t, e, n, r) {
    var i = dn(r);
    return new I(E.INVALID_ARGUMENT, "Function " + t + "() requires its " + wn(n) + " argument to be a " + e + ", but it was: " + i);
}

function gn(t, e, n) {
    if (n <= 0) throw new I(E.INVALID_ARGUMENT, "Function " + t + "() requires its " + wn(e) + " argument to be a positive number, but it was: " + n + ".");
}
...
/** Helper function to assert Base64 functions are available at runtime. */ function In() {
    if (!be.nt().yo) throw new I(E.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ var Nn = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        ...
        try {
            ...
            throw new I(E.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + e);
        }
    }, t.fromUint8Array = function(e) {
    ...
    !function(t, e, n, r) {
        if (!(e instanceof Array) || e.length < 1) throw new I(E.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + bn(1, "element") + ".");
    }(0, t);
    for (var e = 0; e < t.length; ++e) if (sn("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new I(E.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
    this.vo = new P(t);
}, Tn = /** @class */ function(e) {
    /**
...
var _n = new RegExp("[~\\*/\\[\\]]"), Dn = function() {
    ...
    return t(n, e), n.prototype.Fo = function(t) {
    ...
    return t(n, e), n.delete = function() {
        return en("FieldValue.delete", arguments), new On(new Vn("FieldValue.delete"));
    }, n.serverTimestamp = function() {
        return en("FieldValue.serverTimestamp", arguments), new On(new kn("FieldValue.serverTimestamp"));
    }, n.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return rn("FieldValue.arrayUnion", arguments, 1), new On(new Sn("FieldValue.arrayUnion", t));
    }, n.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return rn("FieldValue.arrayRemove", arguments, 1), new On(new Un("FieldValue.arrayRemove", t));
    }, n.increment = function(t) {
        return sn("FieldValue.increment", "number", 1, t), nn("FieldValue.increment", arguments, 1), 
        new On(new Rn("FieldValue.increment", t));
    }, n;
     ...
     */
    t.prototype.g = function(t) {
        return Se(this.qo, t.qo) || Se(this.Mo, t.Mo);
    }, t;
...
/** A "context" object passed around while parsing user data. */ var jn = /** @class */ function() {
    ...
    return t.prototype.Xo = function(t, e, n) {
        ...
        if (n.merge) i = new ct(r.Vt), o = r.fieldTransforms; else if (n.mergeFields) {
            for (var u = [], a = 0, h = n.mergeFields; a < h.length; a++) {
                ...
                if (!r.contains(f)) throw new I(E.INVALID_ARGUMENT, "Field '" + f + "' is specified in your field mask but missing from your input data.");
                Kn(u, f) || u.push(f);
            }
    ...
    /** Parse update data from an update() call. */ t.prototype.Zo = function(t, e) {
        ...
        q(e, (function(e, o) {
            ...
            if (o instanceof Dn && o.Co instanceof Vn) 
    ...
    /** Parse update data from a list of field/value arguments. */ t.prototype.ta = function(t, e, n, r) {
        ...
        if (r.length % 2 != 0) throw new I(E.INVALID_ARGUMENT, "Function " + t + "() needs to be called with an even number of arguments that alternate between field names and values.");
        ...
        for (var a = [], h = new Et, c = o.length - 1; c >= 0; --c) if (!Kn(a, o[c])) {
            ...
            if (l instanceof Dn && l.Co instanceof Vn) 
            // Add it to the field mask, but don't add anything to updateData.
            a.push(f); else {
                var d = Gn(l, p);
...
function Qn(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof V || t instanceof Ln || t instanceof Nn || t instanceof Mn || t instanceof Dn);
}
 ...
 */ function Yn(t, e) {
    try {
        return function(t) {
            if (t.search(_n) >= 0) throw new I(E.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (Tn.bind.apply(Tn, r([ void 0 ], t.split("."))));
            } catch (e) {
        ...
        throw new I(E.INVALID_ARGUMENT, "Function " + t + "() called with invalid data. " + n);
    }
    /**
 ...
 */ var Xn = /** @class */ function() {
    ...
    t.prototype.wa = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new I(E.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.Ra(e);
            }));
        }));
    ...
    return t(n, e), n.prototype.ma = function(t) {
    ...
    return t(n, e), Object.defineProperty(n.prototype, "ba", {
        /**
    ...
    n.prototype.start = function() {
        this.ga = !1, this.lastStreamToken = C.ht, e.prototype.start.call(this);
    ...
    return t(n, e), n.prototype.$a = function() {
    ...
    /** Gets an auth token and invokes the provided RPC. */ n.prototype.La = function(t, e) {
        ...
        return this.$a(), this.credentials.getToken().then((function(r) {
            ...
            throw t.code === E.UNAUTHENTICATED && n.credentials.l(), t;
        }));
    }, 
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 6:
                    ...
                    r.isEqual(k.min())) return [ 3 /*break*/ , 13 ];
                    n.label = 7;
    ...
    t.prototype.Ou = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return jt(r = t.code) && r !== E.ABORTED ? (e = this.su.shift(), 
    ...
    return t.prototype.yc = function() {
        ...
        try {
            ...
            return !F(e) && e.catch && e.then ? e : (this.yr.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
n) {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    ...
                    a = o.Tc(s, 
                    /* updateLimboDocuments= */ this.Wc, u), this.Hc(r, a.Rc), h = new hr(t, r, o), 
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.Fc.tc(t, "rejected", r), e = this.Mc.get(t), (i = e && e.key) ? (o = (o = new Gt(O.N)).me(i, new Dt(i, k.min())), 
                    s = ee().add(i), u = new ue(k.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new Wt(Se), o, s), [ 4 /*yield*/ , this.Mh(u) ]) : [ 3 /*break*/ , 2 ];
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.sl = function(t) {
        ...
        n || (n = new Gt(Se)), n = n.me(t, e), this.Bc[this.currentUser.s()] = n;
    }, 
    /**
    ...
    t.prototype.Jc = function() {
        for (;this.kc.length > 0 && this.qc.size < this.Nc; ) {
            ...
            this.Mc.set(e, new cr(t)), this.qc = this.qc.me(t, e), this.Dc.listen(new Ft(St.Wt(t.path).ee(), e, 2 /* LimboResolution */ , xe.er));
        }
    }, 
    // Visible for testing
    ...
    return t.prototype.mh = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.te() || n.isEqual(k.min()) ? this.pl(t, e) : this.Vl.qn(t, r).next((function(o) {
            var u = i.yl(e, o);
            return (e.oe() || e.ae()) && i.wc(e.xt, u, r, n) ? i.pl(t, e) : (Ie() <= s.DEBUG && Ne("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), e.toString()), 
    ...
    t.prototype.wc = function(t, e, n, r) {
        ...
        return Ie() <= s.DEBUG && Ne("IndexFreeQueryEngine", "Using full collection scan to execute query:", e.toString()), 
        this.Vl.Bn(t, e, k.min());
    }, t;
}(), vr = /** @class */ function() {
    function t(t, e) {
        this.Fn = t, this.Kh = e, 
    ...
    return t.prototype.vl = function(t) {
        ...
        // because it precedes all other segments in an ordered traversal.
                O.et(i) || (i = i.child(""));
        var o = new tn(new O(i), 0), s = new Wt(Se);
    ...
    t.prototype.jh = function(t) {
        ...
        for (var r = Jt(), i = new O(e.path.child("")), o = this.docs.ve(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.$e(); ) {
            var s = o.Ne(), u = s.key, a = s.value, h = a.Ol, c = a.readTime;
            if (!e.path.B(u.path)) break;
            c.S(n) <= 0 || h instanceof _t && e.matches(h) && (r = r.me(h.key, h));
        }
        return Me.resolve(r);
...
mr.ql = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype.Tc = function(t) {
        var e = this, n = [];
...
var gr = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.Kl = new Ze, this.targetCount = 0, this.zl = Qe.mr();
    }
    return t.prototype.js = function(t, e) {
        ...
        return this.Kl.mo(e), Me.resolve();
    ...
    return t.prototype.initialize = function(t) {
                ...
                switch (n.label) {
                  ...
                  case 1:
                    ...
                    this.Su = this.y_(t), this.g_ = this.b_(t), this.Fc.Ga = function(t) {
                        return e.Su.mc(t, 1 /* SharedClientState */);
        ...
        if (t.C_.S_) throw new I(E.FAILED_PRECONDITION, Ir);
        return new wr(Er.T_);
    }, t.prototype.p_ = function(t) {
        var e = this;
        ...
        throw new I(E.FAILED_PRECONDITION, Ir);
    }, t;
}(), Ar = /** @class */ function() {
    function t(t, e, n, 
    /**
     ...
     */
    r) {
        this.platform = t, this.F_ = e, this.credentials = n, this.Pr = r, this.clientId = ke.cn()
        /**
                        ...
                        return e(i, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  ...
                                  case 1:
                                    return (e = n.sent()) instanceof _t ? r.resolve(e) : e instanceof Dt ? r.resolve(null) : r.reject(new I(E.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                    [ 3 /*break*/ , 3 ];
...
var Dr = /** @class */ function() {
    ...
    return t.prototype.j_ = function(t) {
        ...
        var e = X(t), n = new V(e.seconds, e.nanos);
        return this.timestampsInSnapshots ? n : n.toDate();
    }, t.prototype.K_ = function(t) {
        var e = U.G(t);
        De(we(e));
        var n = new Pe(e.get(1), e.get(3)), r = new O(e.L(5));
    ...
    function t(t) {
        ...
        hn("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Xe.hh; else {
            if (t.cacheSizeBytes !== Vr && t.cacheSizeBytes < Xe.rh) throw new I(E.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Xe.rh);
    ...
    function t(r, i, o) {
        ...
        this.Z_ = new Ye, this.INTERNAL = {
            ...
            var u = r;
            this.J_ = u, this.xo = t.sf(u), this.if = u.name, this.nf = new T(i);
        } else {
            var a = r;
            if (!a.projectId) throw new I(E.INVALID_ARGUMENT, "Must provide projectId");
            this.xo = new Pe(a.projectId, a.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.if = "[DEFAULT]", this.nf = new A;
        }
        this.rf = o, this.hf = new kr({});
    }
    return Object.defineProperty(t.prototype, "af", {
        ...
        i = !!t.experimentalForceOwningTab && t.experimentalForceOwningTab, r && i)) throw new I(E.INVALID_ARGUMENT, "The 'experimentalForceOwningTab' setting cannot be used with 'synchronizeTabs'.");
        ...
        return new Re(this.xo, this.if, this.hf.host, this.hf.ssl, this.hf.forceLongPolling);
    }, t.prototype.lf = function(t, e) {
        var n = this.ff();
        return this.ef = new Ar(be.nt(), n, this.nf, this.Z_), this.ef.start(t, e);
    }, t.sf = function(t) {
        if (e = t.options, "projectId", !Object.prototype.hasOwnProperty.call(e, "projectId")) throw new I(E.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
 ...
 */        if (!n || "string" != typeof n) throw new I(E.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        return this.tf(), new Mr(new St(U.H, t), this, 
        /* converter= */ null);
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        return this.mf = this.mf.concat(u.Qo(r.Bo, pt.dt())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        ...
        this.mf = this.mf.concat(i.Qo(r.Bo, pt.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        nn("WriteBatch.delete", arguments, 1), this.Pf();
        var e = Gr("WriteBatch.delete", t, this.If);
        return this.mf = this.mf.concat(new gt(e.Bo, pt.dt())), this;
    }, t.prototype.commit = function() {
    ...
    return t(n, e), n.Tf = function(t, e, r) {
        ...
        var i = new Tr({
            ...
            error: r
        }), o = this.ef.listen(St.Wt(this.Bo.path), i, t);
        return function() {
            i.U_(), n.ef.bu(o);
        };
        ...
        var r = this.Vf({
            ...
            next: function(i) {
                ...
                e(new I(E.UNAVAILABLE, "Failed to get document because the client is offline.")) : i.exists && i.metadata.fromCache && n && "server" === n.source ? e(new I(E.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : t(i);
            },
            error: e
        });
...
}(Lr), Mr = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, n.xo, n.af, t) || this).vf = t, i.firestore = n, i.Uo = r, 
        i;
    }
    return t(n, e), n.prototype.where = function(t, e, r) {
        nn("Query.where", arguments, 3), yn("Query.where", 3, r);
        // Enumerated from the WhereFilterOp type in index.d.ts.
        var i = fn("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ ], 2, e), o = Hn("Query.where", t), s = this.Sf(o, i, r);
        return new n(this.vf.Ht(s), this.firestore, this.Uo);
    }, n.prototype.orderBy = function(t, e) {
        var r;
        if (on("Query.orderBy", arguments, 1, 2), un("Query.orderBy", "non-empty string", 2, e), 
        ...
        var i = Hn("Query.orderBy", t), o = this.Nf(i, r);
        return new n(this.vf.Kt(o), this.firestore, this.Uo);
    }, n.prototype.limit = function(t) {
        return nn("Query.limit", arguments, 1), sn("Query.limit", "number", 1, t), gn("Query.limit", 1, t), 
        new n(this.vf.zt(t), this.firestore, this.Uo);
    }, n.prototype.limitToLast = function(t) {
        return nn("Query.limitToLast", arguments, 1), sn("Query.limitToLast", "number", 1, t), 
        gn("Query.limitToLast", 1, t), new n(this.vf.Yt(t), this.firestore, this.Uo);
        ...
        if (!(t instanceof n)) throw mn("isEqual", "Query", 1, t);
        return this.firestore === t.firestore && this.vf.isEqual(t.vf) && this.Uo === t.Uo;
    }, n.prototype.withConverter = function(t) {
        return new n(this.vf, this.firestore, t);
    }, 
    /** Helper function to create a bound from a document or fields */ n.prototype.Mf = function(t, e, n, i) {
        if (yn(t, 1, e), e instanceof Lr) return nn(t, r([ e ], n), 1), this.Lf(t, e.yf, i);
        var o = [ e ].concat(n);
        ...
        var e = this;
        return on("Query.get", arguments, 0, 1), Br("Query.get", t), this.kf(this.vf), new Promise((function(n, r) {
        ...
        var r = this.Vf({
            ...
            next: function(i) {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                r(), i.metadata.fromCache && n && "server" === n.source ? e(new I(E.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : t(i);
            },
            error: e
        });
    }, n;
    ...
    t.prototype.Lf = function(t, e, n) {
        ...
        for (var r = [], i = 0, o = this.vf.orderBy; i < o.length; i++) {
            var s = o[i];
            if (s.field.Y()) r.push(Z(this.xo, e.key)); else {
                var u = e.field(s.field);
                if (j(u)) throw new I(E.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + s.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === u) {
                    var a = s.field.j();
                    throw new I(E.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + a + "' (used as the orderBy) does not exist.");
                }
                r.push(u);
            }
        }
    ...
    t.prototype.Of = function(t, e, n) {
        ...
        var r = this.vf.Mt;
        if (e.length > r.length) throw new I(E.INVALID_ARGUMENT, "Too many arguments provided to " + t + "(). The number of arguments must be less than or equal to the number of Query.orderBy() clauses");
        for (var i = [], o = 0; o < e.length; o++) {
            var s = e[o];
            if (r[o].field.Y()) {
                if ("string" != typeof s) throw new I(E.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + t + "(), but got a " + typeof s);
                if (!this.vf.le() && -1 !== s.indexOf("/")) throw new I(E.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + t + "() must be a plain document ID, but '" + s + "' contains a slash.");
                var u = this.vf.path.child(U.G(s));
                if (!O.et(u)) throw new I(E.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + t + "() must result in a valid document path, but '" + u + "' is not because it contains an odd number of segments.");
                var a = new O(u);
                i.push(Z(this.xo, a));
            } else {
                var h = this.af.ea(t, s);
                i.push(h);
            }
        }
        return new Mt(i, n);
    ...
    t.prototype.Df = function(t) {
        if ("string" == typeof t) {
            ...
            var e = this.vf.path.child(U.G(t));
            if (!O.et(e)) throw new I(E.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + e + "' is not because it has an odd number of segments (" + e.length + ").");
            return Z(this.xo, new O(e));
        }
        if (t instanceof Mn) return Z(this.xo, t.Bo);
        throw new I(E.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + dn(t) + ".");
    }, 
    /**
    ...
    t.prototype.Cf = function(t, e) {
        ...
        })).length > 0) throw new I(E.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'NaN' in the value array.");
        ...
        if (t instanceof Ut) {
            ...
            if (t.ue()) {
                var o = this.vf.jt();
                if (null !== o && !o.isEqual(t.field)) throw new I(E.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, >, or >=) must be on the same field. But you have inequality filters on '" + o.toString() + "' and '" + t.field.toString() + "'");
                var s = this.vf.Gt();
                ...
                throw u === t.op ? new I(E.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + t.op.toString() + "' filter.") : new I(E.INVALID_ARGUMENT, "Invalid query. You cannot use '" + t.op.toString() + "' filters with '" + u.toString() + "' filters.");
            }
        }
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        get: function() {
            return new Mr(this.xf, this.If, this.Uo);
        },
        enumerable: !0,
        configurable: !0
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        ...
        return new qr(this.If, t.key, t, this.metadata.fromCache, this.Bf.ns.has(t.key), this.Uo);
    }, t;
}(), Fr = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, St.Wt(t), n, r) || this).jf = t, t.length % 2 != 1) throw new I(E.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.j() + " has " + t.length);
        return i;
    }
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.M() ? null : new Pr(new O(t), this.firestore, 
            /* converter= */ null);
        },
        enumerable: !0,
        configurable: !0
        ...
        // 'undefined' and 'null'.
        0 === arguments.length && (t = ke.cn()), sn("CollectionReference.doc", "non-empty string", 1, t);
        var e = U.G(t);
...
function xr(t, e) {
    ...
    if (vn(t, e, [ "merge", "mergeFields" ]), hn(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new I(E.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + dn(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new I(E.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + dn(r[o]));
        }(t, e, n, r, i);
...
var Hr = Wr(Sr, "Use firebase.firestore() instead."), Yr = Wr(Ur, "Use firebase.firestore().runTransaction() instead."), Kr = Wr(Rr, "Use firebase.firestore().batch() instead."), Xr = Wr(Pr, "Use firebase.firestore().doc() instead."), $r = Wr(Lr), Jr = Wr(qr), Zr = Wr(Mr), ti = Wr(Cr), ei = Wr(Fr, "Use firebase.firestore().collection() instead."), ni = Wr(Pn, "Use FieldValue.<field>() instead."), ri = Wr(Nn, "Use Blob.fromUint8Array() or Blob.fromBase64String() instead."), ii = {
    ...
    Commit: "commit"
}, hi = "gl-js/ fire/" + w, ci = /** @class */ function() {
    function t(t) {
        this.ii = t.ii;
     ...
     */    return t.prototype.ud = function(t, e) {
            ...
            u.listenOnce(y.COMPLETE, (function() {
                try {
                    switch (u.getLastErrorCode()) {
                      ...
                      case v.TIMEOUT:
                        Ne("Connection", 'RPC "' + t + '" timed out'), s(new I(E.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case v.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                s(new I(i, r.message));
                            } else s(new I(E.UNKNOWN, "Server responded with status " + u.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        Ne("Connection", 'RPC "' + t + '" failed'), s(new I(E.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var n = [ this.ad, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], i = m(), o = {
        ...
        this.ud(o.initMessageHeaders, e), 
        ...
        return N(g.EventType.OPEN, (function() {
            ...
            v || (v = !0, Ne("Connection", "WebChannel transport closed"), b.hd());
        })), N(g.EventType.ERROR, (function(t) {
            v || (v = !0, function(t) {
                for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
                if (Ee.logLevel <= s.WARN) {
                    var i = e.map(Te);
                    Ee.warn.apply(Ee, r([ "Firestore (" + w + "): " + t ], i));
                }
            }("Connection", "WebChannel transport errored:", t), b.hd(new I(E.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!v) {
                ...
                if (i) {
                    ...
                    v = !0, b.hd(new I(s, u)), d.close();
                } else Ne("Connection", "WebChannel received:", n), b.od(n);
            }
        })), setTimeout((function() {
...
export { fi as __PRIVATE_registerFirestore };
