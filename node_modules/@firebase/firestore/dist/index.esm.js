...
var T = {
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.A !== e ? (_e("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (xe("string" == typeof n.accessToken), new N(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.m = function() {
        ...
        return xe(null === t || "string" == typeof t), new b(t);
    }, t;
}(), D = /** @class */ function() {
    function t(t, e) {
    ...
    function t(t, e, n) {
        void 0 === e ? e = 0 : e > t.length && Se(), void 0 === n ? n = t.length - e : n > t.length - e && Se(), 
...
var V = /^[_a-zA-Z][_a-zA-Z0-9]*$/, O = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.k = function(t, e, r) {
...
/** A dot-separated path for navigating sub-objects within a document. */ O.G = new O([]);
...
/** Returns whether the value represents -0. */ function F(t) {
 ...
 */ function B(t) {
    return "number" == typeof t && Number.isInteger(t) && !F(t) && t <= Number.MAX_SAFE_INTEGER && t >= Number.MIN_SAFE_INTEGER;
}
...
/** Extracts the backend's type order for the provided value. */ function Q(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? z(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : Se();
}
      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            ...
            if ("doubleValue" in t && "doubleValue" in e) {
                ...
                return n === r ? F(n) === F(r) : isNaN(n) && isNaN(r);
            }
            return !1;
        }(t, e);

      case 9 /* ArrayValue */ :
        return Ve(t.arrayValue.values || [], e.arrayValue.values || [], K);
...
function J(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = Pe(Z(t.latitude), Z(e.latitude));
            return 0 !== n ? n : Pe(Z(t.longitude), Z(e.longitude));
...
function X(t, e) {
    ...
    var n = $(t), r = $(e), i = Pe(n.seconds, r.seconds);
...
var at = /** @class */ function() {
    ...
    return t.prototype.ot = function(t, e) {
        ...
        return e instanceof t && Ve(this.elements, e.elements, K);
    }, t;
}(), ct = /** @class */ function() {
    function t(t) {
        this.elements = t;
 ...
 */ var lt = /** @class */ function() {
    ...
    return t.prototype.dt = function(t) {
        ...
        return Ve(this.fields, t.fields, (function(t, e) {
            return t.isEqual(e);
        }));
    }, t;
}(), pt = /** @class */ function() {
...
e) {
     ...
     */
    t.wt = function(t) {
        return t instanceof St ? t.version : R.min();
    }, t;
}(), mt = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
    ...
    n.prototype.gt = function(t) {
        var e;
        return e = t instanceof St ? t.data() : Tt.empty(), this.pt(e);
    }, n.prototype.pt = function(t) {
    ...
    return t(n, e), n.prototype.at = function(t, e) {
        if (this.It(t), xe(null != e.transformResults), !this.Rt.Et(t)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
        ...
        return t instanceof n && this.key.isEqual(t.key) && Ve(this.fieldTransforms, t.fieldTransforms, (function(t, e) {
            return t.isEqual(e);
    ...
    n.prototype.vt = function(t, e) {
        var n = [];
        xe(this.fieldTransforms.length === e.length);
        for (var r = 0; r < e.length; r++) {
            var i = this.fieldTransforms[r], o = i.transform, s = null;
            t instanceof St && (s = t.field(i.field)), n.push(o.at(s, e[r]));
        }
        return n;
    }, 
    /**
    ...
    return t(n, e), n.prototype.at = function(t, e) {
        ...
        // document the server has accepted the mutation so the precondition must
        // have held.
        return this.It(t), new xt(this.key, e.version, {
            hasCommittedMutations: !0
        });
    }, n.prototype.ot = function(t, e, n) {
        return this.It(t), this.Rt.Et(t) ? new xt(this.key, R.min()) : t;
    }, n.prototype.Pt = function(t) {
        return null;
    }, n.prototype.isEqual = function(t) {
...
var _t, At, Dt = function(t, e) {
    this.key = t, this.version = e;
}, St = /** @class */ function(e) {
    function n(t, n, r, i) {
        var o = this;
        return (o = e.call(this, t, n) || this).Mt = r, o.At = !!i.At, o.hasCommittedMutations = !!i.hasCommittedMutations, 
        o;
    }
    ...
    return t.prototype.canonicalId = function() {
        if (null === this.$t) {
            ...
            t += this.filters.map((function(t) {
                ...
                return t.canonicalId();
            })).join(","), M(this.limit) || (t += "|l:", t += this.limit), this.startAt && (t += "|lb:", 
        ...
        M(this.limit) || (t += ", limit: " + this.limit), this.orderBy.length > 0 && (t += ", orderBy: [" + this.orderBy.join(", ") + "]"), 
    ...
    // in the Lite client become tree-shakeable.
        ...
        get: function() {
            if (null === this.qt) {
                ...
                t.Y() || this.qt.push(new Mt(t)), this.qt.push(new Mt(O.J(), "asc" /* ASCENDING */)); else {
    ...
    t.prototype.canonicalId = function() {
        ...
        for (var t = 0, e = this.filters; t < e.length; t++) {
            var n = e[t];
            if (n instanceof Vt && n.ue()) return n.field;
        }
        return null;
    }, 
    ...
    t.prototype.ce = function(t) {
        for (var e = 0, n = this.filters; e < n.length; e++) {
            var r = n[e];
            if (r instanceof Vt && t.indexOf(r.op) >= 0) return r.op;
        }
        return null;
    }, t.prototype.Ot = function() {
        return this.ee().Ot();
    ...
    t.prototype.ee = function() {
        if (!this.Ut) if ("F" /* First */ === this.Bt) this.Ut = new kt(this.path, this.collectionGroup, this.orderBy, this.filters, this.limit, this.startAt, this.endAt); else {
            for (
            // Flip the orderBy directions since we want the last results
            var t = [], e = 0, n = this.orderBy; e < n.length; e++) {
                var r = n[e], i = "desc" /* DESCENDING */ === r.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
                t.push(new Mt(r.field, i));
            }
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        if (t.Y()) return "in" /* IN */ === e ? new Lt(t, r) : new Ot(t, e, r);
        if (it(r)) {
        ...
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new Ut(t, r) : "in" /* IN */ === e ? new Ct(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new qt(t, r) : new n(t, e, r);
    }, n.prototype.matches = function(t) {
        var e = t.field(this.field);
        // Only compare types with matching backend order (such as double and int).
                return null !== e && Q(this.value) === Q(e) && this.de(J(e, this.value));
        ...
        return this.field.j() + this.op.toString() + H(this.value);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n && this.op === t.op && this.field.isEqual(t.field) && K(this.value, t.value);
    }, n.prototype.toString = function() {
        return this.field.j() + " " + this.op + " " + H(this.value);
    }, n;
}((function() {})), Ot = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
    ...
    t.prototype.le = function(t, e) {
        for (var n = 0, r = 0; r < this.position.length; r++) {
            ...
            if (n = i.field.Y() ? L.N(L.Z(o.referenceValue), e.key) : J(o, e.field(i.field)), 
     ...
     */ , s) {
        void 0 === i && (i = R.min()), void 0 === o && (o = R.min()), void 0 === s && (s = j.ht), 
 ...
 */ function Gt(t) {
    ...
    return Ae("GRPC error has no .code"), T.UNKNOWN;
    switch (t) {
      case _t.OK:
        return T.OK;
 ...
 *     Code.UNKNOWN.
 */ (At = _t || (_t = {}))[At.OK = 0] = "OK", At[At.CANCELLED = 1] = "CANCELLED", 
...
var Wt = /** @class */ function() {
    ...
    t.prototype.je = function() {
        if (this.Oe() && this.left.Oe()) throw Se();
        if (this.right.Oe()) throw Se();
        var t = this.left.je();
        if (t !== this.right.je()) throw Se();
...
var Yt = /** @class */ function() {
    function t(t) {
        this.N = t, this.data = new Wt(this.N);
    }
...
var ee = new Wt(L.N), ne = new Yt(L.N);

function re() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    for (var n = ne, r = 0, i = t; r < i.length; r++) {
        var o = i[r];
        n = n.add(o);
    }
    return n;
 ...
 */ var se = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.Je = te(), this.Xe = new Wt(this.N)
        /**
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, he.ds(e, n)), new t(R.min(), r, oe(), Ht(), re());
    }, t;
}(), he = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = j.ht), void 0 === r && (r = null), this.state = t, this.targetIds = e, 
    ...
    t.prototype.Ss = function() {
        ...
        })), new he(this.Vs, this.gs, t, e, n);
    }, 
    /**
     * Resets the document changes and sets `hasPendingChanges` to false.
     */
    t.prototype.Ds = function() {
        this.ps = !1, this.Ps = me();
    ...
    return t.prototype.qs = function(t) {
        for (var e = 0, n = t.ws; e < n.length; e++) {
            var r = n[e];
            t.Rs instanceof St ? this.Us(r, t.Rs) : t.Rs instanceof xt && this.Qs(r, t.key, t.Rs);
        }
    ...
    t.prototype.Hs = function(t) {
        ...
        if (r) {
            ...
            if (i.Ot()) if (0 === n) {
                ...
                // queries.
                var o = new L(i.path);
                this.Qs(e, o, new xt(o, R.min()));
            } else xe(1 === n); else this.Js(e) !== n && (
    ...
    t.prototype.Xs = function(t) {
        ...
        this.$s.forEach((function(r, i) {
            ...
            if (o) {
                if (r.fs && o.target.Ot()) {
                    ...
                    null !== e.Os.get(s) || e.Zs(i, s) || e.Qs(i, s, new xt(s, t));
                }
        ...
        return this.Os = Ht(), this.Ls = ve(), this.Bs = new Yt(Pe), i;
    }, 
    /**
    ...
    t.prototype.Ns = function(t) {
        ...
        var e = this.$s.get(t);
        return e || (e = new de, this.$s.set(t, e)), e;
    }, t.prototype.ti = function(t) {
        var e = this.Ls.get(t);
        return e || (e = new Yt(Pe), this.Ls = this.Ls.Ae(t, e)), e;
    }, 
    /**
    ...
    t.prototype.Gs = function(t) {
        ...
        return e || _e("WatchChangeAggregator", "Detected inactive target", t), e;
    }, 
    /**
    ...
    t.prototype.zs = function(t) {
        var e = this;
        this.$s.set(t, new de), this.xs.ei(t).forEach((function(n) {
 ...
 */ var ge = {
    ...
    return t.prototype.ni = function(t) {
        var e = void 0 === t.code ? T.UNKNOWN : Gt(t.code);
    ...
    t.prototype.oi = function(t) {
        var e;
        return M(e = "object" == typeof t ? t.value : t) ? null : e;
    }, 
    /**
    ...
    t.prototype.ci = function(t) {
        return this.options.hi ? (xe(void 0 === t || "string" == typeof t), j.fromBase64String(t || "")) : (xe(void 0 === t || t instanceof Uint8Array), 
        j.fromUint8Array(t || new Uint8Array));
    }, t.prototype.toVersion = function(t) {
        return this.C(t.C());
    }, t.prototype.fromVersion = function(t) {
        return xe(!!t), R.v(this.v(t));
        ...
        var e = this.di(t);
        return xe(e.get(1) === this.ii.projectId), xe(!e.get(3) && !this.ii.database || e.get(3) === this.ii.database), 
        new L(this.Ti(e));
        ...
        // in the local target cache.
                return 4 === e.length ? P.G : this.Ti(e);
    }, Object.defineProperty(t.prototype, "wi", {
        get: function() {
            return new P([ "projects", this.ii.projectId, "databases", this.ii.database ]).j();
        },
        enumerable: !0,
        configurable: !0
        ...
        return xe(t.length > 4 && "documents" === t.get(4)), t.M(5);
    }, 
    /** Creates an api.Document from key and fields (but no create/update time) */ t.prototype.Ri = function(t, e) {
        ...
        xe(!!t.found), t.found.name, t.found.updateTime;
        ...
        xe(!!t.missing), xe(!!t.readTime);
        var e = this.Z(t.missing), n = this.fromVersion(t.readTime);
        return new xt(e, n);
    }, t.prototype.gi = function(t) {
        return "found" in t ? this.Pi(t) : "missing" in t ? this.Vi(t) : Se();
    }, t.prototype.pi = function(t) {
        var e;
        if ("targetChange" in t) {
            ...
            e = new pe(n, r, i, s || null);
        } else if ("documentChange" in t) {
            t.documentChange;
            var u = t.documentChange;
            u.document, u.document.name, u.document.updateTime;
            var a = this.Z(u.document.name), c = this.fromVersion(u.document.updateTime), h = new Tt({
                mapValue: {
                    fields: u.document.fields
                }
            }), f = new St(a, c, h, {}), l = u.targetIds || [], p = u.removedTargetIds || [];
            e = new fe(l, p, f.key, f);
        } else if ("documentDelete" in t) {
            t.documentDelete;
            var d = t.documentDelete;
            d.document;
            var y = this.Z(d.document), v = d.readTime ? this.fromVersion(d.readTime) : R.min(), m = new xt(y, v), g = d.removedTargetIds || [];
            e = new fe([], g, m.key, m);
            ...
            if (!("filter" in t)) return Se();
            t.filter;
            var T = t.filter;
            T.targetId;
            var I = T.count || 0, N = new Bt(I), _ = T.targetId;
            e = new le(_, N);
        }
        return e;
    }, t.prototype.yi = function(t) {
        return "NO_CHANGE" === t ? 0 /* NoChange */ : "ADD" === t ? 1 /* Added */ : "REMOVE" === t ? 2 /* Removed */ : "CURRENT" === t ? 3 /* Current */ : "RESET" === t ? 4 /* Reset */ : Se();
        ...
        return e.targetIds && e.targetIds.length ? R.min() : e.readTime ? this.fromVersion(e.readTime) : R.min();
    }, t.prototype.vi = function(t) {
        var e, n = this;
        ...
        if (t.transform) {
            ...
            return xe(!0 === n.exists), new wt(u, a);
        }
        if (t.verify) {
        ...
        var n = this;
        return t && t.length > 0 ? (xe(void 0 !== e), t.map((function(t) {
            return n.xi(t, e);
        }))) : [];
    }, t.prototype.Di = function(t) {
        var e = t.transform;
        ...
        var e = null;
        if ("setToServerValue" in t) xe("REQUEST_TIME" === t.setToServerValue), e = ut.instance; else if ("appendMissingElements" in t) {
            var n = t.appendMissingElements.values || [];
            e = new at(n);
        } else if ("removeAllFromArray" in t) {
            var r = t.removeAllFromArray.values || [];
            e = new ct(r);
        } else "increment" in t ? e = new ht(this, t.increment) : Se();
        var i = O.X(t.fieldPath);
        return new pt(i, e);
    }, t.prototype.Oi = function(t) {
        return {
        ...
        xe(1 === t.documents.length);
        var e = t.documents[0];
        return Pt.Wt(this.Ii(e)).ee();
    }, t.prototype.Bi = function(t) {
        ...
        var h = null;
        return n.endAt && (h = this.Gi(n.endAt)), new Pt(e, i, u, s, a, "F" /* First */ , c, h).ee();
        ...
        if (0 !== t.length) {
            var n = t.map((function(t) {
                return t instanceof Vt ? e.Yi(t) : Se();
            }));
 ...
 */ var Te = /** @class */ function() {
    ...
    return t.an = function(e) {
        t.platform && Se(), t.platform = e;
    }, t.nt = function() {
        return t.platform || Se(), t.platform;
    }, t;
}(), Ie = new o("@firebase/firestore");
...
function _e(t) {
    ...
    if (Ie.logLevel <= s.DEBUG) {
        var i = e.map(De);
        Ie.debug.apply(Ie, r([ "Firestore (" + E + "): " + t ], i));
    }
}
...
function Ae(t) {
    ...
    if (Ie.logLevel <= s.ERROR) {
        var i = e.map(De);
        Ie.error.apply(Ie, r([ "Firestore (" + E + "): " + t ], i));
    }
}
 ...
 */ var ke = /** @class */ function() {
    ...
    return t.cn = function() {
        ...
        ; n.length < 20; ) for (var r = Te.nt()._n(40), i = 0; i < r.length; ++i) 
...
/** Helper to compare arrays using isEqual(). */ function Ve(t, e, n) {
...
function(t, e, n, r, i) {
    ...
    t.prototype.In = function(t) {
        ...
        return this.batchId === t.batchId && Ve(this.mutations, t.mutations, (function(t, e) {
            return t.isEqual(e);
        })) && Ve(this.baseMutations, t.baseMutations, (function(t, e) {
            return t.isEqual(e);
        }));
    }, t;
}(), je = /** @class */ function() {
    ...
    return t.from = function(e, n, r) {
        xe(e.mutations.length === r.length);
        for (var i = ee, o = e.mutations, s = 0; s < o.length; s++) i = i.Ae(o[s].key, r[s].version);
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.Vn && Se(), this.Vn = !0, this.Pn ? this.error ? this.gn(n, this.error) : this.pn(e, this.result) : new t((function(t, i) {
            r.An = function(n) {
                r.pn(e, n).next(t, i);
            }, r.mn = function(e) {
                r.gn(n, e).next(t, i);
    ...
    t.prototype.xn = function(t, e) {
        this.kn();
        var n = this.Dn.get(e);
        return void 0 !== n ? Me.resolve(n) : this.$n(t, e);
    }, 
    /**
    ...
    t;
}(), Be = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", ze = /** @class */ function() {
    function t() {
        this.Bn = [];
    }
    ...
    t.prototype.Jn = function(t, e) {
        ...
        return this.Wn.Xn(t, e).next((function(r) {
            var i = n.Hn(t, e, r), o = Ht();
            return i.forEach((function(t, e) {
                // TODO(http://b/32275378): Don't conflate missing / deleted.
                e || (e = new xt(t, R.min())), o = o.Ae(t, e);
            })), o;
        }));
    }, 
    /**
    ...
    t.prototype.Zn = function(t, e, n) {
        ...
        return this.Kn(t, new L(e)).next((function(t) {
            var e = te();
            return t instanceof St && (e = e.Ae(t.key, t)), e;
        }));
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.rr(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    ...
                    r = f instanceof St ? r.Ae(c, f) : r.remove(c);
                }
            }));
        })).next((function() {
        ...
        for (var r = re(), i = 0, o = e; i < o.length; i++) for (var s = 0, u = o[i].mutations; s < u.length; s++) {
            var a = u[s];
        ...
        return this.Qn.getEntries(t, r).next((function(t) {
            return t.forEach((function(t, e) {
                null !== e && e instanceof St && (c = c.Ae(t, e));
            })), c;
        }));
    }, t;
}(), We = /** @class */ function() {
    ...
    return t.ar = function(e, n) {
        for (var r = re(), i = re(), o = 0, s = n.docChanges; o < s.length; o++) {
            var u = s[o];
            switch (u.type) {
              case 0 /* Added */ :
                r = r.add(u.doc.key);
...
/** Represents the database ID a Firestore client is associated with. */ Qe.dr = -1;
...
var Ke = function() {
    ...
    t.prototype.gr = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && _e("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.Ar + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
 ...
 */
function Je(t) {
    for (var e = "", n = 0; n < t.length; n++) e.length > 0 && (e = He(e)), e = Xe(t.get(n), e);
    return He(e);
}
 ...
 */ function $e(t) {
    ...
    var e = t.length;
    if (xe(e >= 2), 2 === e) return xe("" === t.charAt(0) && "" === t.charAt(1)), 
    P.G;
    ...
    // source value.
        ...
        var s = t.indexOf("", o);
        switch ((s < 0 || s > n) && Se(), t.charAt(s + 1)) {
          case "":
 ...
 */ var Ze = /** @class */ function() {
    ...
    return t.prototype.Dr = function(t, e) {
        return this.Sr.add(e), Me.resolve();
    }, t.prototype.ir = function(t, e) {
        return Me.resolve(this.Sr.getEntries(e));
    }, t;
}(), tn = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.L(), n = t.$(), r = this.index[e] || new Yt(P.N), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.L(), n = t.$(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new Yt(P.N)).W();
    }, t;
}(), en = /** @class */ function() {
    function t() {
        /**
     ...
     */    return t.prototype.Dr = function(t, e) {
        ...
        var n = [], r = IDBKeyRange.bound([ e, "" ], [ Oe(e), "" ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return nn(t).Fr(r).next((function(t) {
 ...
 */ var rn = /** @class */ function() {
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        var n = this;
        return sn(t).get(un(e)).next((function(t) {
            return n.Mr(t);
        }));
    }, 
    /**
    ...
    t.prototype.Lr = function(t, e) {
        var n = this, r = $t(), i = new Wt(L.N);
        return this.Or(t, e, (function(t, e) {
            var o = n.Mr(e);
            o ? (r = r.Ae(t, o), i = i.Ae(t, an(e))) : (r = r.Ae(t, null), i = i.Ae(t, 0));
        })).next((function() {
            return {
                Br: r,
                qr: i
        ...
        if (n.isEqual(R.min())) {
            ...
            /* open= */ !0), s.index = Cn.collectionReadTimeIndex;
        }
        return sn(t).Ur(s, (function(t, n, s) {
            ...
            if (t.length === o) {
                ...
                e.path.q(u.key.path) ? u instanceof St && e.matches(u) && (i = i.Ae(u.key, u)) : s.done();
            }
        })).next((function() {
            return i;
        }));
    ...
    t.prototype.Kr = function(t, e) {
        var n = this, r = Ht(), i = this.serializer.Wr(e), o = sn(t), s = IDBKeyRange.lowerBound(i, !0);
        return o.Ur({
            index: Cn.readTimeIndex,
            range: s
        }, (function(t, e) {
    ...
    t.prototype.Hr = function(t) {
        ...
        return on(t).get(qn.key).next((function(t) {
            return xe(!!t), t;
        }));
    }, t.prototype.kr = function(t, e) {
        return on(t).put(qn.key, e);
    }, 
    /**
    ...
    t.prototype.Mr = function(t) {
        if (t) {
            ...
            return e instanceof xt && e.version.isEqual(R.min()) ? null : e;
        }
        return null;
    }, t;
}();
 ...
 */ function on(t) {
    return mn.Nr(t, qn.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function sn(t) {
    return mn.Nr(t, Cn.store);
}
 ...
 * limitations under the License.
 */
/** Offset to ensure non-overlapping target ids. */ rn.Jr = /** @class */ function(e) {
    /**
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).th = t, r.Xr = n, 
        // A map of document sizes prior to applying the changes in this buffer.
        r.eh = new Ce((function(t) {
            return t.toString();
        })), r;
    }
    return t(n, e), n.prototype.Ln = function(t) {
        ...
        return this.Dn.forEach((function(o, s) {
            ...
            if (s) {
                ...
                var h = e.th.serializer.sh(new xt(o, R.min()), e.readTime);
                n.push(e.th.Nn(t, o, h));
            } else n.push(e.th.Mn(t, o));
        })), i.forEach((function(r) {
            n.push(e.th.jn.Dr(t, r));
        })), n.push(this.th.updateMetadata(t, r)), Me.vn(n);
...
var cn = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.ah(t).next((function(n) {
            var r = new cn(n.highestTargetId);
        ...
        return this.ah(t).next((function(t) {
            return R.v(new x(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds));
        }));
        ...
        return this.Rh(t, e.targetId).next((function() {
            return fn(t).delete(e.targetId);
        })).next((function() {
            return n.ah(t);
        })).next((function(e) {
            return xe(e.targetCount > 0), e.targetCount -= 1, n.uh(t, e);
        }));
    }, 
    /**
    ...
    t.prototype.js = function(t, e) {
        var n = this;
        return fn(t).Ur((function(t, r) {
            var i = n.serializer.mh(r);
            e(i);
        }));
    }, t.prototype.ah = function(t) {
        return ln(t).get(Fn.key).next((function(t) {
            return xe(null !== t), t;
        }));
    }, t.prototype.uh = function(t, e) {
        return ln(t).put(Fn.key, e);
    }, t.prototype.Th = function(t, e) {
        return fn(t).put(this.serializer.Ph(e));
    }, 
    /**
    ...
    t.prototype.Eh = function(t, e) {
        ...
        // IndexedDb.
            ...
            var s = Je(e.path);
            i.push(o.put(new Mn(n, s))), i.push(r.hh.yh(t, n, e));
        })), Me.vn(i);
        ...
        // IndexedDb.
            ...
            var o = Je(e.path);
            return Me.vn([ i.delete([ n, o ]), r.hh.vh(t, n, e) ]);
        }));
    }, t.prototype.Rh = function(t, e) {
        var n = pn(t), r = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(r);
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), r = pn(t), i = re();
        return r.Ur({
            range: n,
            Dh: !0
        }, (function(t, e, n) {
            var r = $e(t[1]), o = new L(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
    }, t.prototype.Ch = function(t, e) {
        var n = Je(e.path), r = IDBKeyRange.bound([ n ], [ Oe(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return pn(t).Ur({
            index: Mn.documentTargetsIndex,
            Dh: !0,
            range: r
        }, (function(t, e, n) {
            var r = t[0];
    ...
    t.prototype.si = function(t, e) {
        var n = this;
        return fn(t).get(e).next((function(t) {
 ...
 */
function fn(t) {
    return mn.Nr(t, jn.store);
}

/**
 * Helper to get a typed SimpleDbStore for the target globals object store.
 */ function ln(t) {
    return mn.Nr(t, Fn.store);
}

/**
 * Helper to get a typed SimpleDbStore for the document target object store.
 */ function pn(t) {
    return mn.Nr(t, Mn.store);
}
 ...
 * limitations under the License.
 */
/** Serializer for values stored in the LocalStore. */ var dn = /** @class */ function() {
    function t(t) {
        this.Fh = t;
    }
    /** Decodes a remote document from storage locally to a Document. */    return t.prototype.jr = function(t) {
        ...
        if (t.noDocument) {
            var e = L.st(t.noDocument.path), n = this.Nh(t.noDocument.readTime);
            return new xt(e, n, {
                hasCommittedMutations: !!t.hasCommittedMutations
            });
        }
        if (t.unknownDocument) {
            var r = L.st(t.unknownDocument.path), i = this.Nh(t.unknownDocument.version);
            return new Rt(r, i);
        }
        return Se();
    }, 
    /** Encodes a document for storage locally. */ t.prototype.sh = function(t, e) {
        ...
        if (t instanceof xt) {
            ...
            return new Cn(
            /* unknownDocument= */ null, new Ln(s, u), 
            /* document= */ null, a, n, r);
        }
        if (t instanceof Rt) {
            var c = t.key.path.W(), h = this.kh(t.version);
            return new Cn(new Un(c, h), 
            /* noDocument= */ null, 
            /* document= */ null, 
        ...
        var e = t.C();
        return new Rn(e.seconds, e.nanoseconds);
    ...
    /** Encodes a batch of mutations into a DbMutationBatch for local storage. */ t.prototype.Mh = function(t, e) {
        ...
        return new Vn(t, e.batchId, e.Tn.toMillis(), r, i);
    }, 
    /** Decodes a DbMutationBatch into a MutationBatch */ t.prototype.xh = function(t) {
        var e = this, n = (t.baseMutations || []).map((function(t) {
            ...
            return e.Fh.Fi(t);
        })), i = x.fromMillis(t.localWriteTimeMs);
        return new qe(t.batchId, i, n, r);
    }, 
    /** Decodes a DbTarget into TargetData */ t.prototype.mh = function(t) {
        var e, n = this.Nh(t.readTime), r = void 0 !== t.lastLimboFreeSnapshotVersion ? this.Nh(t.lastLimboFreeSnapshotVersion) : R.min();
        return e = void 0 !== t.query.documents ? this.Fh.Li(t.query) : this.Fh.Wi(t.query), 
        new Ft(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, n, r, j.fromBase64String(t.resumeToken));
    }, 
...
}(), yn = "Failed to obtain exclusive access to the persistence layer. To allow shared access, make sure to invoke `enablePersistence()` with `synchronizeTabs:true` in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", vn = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).$h = t, r.Oh = n, r;
    }
    return t(n, e), n;
}(ze), mn = /** @class */ function() {
    function t(
    /**
    ...
    c) {
        ...
        this.Tr = s, this.Lh = a, this.Bh = c, this.qh = null, this.Uh = !1, this.isPrimary = !1, 
        ...
        }, !t.zh()) throw new I(T.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.hh = new En(this, o), this.Hh = n + t.Yh, this.serializer = new dn(u), this.document = i.document, 
        this.Jh = new hn(this.hh, this.serializer), this.jn = new en, this.Qn = new rn(this.serializer, this.jn), 
        this.window = i.window, i.window && i.window.localStorage ? this.Xh = i.window.localStorage : (this.Xh = null, 
        !1 === c && Ae("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
    }
    return t.Nr = function(t, e) {
        if (t instanceof vn) return Qn.Nr(t.$h, e);
        throw Se();
    }, 
    /**
    ...
    t.prototype.start = function() {
        var t = this;
        return Qn.Zh(this.Hh, Sn, new xn(this.serializer)).then((function(e) {
            return t.to = e, t.eo();
        })).then((function() {
            if (!t.isPrimary && !t.allowTabSynchronization) 
            // Fail `start()` if `synchronizeTabs` is disabled and we cannot
            // obtain the primary lease.
            throw new I(T.FAILED_PRECONDITION, yn);
    ...
    t.prototype.ro = function(t) {
        var r = this;
        return this.Gh = function(i) {
            return e(r, void 0, void 0, (function() {
                return n(this, (function(e) {
                    return this.ho ? [ 2 /*return*/ , t(i) ] : [ 2 /*return*/ ];
                }));
            }));
        }, t(this.isPrimary);
    }, 
    ...
    t.prototype.eo = function() {
        ...
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (function(e) {
            return wn(e).put(new Gn(t.clientId, Date.now(), t.networkEnabled, t.inForeground)).next((function() {
            ...
            return _e("IndexedDbPersistence", "Failed to extend owner lease: ", e), t.isPrimary;
            if (!t.allowTabSynchronization) throw e;
            return _e("IndexedDbPersistence", "Releasing owner lease after error during lease refresh", e), 
            /* isPrimary= */ !1;
        })).then((function(e) {
        ...
        var e = this;
        return gn(t).get(kn.key).next((function(t) {
            return Me.resolve(e.Eo(t));
        }));
    }, t.prototype.Io = function(t) {
        return wn(t).delete(this.clientId);
    }, 
    /**
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    ...
                    if (e = n.sent(), this.Xh) for (r = 0, i = e; r < i.length; r++) o = i[r], this.Xh.removeItem(this.mo(o.clientId));
                    n.label = 2;
    ...
    t.prototype.do = function(t) {
        var e = this;
        return this.Bh ? Me.resolve(!0) : gn(t).get(kn.key).next((function(n) {
            ...
            return !(!e.networkEnabled || !e.inForeground) || wn(t).Fr().next((function(t) {
            ...
            return e.isPrimary !== t && _e("IndexedDbPersistence", "Client " + (t ? "is" : "is not") + " eligible for a primary lease."), 
            t;
        }));
                ...
                switch (e.label) {
                  case 0:
                    ...
                    this.bo(), [ 4 /*yield*/ , this.runTransaction("shutdown", "readwrite", (function(e) {
                        ...
                        _e("IndexedDbPersistence", "Proceeding with shutdown despite failure: ", t);
                    })) ];
    ...
    t.prototype.So = function() {
        ...
        return this.runTransaction("getActiveClients", "readonly", (function(e) {
            return wn(e).Fr().next((function(e) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return t.zh() ? (e = r + t.Yh, [ 4 /*yield*/ , Qn.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
        ...
        return Tn.Co(t, this.serializer, this.jn, this.hh);
        ...
        var r = this;
        _e("IndexedDbPersistence", "Starting transaction:", t);
        var i, o = "readonly" === e ? "readonly" : "readwrite";
        // Do all transactions as readwrite against all object stores, since we
        // are the only reader/writer.
        return this.to.runTransaction(o, Wn, (function(o) {
            return i = new vn(o, r.qh ? r.qh.next() : Qe.dr), "readwrite-primary" === e ? r._o(i).next((function(t) {
                return !!t || r.do(i);
            })).next((function(e) {
                if (!e) throw Ae("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.Tr.lo((function() {
                    return r.Gh(!1);
                })), new I(T.FAILED_PRECONDITION, Be);
                return n(i);
            })).next((function(t) {
    ...
    t.prototype.Mo = function(t) {
        var e = this;
        return gn(t).get(kn.key).next((function(t) {
            if (null !== t && e.Ro(t.leaseTimestampMs, 5e3) && !e.Po(t.ownerId) && !e.Eo(t) && !(e.Bh || e.allowTabSynchronization && t.allowTabSynchronization)) throw new I(T.FAILED_PRECONDITION, yn);
        }));
    }, 
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.fo = function(t) {
        ...
        return n.get(kn.key).next((function(t) {
            return e.Eo(t) ? (_e("IndexedDbPersistence", "Releasing primary lease."), n.delete(kn.key)) : Me.resolve();
        }));
    }, 
    /** Verifies that `updateTimeMs` is within `maxAgeMs`. */ t.prototype.Ro = function(t, e) {
        var n = Date.now();
        return !(t < n - e || t > n && (Ae("Detected an update time that is in the future: " + t + " > " + n), 
        1));
    }, t.prototype.so = function() {
        var t = this;
    ...
    t.prototype.Po = function(t) {
        ...
        try {
            ...
            return _e("IndexedDbPersistence", "Client '" + t + "' " + (n ? "is" : "is not") + " zombied in LocalStorage"), 
            n;
        } catch (t) {
            // Gracefully handle if LocalStorage isn't working.
            return Ae("IndexedDbPersistence", "Failed to get zombied client id.", t), !1;
        }
    }, 
    /**
    ...
    t.prototype.po = function() {
        if (this.Xh) try {
            ...
            Ae("Failed to set zombie client id.", t);
        }
    }, 
 ...
 */
function gn(t) {
    return mn.Nr(t, kn.store);
}

/**
 * Helper to get a typed SimpleDbStore for the client metadata object store.
 */ function wn(t) {
    return mn.Nr(t, Gn.store);
}

/** Provides LRU functionality for IndexedDB persistence. */ mn.Yh = "main";

var En = /** @class */ function() {
    function t(t, e) {
        this.db = t, this.$o = new cr(this, e);
    }
    ...
    t.prototype.Qo = function(t, e) {
        ...
        return function(t, e) {
            ...
            return Dn(t).Wo((function(r) {
                return In(t, r, e).next((function(t) {
                    return t && (n = !0), Me.resolve(!t);
                }));
            })).next((function() {
                return n;
            }));
            ...
            if (u <= e) {
                var a = n.Qo(t, s).next((function(e) {
                    ...
                    return o++, r.xn(t, s).next((function() {
                        return r.Mn(s), pn(t).delete([ 0, Je(s.path) ]);
                    }));
                }));
                i.push(a);
            }
 ...
 * limitations under the License.
 */
/** A mutation queue for a specific user, backed by IndexedDB. */ var Tn = /** @class */ function() {
    function t(
    /**
    ...
    return t.Co = function(e, n, r, i) {
        ...
        return xe("" !== e.uid), new t(e.t() ? e.uid : "", n, r, i);
        ...
        return s.add({}).next((function(u) {
            xe("number" == typeof u);
            for (var a = new qe(u, e, n, r), c = i.serializer.Mh(i.userId, a), h = [], f = new Yt((function(t, e) {
                return Pe(t.j(), e.j());
            })), l = 0, p = r; l < p.length; l++) {
                var d = p[l], y = On.key(i.userId, d.key.path, u);
                f = f.add(d.key.path.$()), h.push(s.put(c)), h.push(o.put(y, On.PLACEHOLDER));
            }
            return f.forEach((function(e) {
                h.push(i.jn.Dr(t, e));
            })), t.qn((function() {
                i.zo[u] = a.keys();
            })), Me.vn(h).next((function() {
                return a;
            }));
        }));
    }, t.prototype.Jo = function(t, e) {
        ...
        return _n(t).get(e).next((function(t) {
            return t ? (xe(t.userId === n.userId), n.serializer.xh(t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.Xo = function(t, e) {
        var n = this;
        return this.zo[e] ? Me.resolve(this.zo[e]) : this.Jo(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.zo[e] = r, r;
            }
        ...
        return _n(t).Ur({
            ...
            e.userId === n.userId && (xe(e.batchId >= r), o = n.serializer.xh(e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        return _n(t).Fr(Vn.userMutationsIndex, n).next((function(t) {
            return t.map((function(t) {
        ...
        // the given documentKey.
            ...
            return _n(t).get(c).next((function(t) {
                if (!t) throw Se();
                xe(t.userId === n.userId), o.push(n.serializer.xh(t));
            }));
            s.done();
        })).next((function() {
            return o;
        ...
        return e.forEach((function(e) {
            var o = On.prefixForPath(n.userId, e.path), s = IDBKeyRange.lowerBound(o), u = An(t).Ur({
                range: s
            }, (function(t, i, o) {
                var s = t[0], u = t[1], a = t[2], c = $e(u);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
            ...
            i.push(u);
        })), Me.vn(i).next((function() {
            return n.sa(t, r);
        }));
    }, t.prototype.nr = function(t, e) {
        var n = this, r = e.path, i = r.length + 1, o = On.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), u = new Yt(Pe);
        return An(t).Ur({
            range: s
        }, (function(t, e, o) {
            var s = t[0], a = t[1], c = t[2], h = $e(a);
            s === n.userId && r.q(h) ? 
        ...
        return e.forEach((function(e) {
            i.push(_n(t).get(e).next((function(t) {
                if (null === t) throw Se();
                xe(t.userId === n.userId), r.push(n.serializer.xh(t));
            })));
        })), Me.vn(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return Nn(t.$h, this.userId, e).next((function(r) {
            return t.qn((function() {
                n.na(e.batchId);
            })), Me.forEach(r, (function(e) {
                return n.hh.Uo(t, e);
            }));
        }));
    }, 
...
function Nn(t, e, n) {
    var r = t.store(Vn.store), i = t.store(On.store), o = [], s = IDBKeyRange.only(n.batchId), u = 0, a = r.Ur({
        range: s
    }, (function(t, e, n) {
        return u++, n.delete();
    }));
    ...
    for (var c = [], h = 0, f = n.mutations; h < f.length; h++) {
        var l = f[h], p = On.key(e, l.key.path, n.batchId);
        o.push(i.delete(p)), c.push(l.key);
    }
    return Me.vn(o).next((function() {
        return c;
    }));
}
 ...
 */ function _n(t) {
    return mn.Nr(t, Vn.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function An(t) {
    return mn.Nr(t, On.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Dn(t) {
    return mn.Nr(t, Pn.store);
}
 ...
 */ var Sn = 10, xn = /** @class */ function() {
     ...
     */    return t.prototype.createOrUpgrade = function(t, e, n, r) {
        ...
        0 !== n && (function(t) {
            t.deleteObjectStore(Mn.store), t.deleteObjectStore(jn.store), t.deleteObjectStore(Fn.store);
     ...
     */
            return function(t) {
                ...
                /*highestTargetId=*/ 0, 
                /*lastListenSequenceNumber=*/ 0, R.min().C(), 
                /*targetCount=*/ 0);
        ...
        s = s.next((function() {
            return function(t, e) {
                return e.store(Vn.store).Fr().next((function(n) {
            ...
            !function(t) {
                ...
                var e = t.objectStore(Cn.store);
                e.createIndex(Cn.readTimeIndex, Cn.readTimeIndexPath, {
                    unique: !1
                }), e.createIndex(Cn.collectionReadTimeIndex, Cn.collectionReadTimeIndexPath, {
                    unique: !1
                });
            }(e);
        ...
        var e = 0;
        return t.store(Cn.store).Ur((function(t, n) {
            e += an(n);
        })).next((function() {
            var n = new qn(e);
        ...
        var e = this, n = t.store(Pn.store), r = t.store(Vn.store);
        return n.Fr().next((function(n) {
            return Me.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.Fr(Vn.userMutationsIndex, i).next((function(r) {
                    return Me.forEach(r, (function(r) {
                        xe(r.userId === n.userId);
    ...
    t.prototype.ensureSequenceNumbers = function(t) {
        var e = t.store(Mn.store), n = t.store(Cn.store);
        return t.store(Fn.store).get(Fn.key).next((function(t) {
            var r = [];
            return n.Ur((function(n, i) {
                ...
                r.push(e.get(s).next((function(n) {
                    return n ? Me.resolve() : function(n) {
                        return e.put(new Mn(0, Je(n), t.highestListenSequenceNumber));
                    }(o);
                })));
            })).next((function() {
                return Me.vn(r);
        ...
        var n = e.store(Bn.store), r = new tn, i = function(t) {
            if (r.add(t)) {
                var e = t.L(), i = t.$();
                return n.put({
                    collectionId: e,
        ...
        // Index existing remote documents.
                return e.store(Cn.store).Ur({
            Dh: !0
        }, (function(t, e) {
            var n = new P(t);
            return i(n.$());
        })).next((function() {
            return e.store(On.store).Ur({
                Dh: !0
            }, (function(t, e) {
                t[0];
                var n = t[1], r = (t[2], $e(n));
...
/** Name of the IndexedDb object store.  */ Pn.store = "mutationQueues", 
...
/**
     ...
     */
Cn.readTimeIndex = "readTimeIndex", Cn.readTimeIndexPath = "readTime", 
/**
     ...
     */
Cn.collectionReadTimeIndex = "collectionReadTimeIndex", Cn.collectionReadTimeIndexPath = [ "parentPath", "readTime" ];
...
/** Name of the IndexedDb object store.  */ Mn.store = "targetDocuments", 
/** Keys are automatically assigned via the targetId, path properties. */
Mn.keyPath = [ "targetId", "path" ], 
/** The index name for the reverse index. */
Mn.documentTargetsIndex = "documentTargetsIndex", 
/** We also need to create the reverse index for these properties. */
Mn.documentTargetsKeyPath = [ "path", "targetId" ];
...
/** Name of the IndexedDb object store. */ function zn(t) {
    t.createObjectStore(Mn.store, {
        keyPath: Mn.keyPath
    }).createIndex(Mn.documentTargetsIndex, Mn.documentTargetsKeyPath, {
        unique: !0
    }), 
...
Bn.store = "collectionParents", 
/** Keys are automatically assigned via the collectionId, parent properties. */
Bn.keyPath = [ "collectionId", "parent" ];
...
/** Name of the IndexedDb object store. */ Gn.store = "clientMetadata", 
/** Keys are automatically assigned via the clientId properties. */
Gn.keyPath = "clientId";

var Wn = r(r(r([ Pn.store, Vn.store, On.store, Cn.store, jn.store, kn.store, Fn.store, Mn.store ], [ Gn.store ]), [ qn.store ]), [ Bn.store ]), Qn = /** @class */ function() {
    function t(e) {
        this.db = e, 
        ...
        // log on 12.2.
        12.2 === t.oa(u()) && Ae("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /**
     ...
     */    return t.Zh = function(e, n, r) {
        return _e("SimpleDb", "Opening database:", e), new Me((function(i, o) {
            ...
            s.onsuccess = function(e) {
                ...
                _e("SimpleDb", 'Database "' + e + '" requires upgrade from version:', t.oldVersion);
                var n = t.target.result;
                r.createOrUpgrade(n, s.transaction, t.oldVersion, Sn).next((function() {
                    _e("SimpleDb", "Database upgrade to version " + Sn + " complete");
                }));
            };
        })).yn();
    }, 
    /** Deletes the specified database. */ t.delete = function(t) {
        return _e("SimpleDb", "Removing database:", t), $n(window.indexedDB.deleteDatabase(t)).yn();
    }, 
    /** Returns true if IndexedDB is available in the current environment. */ t.zh = function() {
        ...
        // Check the UA string to find out the browser.
                var e = u(), n = t.oa(e), r = 0 < n && n < 10, i = t.ua(e), o = 0 < i && i < 4.5;
        // IE 10
                  ...
                  case 0:
                    e = "readonly" === t, o = 0, s = function() {
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                ++o, t = Xn.open(u.db, e ? "readonly" : "readwrite", r), n.label = 1;
                              ...
                              case 3:
                                return c = n.sent(), h = "FirebaseError" !== c.name && o < 3, _e("SimpleDb", "Transaction failed with error: %s. Retrying: %s.", c.message, h), 
 ...
 */
/** Verifies whether `e` is an IndexedDbTransactionError. */ function Jn(t) {
 ...
 */ var Xn = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             */
        this.Ea = new Ke, this.transaction.oncomplete = function() {
            e.Ea.resolve();
        }, this.transaction.onabort = function() {
            t.error ? e.Ea.reject(new Yn(t.error)) : e.Ea.resolve();
        }, this.transaction.onerror = function(t) {
            var n = tr(t.target.error);
            e.Ea.reject(new Yn(n));
        };
    }
    return t.open = function(e, n, r) {
        ...
        t && this.Ea.reject(t), this.aborted || (_e("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
    ...
    return t.prototype.put = function(t, e) {
        var n;
        return void 0 !== e ? (_e("SimpleDb", "PUT", this.store.name, t, e), n = this.store.put(e, t)) : (_e("SimpleDb", "PUT", this.store.name, "<auto-key>", t), 
    ...
    t.prototype.add = function(t) {
        return _e("SimpleDb", "ADD", this.store.name, t, t), $n(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
            ...
            return void 0 === n && (n = null), _e("SimpleDb", "GET", e.store.name, t, n), n;
        }));
    }, t.prototype.delete = function(t) {
        return _e("SimpleDb", "DELETE", this.store.name, t), $n(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return _e("SimpleDb", "COUNT", this.store.name), $n(this.store.count());
        ...
        _e("SimpleDb", "DELETE ALL", this.store.name);
    ...
    t.prototype.Wo = function(t) {
        ...
        var n = [];
        return new Me((function(r, i) {
            t.onerror = function(t) {
                i(t.target.error);
            }, t.onsuccess = function(t) {
                var i = t.target.result;
                if (i) {
                    var o = new Kn(i), s = e(i.primaryKey, i.value, o);
                    if (s instanceof Me) {
                        var u = s.catch((function(t) {
                            return o.done(), Me.reject(t);
                        }));
                        n.push(u);
                    }
 ...
 */ var er = /** @class */ function() {
    function t(t, e, n, r, i) {
        this.Ra = t, this.Er = e, this.Aa = n, this.op = r, this.ma = i, this.Pa = new Ke, 
    ...
    t.prototype.cancel = function(t) {
        null !== this.ga && (this.clearTimeout(), this.Pa.reject(new I(T.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    function t() {
        ...
        this.Na = new Ye(this, "async_queue_retry" /* AsyncQueueRetry */), 
    ...
    t.prototype.Ba = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.$a(), this.va ? [ 3 /*break*/ , 2 ] : (this.va = !0, (e = Te.nt().window) && e.removeEventListener("visibilitychange", this.ka), 
                    [ 4 /*yield*/ , this.La(t) ]);
    ...
    t.prototype.lo = function(t) {
                ...
                return e(r, void 0, void 0, (function() {
                    ...
                    return n(this, (function(n) {
                        switch (n.label) {
                          ...
                          case 1:
                            return n.sent(), i.resolve(), this.Na.reset(), [ 3 /*break*/ , 3 ];

                          case 2:
                            if (!Jn(e = n.sent())) throw i.resolve(), e;
                            // Failure will be handled by AsyncQueue
                                                        return _e("AsyncQueue", "Operation failed with retryable error: " + e), 
                            this.Na.gr(o), [ 3 /*break*/ , 3 ];
        ...
        var e = this, n = this.ya.then((function() {
            return e.Ca = !0, t().catch((function(t) {
                ...
                throw e.Da = t, e.Ca = !1, Ae("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
    ...
    t.prototype.yr = function(t, e, n) {
        ...
        var i = er.Va(this, t, e, n, (function(t) {
            return r.qa(t);
        }));
 ...
 */
function rr(t, e) {
    if (Ae("AsyncQueue", e + ": " + t), Jn(t)) return new I(T.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var or = /** @class */ function() {
    function t(t) {
        this.Ga = t, this.buffer = new Yt(ir), this.za = 0;
    }
...
ur.ou = -1, ur.au = 1048576, ur.uu = 41943040, ur.ru = 10, ur.hu = 1e3, ur.cu = new ur(ur.uu, ur.ru, ur.hu), 
ur.DISABLED = new ur(ur.ou, 0, 0);
...
var ar = /** @class */ function() {
    ...
    return t.prototype.start = function(t) {
        ...
        var r = this, i = this._u ? 3e5 : 6e4;
        _e("LruGarbageCollector", "Garbage collection scheduled in " + i + "ms"), this.lu = this.Ra.yr("lru_garbage_collection" /* LruGarbageCollection */ , i, (function() {
            return e(r, void 0, void 0, (function() {
                var e;
                return n(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        this.lu = null, this._u = !0, n.label = 1;

                      case 1:
                        return n.trys.push([ 1, 3, , 7 ]), [ 4 /*yield*/ , t.Tu(this.$o) ];

                      case 2:
                        return n.sent(), [ 3 /*break*/ , 7 ];

                      case 3:
                        return Jn(e = n.sent()) ? (_e("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    /** Returns the nth sequence number, counting in order from the smallest. */ t.prototype.wu = function(t, e) {
        var n = this;
        if (0 === e) return Me.resolve(Qe.dr);
        var r = new or(e);
    ...
    t.prototype.jo = function(t, e) {
        ...
        var n = this;
        return this.du.eu === ur.ou ? (_e("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        Me.resolve(sr)) : this.Go(t).next((function(r) {
            return r < n.du.eu ? (_e("LruGarbageCollector", "Garbage collection skipped; Cache size " + r + " is lower than threshold " + n.du.eu), 
            sr) : n.Au(t, e);
        }));
    }, t.prototype.Go = function(t) {
        return this.Eu.Go(t);
        ...
        return this.Iu(t, this.du.su).next((function(e) {
            ...
            return e > h.du.iu ? (_e("LruGarbageCollector", "Capping sequence numbers to collect down to the maximum of " + h.du.iu + " from " + e), 
            r = h.du.iu) : r = e, o = Date.now(), h.wu(t, r);
        })).next((function(r) {
            return n = r, u = Date.now(), h.Ah(t, n, e);
        })).next((function(e) {
            return i = e, a = Date.now(), h.jo(t, n);
        })).next((function(t) {
            return c = Date.now(), Ne() <= s.DEBUG && _e("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - f) + "ms\n\tDetermined least recently used " + r + " in " + (u - o) + "ms\n\tRemoved " + i + " targets in " + (a - u) + "ms\n\tRemoved " + t + " documents in " + (c - a) + "ms\nTotal Duration: " + (c - f) + "ms"), 
            Me.resolve({
                Ja: !0,
                Xa: r,
                Za: i,
    ...
    t, e, n) {
        ...
        /**
             ...
             * PORTING NOTE: This is only used for multi-tab synchronization.
             */
        this.gu = R.min(), this.Wn = t.Do(n), this.pu = t.No(), this.Jh = t.Fo(), this.yu = new Ge(this.pu, this.Wn, this.persistence.ko()), 
        this.mu.bu(this.yu)
    ...
    t.prototype.vu = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = this.Wn, r = this.yu, [ 4 /*yield*/ , this.persistence.runTransaction("Handle user change", "readonly", (function(n) {
                        // Swap out the mutation queue, grabbing the pending mutation batches
                        // before and after.
                        var i;
                        return o.Wn.ea(n).next((function(s) {
                            return i = s, e = o.persistence.Do(t), 
                            // Recreate our LocalDocumentsView using the new
                            // MutationQueue.
                            r = new Ge(o.pu, e, o.persistence.ko()), e.ea(n);
                        })).next((function(t) {
                            for (var e = [], o = [], s = re(), u = 0, a = i
                  ...
                  case 1:
                    return i = n.sent(), [ 2 /*return*/ , (this.Wn = e, this.yu = r, this.mu.bu(this.yu), 
                    i) ];
                }
            }));
        }));
        ...
        return this.persistence.runTransaction("Locally write mutations", "readwrite", (function(o) {
            return n.yu.Yn(o, i).next((function(i) {
                ...
                var s = [], u = 0, a = t; u < a.length; u++) {
                    ...
                    // exists=true
                    s.push(new gt(c.key, h, Nt(h.proto.mapValue), yt.exists(!0)));
                }
    ...
    t.prototype.Mu = function(t) {
        ...
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", (function(n) {
            ...
            return e.Wn.Jo(n, t).next((function(t) {
                return xe(null !== t), r = t.keys(), e.Wn.ia(n, t);
            })).next((function() {
                return e.Wn.ra(n);
            })).next((function() {
                return e.yu.Yn(n, r);
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            u.push(s.getEntries(o, c).next((function(t) {
                e.cs.forEach((function(i, c) {
                    ...
                    // cache.
                                        c instanceof xt && c.version.isEqual(R.min()) ? (
                    ...
                    a = a.Ae(i, c)) : _e("LocalStore", "Ignoring outdated watch update for ", i, ". Current version:", h.version, " Watch version:", c.version), 
    ...
    t.$u = function(t, e, n) {
        ...
        return xe(e.resumeToken.rt() > 0), 0 === t.resumeToken.rt() || (
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(e) {
                        return Me.forEach(t, (function(t) {
                            return Me.forEach(t.hr, (function(n) {
                                return h.persistence.hh.yh(e, t.targetId, n);
                            })).next((function() {
                                return Me.forEach(t.or, (function(n) {
                  ...
                  case 2:
                    if (!Jn(e = n.sent())) throw e;
                    // If `notifyLocalViewChanges` fails, we did not advance the sequence
                    // number for the documents that were included in this transaction.
                    // This might trigger them to be deleted earlier than they otherwise
                    // would have, but it should not invalidate the integrity of the data.
                                        return _e("LocalStore", "Failed to update sequence numbers: " + e), 
                    [ 3 /*break*/ , 3 ];
    ...
    t.prototype.Uu = function(t) {
        ...
        return this.persistence.runTransaction("Allocate target", "readwrite", (function(n) {
            ...
            return e.Jh.gh(n, t).next((function(i) {
                ...
                r = i, Me.resolve(r)) : e.Jh.oh(n).next((function(i) {
                    return r = new Ft(t, i, 0 /* Listen */ , n.Oh), e.Jh.fh(n, r).next((function() {
                        return r;
                    }));
                }));
            }));
    ...
    t.prototype.gh = function(t, e) {
        var n = this.Vu.get(e);
        return void 0 !== n ? Me.resolve(this.Pu.get(n)) : this.Jh.gh(t, e);
    }, 
    /**
    ...
    t.prototype.Qu = function(t, e) {
        ...
        return this.persistence.runTransaction("Release target", i, (function(t) {
            return e ? Me.resolve() : n.persistence.hh.removeTarget(t, r);
        })).then((function() {
    ...
    t.prototype.Wu = function(t, e) {
        ...
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.gh(o, t.ee()).next((function(t) {
                ...
                return n.mu.Zn(o, t, e ? r : R.min(), e ? i : re());
            })).next((function(t) {
                return {
                    documents: t,
                    ju: i
        ...
        return o.forEach((function(r) {
            s = s.next((function() {
                ...
                xe(null !== s), (!o || o.version.S(s) < 0) && ((o = i.at(r, o, e)) && 
...
var fr = /** @class */ function(r) {
    function i(t, e, n) {
        var i = this;
        return (i = r.call(this, t, e, n) || this).persistence = t, i.Wn = t.Do(n), i.pu = t.No(), 
        i.Jh = t.Fo(), i;
    }
    ...
    /** Returns the local view of the documents affected by a mutation batch. */ i.prototype.Gu = function(t) {
        ...
        return this.persistence.runTransaction("Lookup mutation documents", "readonly", (function(n) {
            return e.Wn.Xo(n, t).next((function(t) {
                return t ? e.yu.Yn(n, t) : Me.resolve(null);
            }));
        }));
 ...
 */ function lr(t) {
    return e(this, void 0, void 0, (function() {
        return n(this, (function(e) {
            if (t.code !== T.FAILED_PRECONDITION || t.message !== Be) throw t;
            return _e("LocalStore", "Unexpectedly lost primary lease"), [ 2 /*return*/ ];
        }));
    }));
}
 ...
 */ var pr = /** @class */ function() {
    function t() {
        ...
        this.Yu = new Yt(dr.Ju), 
        // A set of outstanding references to a document sorted by target id.
        this.Xu = new Yt(dr.Zu)
    ...
    t.prototype.ic = function(t) {
        var e = this, n = L.EMPTY, r = new dr(n, t), i = new dr(n, t + 1), o = [];
        ...
        var e = L.EMPTY, n = new dr(e, t), r = new dr(e, t + 1), i = re();
        return this.Xu.Ke([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.Ch = function(t) {
        var e = new dr(t, 0), n = this.Yu.ze(e);
 ...
 */
function yr(t, e) {
    if (0 !== e.length) throw new I(T.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + Vr(e.length, "argument") + ".");
}
 ...
 */ function vr(t, e, n) {
    if (e.length !== n) throw new I(T.INVALID_ARGUMENT, "Function " + t + "() requires " + Vr(n, "argument") + ", but was called with " + Vr(e.length, "argument") + ".");
}
 ...
 */ function mr(t, e, n) {
    if (e.length < n) throw new I(T.INVALID_ARGUMENT, "Function " + t + "() requires at least " + Vr(n, "argument") + ", but was called with " + Vr(e.length, "argument") + ".");
}
 ...
 */ function gr(t, e, n, r) {
    if (e.length < n || e.length > r) throw new I(T.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + Vr(e.length, "argument") + ".");
}
...
function Ir(t, e, n, r, i) {
    void 0 !== r && function(t, e, n, r, i) {
        ...
        var c = Dr(r);
        throw new I(T.INVALID_ARGUMENT, "Invalid value " + c + " provided to function " + t + '() for option "' + n + '". Acceptable values: ' + o.join(", "));
    }(t, 0, n, r, i);
}
 ...
 */ function Nr(t, e, n, r) {
    if (!e.some((function(t) {
        return t === r;
    }))) throw new I(T.INVALID_ARGUMENT, "Invalid value " + Dr(r) + " provided to function " + t + "() for its " + Pr(n) + " argument. Acceptable values: " + e.join(", "));
    return r;
}

/** Helper to validate the type of a provided input. */ function _r(t, e, n, r) {
    if (!("object" === e ? Ar(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = Dr(r);
...
/** Returns a string describing the type / value of the provided input. */ function Dr(t) {
    ...
    return "function" == typeof t ? "a function" : Se();
}

function Sr(t, e, n) {
    if (void 0 === n) throw new I(T.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + Pr(e) + " argument, but it was undefined.");
}
 ...
 */ function Rr(t, e, n, r) {
    var i = Dr(r);
    return new I(T.INVALID_ARGUMENT, "Function " + t + "() requires its " + Pr(n) + " argument to be a " + e + ", but it was: " + i);
}

function kr(t, e, n) {
    if (n <= 0) throw new I(T.INVALID_ARGUMENT, "Function " + t + "() requires its " + Pr(e) + " argument to be a positive number, but it was: " + n + ".");
}

/** Converts a number to its english word representation */ function Pr(t) {
    switch (t) {
      case 1:
        return "first";
 ...
 * limitations under the License.
 */
/** Helper function to assert Uint8Array is available at runtime. */ function Or() {
...
/** Helper function to assert Base64 functions are available at runtime. */ function Lr() {
    if (!Te.nt().oc) throw new I(T.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ var Ur = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        vr("Blob.fromBase64String", arguments, 1), wr("Blob.fromBase64String", "string", 1, e), 
        Lr();
        try {
        ...
        if (vr("Blob.fromUint8Array", arguments, 1), Or(), !(e instanceof Uint8Array)) throw Rr("Blob.fromUint8Array", "Uint8Array", 1, e);
        return new t(j.fromUint8Array(e));
    }, t.prototype.toBase64 = function() {
        return vr("Blob.toBase64", arguments, 0), Lr(), this.ac.toBase64();
    }, t.prototype.toUint8Array = function() {
        return vr("Blob.toUint8Array", arguments, 0), Or(), this.ac.toUint8Array();
    }, t.prototype.toString = function() {
    ...
    !function(t, e, n, r) {
        if (!(e instanceof Array) || e.length < 1) throw new I(T.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + Vr(1, "element") + ".");
    }(0, t);
    for (var e = 0; e < t.length; ++e) if (wr("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new I(T.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
    this.uc = new O(t);
}, qr = /** @class */ function(e) {
    /**
    ...
    return t(n, e), n.documentId = function() {
        ...
        if (!(t instanceof n)) throw Rr("isEqual", "FieldPath", 1, t);
 ...
 */
var jr = new RegExp("[~\\*/\\[\\]]"), Mr = function() {
    /** A pointer to the implementing class. */
    this._c = this;
}, Fr = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).lc = t, n;
    }
    return t(n, e), n.prototype.dc = function(t) {
...
}(Mr), zr = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).lc = t, r.Ec = n, r;
    }
    return t(n, e), n.prototype.dc = function(t) {
...
}(Mr), Wr = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).lc = t, r.wc = n, r;
    }
    return t(n, e), n.prototype.dc = function(t) {
        var e = new ti({
            fc: 3 /* Argument */ ,
            methodName: this.lc
        }, t.ii, t.serializer, t.ignoreUndefinedProperties), n = ni(this.wc, e), r = new ht(t.serializer, n);
        return new pt(t.path, r);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    }, n;
}(Mr), Qr = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.delete = function() {
        return yr("FieldValue.delete", arguments), new Kr(new Fr("FieldValue.delete"));
    }, n.serverTimestamp = function() {
        return yr("FieldValue.serverTimestamp", arguments), new Kr(new Br("FieldValue.serverTimestamp"));
    }, n.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return mr("FieldValue.arrayUnion", arguments, 1), new Kr(new zr("FieldValue.arrayUnion", t));
    }, n.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return mr("FieldValue.arrayRemove", arguments, 1), new Kr(new Gr("FieldValue.arrayRemove", t));
    }, n.increment = function(t) {
        return wr("FieldValue.increment", "number", 1, t), vr("FieldValue.increment", arguments, 1), 
        new Kr(new Wr("FieldValue.increment", t));
    }, n;
}(Mr), Kr = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this)._c = t, n.lc = t.lc, n;
    }
    return t(n, e), n.prototype.dc = function(t) {
        return this._c.dc(t);
    }, n.prototype.isEqual = function(t) {
...
}(Qr), Yr = /** @class */ function() {
    function t(t, e) {
        if (vr("GeoPoint", arguments, 2), wr("GeoPoint", "number", 1, t), wr("GeoPoint", "number", 2, e), 
     ...
     */
    t.prototype.p = function(t) {
        return Pe(this.Rc, t.Rc) || Pe(this.Ac, t.Ac);
    }, t;
}(), Jr = /^__.*__$/, Xr = function(t, e, n) {
...
/** A "context" object passed around while parsing user data. */ var ti = /** @class */ function() {
    /**
    ...
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Zr(this.fc) && Jr.test(t)) throw this.Tc('Document fields cannot begin and end with "__"');
    }, t;
}(), ei = /** @class */ function() {
    function t(t, e, n) {
        this.ii = t, this.ignoreUndefinedProperties = e, this.serializer = n || Te.nt().Cc(t)
    ...
    return t.prototype.Fc = function(t, e, n) {
        ...
        var i, o, s = ri(e, r);
        if (n.merge) i = new lt(r.Vt), o = r.fieldTransforms; else if (n.mergeFields) {
            for (var u = [], a = 0, c = n.mergeFields; a < c.length; a++) {
                var h = c[a], f = void 0;
                if (h instanceof Cr) f = h.uc; else {
                    if ("string" != typeof h) throw Se();
                    f = ui(t, h);
                }
    ...
    /** Parse update data from an update() call. */ t.prototype.kc = function(t, e) {
        ...
        var r = [], i = new It;
        C(e, (function(e, o) {
            var s = ui(t, e), u = n.Sc(s);
            if (o instanceof Mr && o._c instanceof Fr) 
    ...
    /** Parse update data from a list of field/value arguments. */ t.prototype.Mc = function(t, e, n, r) {
        ...
        for (var a = [], c = new It, h = o.length - 1; h >= 0; --h) if (!ai(a, o[h])) {
            var f = o[h], l = s[h], p = i.Sc(f);
            if (l instanceof Mr && l._c instanceof Fr) 
            // Add it to the field mask, but don't add anything to updateData.
            a.push(f); else {
                var d = ni(l, p);
        ...
        var y = new lt(a);
        return new $r(c.yt(), y, i.fieldTransforms);
    }, 
    ...
    t.prototype.xc = function(t, e, n) {
        return void 0 === n && (n = !1), ni(e, this.Nc(n ? 4 /* ArrayArgument */ : 3 /* Argument */ , t));
    }, t;
}();
 ...
 */
function ni(t, e) {
    if (ii(t)) return oi("Unsupported field value:", e, t), ri(t, e);
    if (t instanceof Mr) 
    ...
    return function(t, e) {
        ...
        if (!Zr(e.fc)) throw e.Tc(t.lc + "() can only be used with update() and set()");
...
function ri(t, e) {
    ...
    e.path && e.path.length > 0 && e.Vt.push(e.path) : C(t, (function(t, r) {
        var i = ni(r, e.bc(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
...
function ii(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof x || t instanceof Yr || t instanceof Ur || t instanceof Xr || t instanceof Mr);
}
 ...
 */ function si(t, e) {
    if (e instanceof Cr) return e.uc;
 ...
 */ function ui(t, e) {
    try {
        return function(t) {
            if (t.search(jr) >= 0) throw new I(T.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
 ...
 */ var ci = /** @class */ function() {
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.Bc = 0, this.qc = null, this.stream = null, this.Na = new Ye(t, e)
        /**
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.state = t, [ 4 /*yield*/ , this.listener.Jc(r) ];
    ...
    t.prototype.t_ = function(t) {
        ...
        return _e("PersistentStream", "close with error: " + t), this.stream = null, this.close(3 /* Error */ , t);
    }, 
    /**
    ...
    t.prototype.Xc = function(t) {
        ...
        return function(n) {
            e.Tr.co((function() {
                return e.Bc === t ? n() : (_e("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    function n(t, n, r, i, o) {
        ...
        /**
             ...
             * next request.
             */
        s.lastStreamToken = j.ht, s;
    }
    return t(n, e), Object.defineProperty(n.prototype, "a_", {
        /**
    ...
    n.prototype.start = function() {
        this.o_ = !1, this.lastStreamToken = j.ht, e.prototype.start.call(this);
        ...
        xe(!!t.streamToken), this.lastStreamToken = this.serializer.ci(t.streamToken), this.o_) {
        ...
        // The first response is always the handshake response
                return xe(!t.writeResults || 0 === t.writeResults.length), this.o_ = !0, 
        this.listener.__();
    }, 
    /**
...
}(ci), li = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).Oc = t, i.credentials = n, i.serializer = r, i.f_ = !1, 
        i;
    }
    return t(n, e), n.prototype.T_ = function() {
        if (this.f_) throw new I(T.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    ...
    return t.prototype.V_ = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.g_(), this.mutations.length > 0) throw new I(T.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    ...
                                    }, [ 4 /*yield*/ , e.I_("BatchGetDocuments", i) ];
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((r = o.sent()).forEach((function(t) {
                        t instanceof xt || t instanceof St ? i.p_(t) : Se();
                    })), r) ];
                }
            }));
        }));
        ...
        this.write([ new Et(t, this.Rt(t)) ]), this.P_.add(t);
            ...
            return n(this, (function(i) {
                switch (i.label) {
                  case 0:
                    ...
                    t.forEach((function(t, e) {
                        var n = new L(P.K(e));
                        r.mutations.push(new bt(n, r.Rt(n)));
                  ...
                  case 1:
                    // For each mutation, note that the doc was written.
                    return i.sent(), this.A_ = !0, [ 2 /*return*/ ];
                }
            }));
        }));
    ...
    t.prototype.Rt = function(t) {
        ...
        return !this.P_.has(t) && e ? yt.updateTime(e) : yt.ft();
    }, 
    /**
    ...
    t.prototype.set = function(t) {
        ...
        this.D_ ? (Ae(e), this.D_ = !1) : _e("OnlineStateTracker", e);
    ...
    r, i, o, s) {
        ...
        /**
             ...
             * again.
             */
        this.q_ = !1, this.U_ = s, this.U_.Q_((function(t) {
            i.co((function() {
                return e(u, void 0, void 0, (function() {
                    return n(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return this.W_() ? (_e("RemoteStore", "Restarting streams for network reachability change."), 
        ...
        this.G_ = function(t, e, n) {
            var r = Re(t);
            return new hi(e, r.Oc, r.credentials, r.serializer, n);
        }(this.w_, i, {
            ...
            var r = Re(t);
            return new fi(e, r.Oc, r.credentials, r.serializer, n);
        }(this.w_, i, {
    ...
    t.prototype.disableNetwork = function() {
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    return t.sent(), this.O_.length > 0 && (_e("RemoteStore", "Stopping write stream with " + this.O_.length + " pending writes"), 
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return _e("RemoteStore", "RemoteStore shutting down."), this.networkEnabled = !1, 
                    [ 4 /*yield*/ , this.rl() ];
    ...
    t.prototype.ul = function(t) {
        ...
        this.B_ = new ye(this), this.G_.start(), this.K_.C_();
    }, 
    /**
    ...
    }, t.prototype.Y_ = function(t, r) {
        return e(this, void 0, void 0, (function() {
            var e, i, o;
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (this.K_.set("Online" /* Online */), !(t instanceof pe && 2 /* Removed */ === t.state && t.cause)) 
                    // Mark the client as online since we got a message from the server
                    return [ 3 /*break*/ , 6 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 5 ]), [ 4 /*yield*/ , this._l(t) ];

                  case 2:
                    return n.sent(), [ 3 /*break*/ , 5 ];

                  case 3:
                    return e = n.sent(), _e("RemoteStore", "Failed to remove targets %s: %s ", t.targetIds.join(","), e), 
                    [ 4 /*yield*/ , this.ll(e) ];
                  ...
                  case 6:
                    if (t instanceof fe ? this.B_.qs(t) : t instanceof le ? this.B_.Hs(t) : this.B_.Ws(t), 
                    r.isEqual(R.min())) return [ 3 /*break*/ , 13 ];
                    n.label = 7;

                  case 7:
                    return n.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , this.x_._h() ];

                  case 8:
                    return i = n.sent(), r.S(i) >= 0 ? [ 4 /*yield*/ , this.dl(r) ] : [ 3 /*break*/ , 10 ];
                  ...
                  case 11:
                    return _e("RemoteStore", "Failed to raise snapshot:", o = n.sent()), [ 4 /*yield*/ , this.ll(o) ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  ...
                  case 1:
                    // Disable network and raise offline snapshots
                    return o.sent(), this.K_.set("Offline" /* Offline */), r || (
                    ...
                    this.Ra.lo((function() {
                        return e(i, void 0, void 0, (function() {
                            return n(this, (function(t) {
                                switch (t.label) {
                                  case 0:
                                    return _e("RemoteStore", "Retrying IndexedDB access"), [ 4 /*yield*/ , r() ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return r < i.length ? (o = i[r], this.L_.has(o) ? [ 4 /*yield*/ , this.cl.Tl(o, e) ] : [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 5 ];

                  case 2:
                    n.sent(), this.L_.delete(o), this.B_.removeTarget(o), n.label = 3;
    ...
    t.prototype.nl = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    t = this.O_.length > 0 ? this.O_[this.O_.length - 1].batchId : -1, n.label = 1;
                  ...
                  case 2:
                    return n.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , this.x_.Bu(t) ];

                  case 3:
                    return null === (e = n.sent()) ? (0 === this.O_.length && this.J_.Kc(), [ 3 /*break*/ , 7 ]) : (t = e.batchId, 
                    this.Il(e), [ 3 /*break*/ , 6 ]);

                  case 4:
                    return r = n.sent(), [ 4 /*yield*/ , this.ll(r) ];
    ...
    t.prototype.Il = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                ...
                for (t = 0, e = this.O_; t < e.length; t++) r = e[t], this.J_.u_(r.mutations);
                return [ 2 /*return*/ ];
            }));
        }));
    }, t.prototype.c_ = function(t, r) {
        return e(this, void 0, void 0, (function() {
            var e, i, o = this;
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = this.O_.shift(), i = je.from(e, t, r), [ 4 /*yield*/ , this.fl((function() {
                        return o.cl.ml(i);
                    })) ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return zt(r = t.code) && r !== T.ABORTED ? (e = this.O_.shift(), 
                    // In this case it's also unlikely that the server itself is melting
                    // down -- this was just a bad request so inhibit backoff on the next
                    // restart.
                    this.J_.jc(), [ 4 /*yield*/ , this.fl((function() {
                        return i.cl.Vl(e.batchId, t);
                    })) ]) : [ 3 /*break*/ , 3 ];
            ...
            return n(this, (function(t) {
                switch (t.label) {
                  case 0:
                    ...
                    _e("RemoteStore", "RemoteStore restarting streams for new credential"), [ 4 /*yield*/ , this.j_() ]) : [ 3 /*break*/ , 2 ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 2:
                    return (e = t) ? [ 3 /*break*/ , 4 ] : [ 4 /*yield*/ , this.rl() ];

                  case 3:
                    n.sent(), e = this.K_.set("Unknown" /* Unknown */), n.label = 4;
...
var wi = /** @class */ function() {
    ...
    return t.bl = function(e, n, r) {
        ...
        o ? new t(e, n, i.state, s) : (Ae("SharedClientState", "Failed to parse mutation state for ID '" + n + "': " + r), 
        null);
    ...
    return t.bl = function(e, n) {
        ...
        i ? new t(e, r.state, o) : (Ae("SharedClientState", "Failed to parse target state for ID '" + e + "': " + n), 
        null);
    }, t.prototype.vl = function() {
        var t = {
            state: this.state,
    ...
    return t.bl = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = oe(), s = 0; i && s < r.activeTargetIds.length; ++s) i = B(r.activeTargetIds[s]), 
        o = o.add(r.activeTargetIds[s]);
        return i ? new t(e, o) : (Ae("SharedClientState", "Failed to parse client data for instance '" + e + "': " + n), 
        null);
    }, t;
}(), Ti = /** @class */ function() {
    function t(t, e) {
    ...
    return t.bl = function(e) {
        var n = JSON.parse(e);
        return "object" == typeof n && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(n.onlineState) && "string" == typeof n.clientId ? new t(n.clientId, n.onlineState) : (Ae("SharedClientState", "Failed to parse online state: " + e), 
        null);
    }, t;
}(), Ii = /** @class */ function() {
    function t() {
    ...
    function t(e, n, r, i, o) {
        ...
        this.b_ = null, this.ur = null, this.Fl = this.Nl.bind(this), this.kl = new Wt(Pe), 
        this.ho = !1, 
        /**
             * Captures WebStorage events that occur before `start()` is called. These
             * events are replayed once `WebStorageSharedClientState` is started.
             */
        this.Ml = [], !t.zh(this.platform)) throw new I(T.UNIMPLEMENTED, "LocalStorage is not available on this platform.");
        // Escape the special characters mentioned here:
        // https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions
                var s = r.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.platform.window.localStorage, this.currentUser = o, this.xl = vi(this.persistenceKey, this.Cl), 
        this.$l = 
        /** Assembles the key for the current sequence number. */
        function(t) {
            return "firestore_sequence_number_" + t;
        }(this.persistenceKey), this.kl = this.kl.Ae(this.Cl, new Ii), this.Ol = new RegExp("^firestore_clients_" + s + "_([^_]*)$"), 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.zh = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    for (t = n.sent(), e = 0, r = t; e < r.length; e++) (i = r[e]) !== this.Cl && (o = this.getItem(vi(this.persistenceKey, i))) && (s = bi.bl(i, o)) && (this.kl = this.kl.Ae(s.clientId, s));
        ...
        return _e("SharedClientState", "READ", t, e), e;
    }, t.prototype.setItem = function(t, e) {
        _e("SharedClientState", "SET", t, e), this.storage.setItem(t, e);
    }, t.prototype.removeItem = function(t) {
        _e("SharedClientState", "REMOVE", t), this.storage.removeItem(t);
    }, t.prototype.Nl = function(t) {
        var r = this;
        if (t.storageArea === this.storage) {
            if (_e("SharedClientState", "EVENT", t.key, t.newValue), t.key === this.xl) return void Ae("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.Tr.lo((function() {
                return e(r, void 0, void 0, (function() {
                    var e, r, i, o, s, u;
                    return n(this, (function(n) {
                        if (this.ho) {
                            if (null !== t.key) if (this.Ol.test(t.key)) {
                                if (null == t.newValue) return e = this.ad(t.key), [ 2 /*return*/ , this.ud(e, null) ];
                                ...
                                if (null != t) try {
                                    var n = JSON.parse(t);
                                    xe("number" == typeof n), e = n;
                                } catch (t) {
                                    Ae("SharedClientState", "Failed to read sequence number from WebStorage", t);
                                }
                                return e;
                            }(t.newValue)) !== Qe.dr && this.ur(u);
                        } else this.Ml.push(t);
                        return [ 2 /*return*/ ];
                    }));
                }));
        ...
        var r = new wi(this.currentUser, t, e, n), i = mi(this.persistenceKey, this.currentUser, t);
        this.setItem(i, r.vl());
        ...
        var r = gi(this.persistenceKey, t), i = new Ei(t, e, n);
        this.setItem(r, i.vl());
    }, 
    /**
    ...
    t.prototype.Ql = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.cl.Ed(t.batchId, t.state, t.error) ] : (_e("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
    }, t.prototype.Td = function(t) {
    ...
    function t() {
        this.Rd = new Ii, this.Ad = {}, this.cl = null, this.b_ = null, this.ur = null;
    }
    return t.prototype.zl = function(t) {
        ...
        return this.Rd = new Ii, Promise.resolve();
    }, t.prototype.vu = function(t, e, n) {
        // No op.
    }, t.prototype.hd = function(t) {
        // No op.
    ...
    e) {
        ...
        this.ns = re(), this.gd = new se(t.se.bind(t));
    }
    ...
    t.prototype.yd = function(t, e) {
        var n = this, r = e ? e.bd : new ue, i = e ? e.gd : this.gd, o = e ? e.ns : this.ns, s = i, u = !1, a = this.query.oe() && i.size === this.query.limit ? i.last() : null, c = this.query.ae() && i.size === this.query.limit ? i.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.pe((function(t, e) {
            var h = i.get(t), f = e instanceof St ? e : null;
    ...
    t.prototype.Ln = function(t, e, n) {
        ...
        return this.Pd = u, 0 !== o.length || a ? {
            snapshot: new ae(this.query, t.gd, i, o, t.ns, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            Fd: s
        } : {
            Fd: s
    ...
    t.prototype.Dd = function(t) {
        ...
        // updating many documents.
                var e = this.Vd;
        this.Vd = re(), this.gd.forEach((function(e) {
    ...
    t.prototype.xd = function() {
        return ae.os(this.query, this.gd, this.ns, 0 /* Local */ === this.Pd);
    }, t;
}(), xi = /** @class */ function() {
    function t(t, e, n, r) {
        this.Ra = t, this.w_ = e, this.updateFunction = n, this.Pa = r, this.$d = 5, this.Na = new Ye(this.Ra, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.Od = function() {
        ...
        this.Na.gr((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = new pi(this.w_), (e = this.Bd(t)) && e.then((function(e) {
                        r.Ra.co((function() {
        ...
        try {
            ...
            return !M(e) && e.catch && e.then ? e : (this.Pa.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
n) {
    ...
    r, i, o) {
        ...
        this.Gd = null, this.zd = new Ce((function(t) {
            return t.canonicalId();
        })), this.Hd = new Map, 
        /**
        ...
        /**
             ...
             */
        this.Xd = new Map, this.Zd = new pr, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.tf = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.ef = new Map, this.sf = cn.rh(), this.onlineState = "Unknown" /* Unknown */;
    }
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    e = i.targetId, this.jd.Xl(e), r = i.view.xd(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , this.x_.Uu(t.ee()) ];

                  case 2:
                    return o = n.sent(), s = this.jd.Xl(o.targetId), e = o.targetId, [ 4 /*yield*/ , this.rf(t, e, "current" === s) ];

                  case 3:
                    r = n.sent(), this.if && this.Wd.listen(o), n.label = 4;
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return e = n.sent(), o = new Si(t, e.ju), s = o.yd(e.documents), u = he.ds(r, i && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.Ln(s, 
                    /* updateLimboDocuments= */ this.if, u), this.hf(r, a.Fd), c = new Ri(t, r, o), 
                    [ 2 /*return*/ , (this.zd.set(t, c), this.Hd.has(r) ? this.Hd.get(r).push(t) : this.Hd.set(r, [ t ]), 
                    a.snapshot) ];
                }
            }));
        }));
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // to the target.
                    return this.nf("unlisten()"), e = this.zd.get(t), (r = this.Hd.get(e.targetId)).length > 1 ? [ 2 /*return*/ , (this.Hd.set(e.targetId, r.filter((function(e) {
                        return !e.isEqual(t);
                    }))), void this.zd.delete(t)) ] : this.if ? (
                    // We need to remove the local query target first to allow us to verify
                    // whether any other client is still interested in this target.
                    this.jd.td(e.targetId), this.jd.Gl(e.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , this.x_.Qu(e.targetId, /*keepPersistedTargetData=*/ !1).then((function() {
                        i.jd.sd(e.targetId), i.Wd.al(e.targetId), i.af(e.targetId);
                    })).catch(lr) ]) : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    return this.af(e.targetId), [ 4 /*yield*/ , this.x_.Qu(e.targetId, 
    ...
    t.prototype.write = function(t, r) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.nf("write()"), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , this.x_.Fu(t) ];

                  case 2:
                    return e = n.sent(), this.jd.zl(e.batchId), this.uf(e.batchId, r), [ 4 /*yield*/ , this.cf(e.Dn) ];

                  case 3:
                    return n.sent(), [ 4 /*yield*/ , this.Wd.nl() ];

                  case 4:
                    return n.sent(), [ 3 /*break*/ , 6 ];

                  case 5:
                    return i = n.sent(), o = rr(i, "Failed to persist write"), r.reject(o), [ 3 /*break*/ , 6 ];
    ...
    t.prototype.runTransaction = function(t, e, n) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.nf("applyRemoteEvent()"), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.x_.xu(t) ];
                  ...
                  case 2:
                    ...
                    t.as.forEach((function(t, e) {
                        ...
                        xe(t.Ts.size + t.Es.size + t.Is.size <= 1), t.Ts.size > 0 ? n.Qd = !0 : t.Es.size > 0 ? xe(n.Qd) : t.Is.size > 0 && (xe(n.Qd), 
                        n.Qd = !1));
                    })), [ 4 /*yield*/ , this.cf(e, t) ];
    ...
    t.prototype.Nd = function(t, e) {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.jd.nd(t, "rejected", r), e = this.Xd.get(t), (i = e && e.key) ? (o = (o = new Wt(L.N)).Ae(i, new xt(i, R.min())), 
                    s = re().add(i), u = new ce(R.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new Yt(Pe), o, s), [ 4 /*yield*/ , this.xu(u) ]) : [ 3 /*break*/ , 2 ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.nf("applySuccessfulWrite()"), e = t.batch.batchId, n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.x_.Nu(t) ];
                  ...
                  case 2:
                    ...
                    this.df(e, /*error=*/ null), this.ff(e), this.jd.Yl(e, "acknowledged"), [ 4 /*yield*/ , this.cf(r) ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.nf("rejectFailedWrite()"), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.x_.Mu(t) ];
                  ...
                  case 2:
                    ...
                    // listen events.
                    this.df(t, r), this.ff(t), this.jd.Yl(t, "rejected", r), [ 4 /*yield*/ , this.cf(e) ];
    ...
    t.prototype.Tf = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.Wd.W_() || _e("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.x_.ta() ];

                  case 2:
                    return -1 === (e = n.sent()) ? [ 2 /*return*/ , void t.resolve() ] : ((r = this.ef.get(e) || []).push(t), 
                    this.ef.set(e, r), [ 3 /*break*/ , 4 ]);

                  case 3:
                    return i = n.sent(), o = rr(i, "Initialization of waitForPendingWrites() operation failed"), 
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.Ef = function(t) {
        ...
        n || (n = new Wt(Pe)), n = n.Ae(t, e), this.tf[this.currentUser.s()] = n;
    }, 
    /**
    ...
    t.prototype.df = function(t, e) {
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof Ai ? (this.Zd.yh(i.key, t), this.Rf(i)) : i instanceof Di ? (_e("SyncEngine", "Document no longer in limbo: " + i.key), 
        ...
        var e = t.key;
        this.Jd.get(e) || (_e("SyncEngine", "New document in limbo: " + e), this.Yd.push(e), 
        this.lf());
    }, 
    /**
    ...
    t.prototype.lf = function() {
        for (;this.Yd.length > 0 && this.Jd.size < this.Kd; ) {
            ...
            this.Xd.set(e, new ki(t)), this.Jd = this.Jd.Ae(t, e), this.Wd.listen(new Ft(Pt.Wt(t.path).ee(), e, 2 /* LimboResolution */ , Qe.dr));
        }
    }, 
    // Visible for testing
    ...
    t.prototype.mf = function() {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = [], i = [], o = [], this.zd.forEach((function(n, u) {
                        o.push(Promise.resolve().then((function() {
                            ...
                            var n = r && r.as.get(u.targetId), o = u.view.Ln(t, 
                            /* updateLimboDocuments= */ s.if, n);
                            if (s.hf(u.targetId, o.Fd), o.snapshot) {
                                s.if && s.jd.nd(u.targetId, o.snapshot.fromCache ? "not-current" : "current"), e.push(o.snapshot);
                                var a = We.ar(u.targetId, o.snapshot);
                                i.push(a);
                            }
                        })));
                  ...
                  case 1:
                    return n.sent(), this.Gd.n_(e), [ 4 /*yield*/ , this.x_.Lu(i) ];
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    ...
                    this.jd.vu(t, e.Du, e.Cu), [ 4 /*yield*/ , this.cf(e.Su) ];
        ...
        var e = this.Xd.get(t);
        if (e && e.Qd) return re().add(e.key);
        var n = re(), r = this.Hd.get(t);
        if (!r) return n;
    ...
    function i(t, e, n, i, o, s) {
        var u = this;
        return (u = r.call(this, t, e, n, i, o, s) || this).x_ = t, 
        // The primary state is set to `true` or `false` immediately after Firestore
        // startup. In the interim, a client should only be considered primary if
        // `isPrimary` is true.
        u.Pf = void 0, u;
    }
    return t(i, r), Object.defineProperty(i.prototype, "if", {
        get: function() {
            return !0 === this.Pf;
        },
        enumerable: !0,
        ...
        return this.x_.uo(!0), r.prototype.enableNetwork.call(this);
    }, i.prototype.disableNetwork = function() {
        return this.x_.uo(!1), r.prototype.disableNetwork.call(this);
    }, 
    /**
    ...
    i.prototype.Vf = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return e = n.sent(), r = t.view.Md(e), [ 2 /*return*/ , (this.Pf && this.hf(t.targetId, r.Fd), 
                    r) ];
                }
            }));
        }));
    }, i.prototype.Nd = function(t, e) {
        // If we are the primary client, the online state of all clients only
        // depends on the online state of the local RemoteStore.
        this.if && 0 /* RemoteStore */ === e && (r.prototype.Nd.call(this, t, e), this.jd.hd(t)), 
        // If we are the secondary client, we explicitly ignore the remote store's
        // online state (the local client may go offline, even though the primary
        // tab remains online) and only apply the primary tab's online state from
        // SharedClientState.
        this.if || 1 /* SharedClientState */ !== e || r.prototype.Nd.call(this, t, e);
    }, i.prototype.Ed = function(t, r, i) {
        return e(this, void 0, void 0, (function() {
            var e;
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return null === (e = n.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== r ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , this.Wd.nl() ];
                  ...
                  case 3:
                    ...
                    // other clients.
                    this.df(t, i || null), this.x_.zu(t)) : Se(), n.label = 4;

                  case 4:
                    return [ 4 /*yield*/ , this.cf(e) ];
                  ...
                  case 6:
                    ...
                    // as applicable.
                    _e("SyncEngine", "Cannot apply mutation batch with id: " + t), n.label = 7;
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return !0 !== t || !0 === this.Pf ? [ 3 /*break*/ , 3 ] : (e = this.jd.jl(), [ 4 /*yield*/ , this.gf(e.W(), 
                    /*transitionToPrimary=*/ !0) ]);

                  case 1:
                    return r = n.sent(), this.Pf = !0, [ 4 /*yield*/ , this.Wd.yl(!0) ];

                  case 2:
                    for (n.sent(), i = 0, o = r; i < o.length; i++) s = o[i], this.Wd.listen(s);
                    return [ 3 /*break*/ , 7 ];
                  ...
                  case 4:
                    return n.sent(), [ 4 /*yield*/ , this.gf(u, 
                    /*transitionToPrimary=*/ !1) ];

                  case 5:
                    return n.sent(), this.pf(), this.Pf = !1, [ 4 /*yield*/ , this.Wd.yl(!1) ];
        ...
        this.Xd.forEach((function(e, n) {
            t.Wd.al(n);
        })), this.Zd.nc(), this.Xd = new Map, this.Jd = new Wt(L.N);
    }, 
    /**
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 8:
                    return d = n.sent(), [ 4 /*yield*/ , this.x_.Uu(d) ];

                  case 9:
                    return u = n.sent(), [ 4 /*yield*/ , this.rf(this.yf(d), s, 
                    /*current=*/ !1) ];
                  ...
                  case 13:
                    return [ 2 /*return*/ , (this.Gd.n_(r), e) ];
                }
            }));
        }));
    }, 
    ...
    i.prototype.yf = function(t) {
        return new Pt(t.path, t.collectionGroup, t.orderBy, t.filters, t.limit, "F" /* First */ , t.startAt, t.endAt);
    }, i.prototype.So = function() {
        return this.x_.So();
    }, i.prototype.Id = function(t, r, i) {
        return e(this, void 0, void 0, (function() {
            var e, o;
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    _e("SyncEngine", "Ignoring unexpected query state notification."), [ 3 /*break*/ , 8 ]) : [ 3 /*break*/ , 1 ];
                  ...
                  case 3:
                    return e = n.sent(), o = ce.ls(t, "current" === r), [ 4 /*yield*/ , this.cf(e, o) ];
                  ...
                  case 6:
                    return n.sent(), this.af(t, i), [ 3 /*break*/ , 8 ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(d) {
                switch (d.label) {
                  ...
                  case 1:
                    return e < i.length ? (o = i[e], this.Hd.has(o) ? (
                    // A target might have been added in a previous attempt
                    _e("SyncEngine", "Adding an already active target " + o), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , this.x_.Hu(o) ]) : [ 3 /*break*/ , 6 ];
    ...
    function t(t) {
        this.cl = t, this.Sf = new Ce((function(t) {
            return t.canonicalId();
    ...
    return t.prototype.listen = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (e = t.query, r = !1, (i = this.Sf.get(e)) || (r = !0, i = new Oi), !r) return [ 3 /*break*/ , 4 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), o = i, [ 4 /*yield*/ , this.cl.listen(e) ];

                  case 2:
                    return o.bf = n.sent(), [ 3 /*break*/ , 4 ];

                  case 3:
                    return s = n.sent(), u = rr(s, "Initialization of query '" + t.query + "' failed"), 
                    [ 2 /*return*/ , void t.onError(u) ];

                  case 4:
                    return this.Sf.set(e, i), i.vf.push(t), 
        ...
        return e(this, void 0, void 0, (function() {
            var e, r, i, o;
            return n(this, (function(n) {
                return e = t.query, r = !1, (i = this.Sf.get(e)) && (o = i.vf.indexOf(t)) >= 0 && (i.vf.splice(o, 1), 
                r = 0 === i.vf.length), r ? [ 2 /*return*/ , (this.Sf.delete(e), this.cl.al(e)) ] : [ 2 /*return*/ ];
            }));
        }));
    }, t.prototype.n_ = function(t) {
    ...
    return t.prototype.Cf = function(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new ae(t.query, t.docs, t.ss, e, t.ns, t.fromCache, t.rs, 
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.Nd = function(t) {
        ...
        t = ae.os(t.query, t.docs, t.ns, t.fromCache), this.xf = !0, this.Mf.next(t);
    }, t;
}(), Ci = /** @class */ function() {
    function t() {}
    return t.prototype.bu = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.te() || n.isEqual(R.min()) ? this.Qf(t, e) : this.Uf.Yn(t, r).next((function(o) {
            var u = i.Wf(e, o);
            return (e.oe() || e.ae()) && i.Sd(e.Bt, u, r, n) ? i.Qf(t, e) : (Ne() <= s.DEBUG && _e("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), e.toString()), 
            i.Uf.Zn(t, e, n).next((function(t) {
    ...
    t.prototype.Sd = function(t, e, n, r) {
        ...
        return Ne() <= s.DEBUG && _e("IndexFreeQueryEngine", "Using full collection scan to execute query:", e.toString()), 
        this.Uf.Zn(t, e, R.min());
    }, t;
}(), qi = /** @class */ function() {
    function t(t, e) {
        this.jn = t, this.hh = e, 
        ...
        this.Kf = new Yt(dr.Ju);
    }
    return t.prototype.Ho = function(t) {
        return Me.resolve(0 === this.Wn.length);
    }, t.prototype.Yo = function(t, e, n, r) {
        var i = this.jf;
        this.jf++, this.Wn.length > 0 && this.Wn[this.Wn.length - 1];
        var o = new qe(i, e, n, r);
        this.Wn.push(o);
        // Track references by document key and index collection parents.
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.Kf = this.Kf.add(new dr(a.key, i)), this.jn.Dr(t, a.key.path.$());
        }
        return Me.resolve(o);
    }, t.prototype.Jo = function(t, e) {
        return Me.resolve(this.Gf(e));
    }, t.prototype.Zo = function(t, e) {
        var n = e + 1, r = this.zf(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Me.resolve(this.Wn.length > i ? this.Wn[i] : null);
    }, t.prototype.ta = function() {
        return Me.resolve(0 === this.Wn.length ? -1 : this.jf - 1);
    }, t.prototype.ea = function(t) {
        return Me.resolve(this.Wn.slice());
    }, t.prototype.Gn = function(t, e) {
        var n = this, r = new dr(e, 0), i = new dr(e, Number.POSITIVE_INFINITY), o = [];
        ...
        return e.forEach((function(t) {
            var e = new dr(t, 0), i = new dr(t, Number.POSITIVE_INFINITY);
            n.Kf.Ke([ e, i ], (function(t) {
                r = r.add(t.hc);
            }));
        })), Me.resolve(this.Hf(r));
    }, t.prototype.nr = function(t, e) {
        ...
        // because it precedes all other segments in an ordered traversal.
                L.et(i) || (i = i.child(""));
        var o = new dr(new L(i), 0), s = new Yt(Pe);
        ...
        var n = this;
        xe(0 === this.Yf(e.batchId, "removed")), this.Wn.shift();
        var r = this.Kf;
        return Me.forEach(e.mutations, (function(i) {
            var o = new dr(i.key, e.batchId);
        ...
        var n = new dr(e, 0), r = this.Kf.ze(n);
        return Me.resolve(e.isEqual(r && r.key));
    }, t.prototype.ra = function(t) {
        return this.Wn.length, Me.resolve();
    }, 
    /**
    ...
    t.prototype.Mn = function(t) {
        ...
        ; o.ke(); ) {
            ...
            h.S(n) <= 0 || c instanceof St && e.matches(c) && (r = r.Ae(c.key, c));
        }
        return Me.resolve(r);
 ...
 */
ji.Jr = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).th = t, n;
    }
    return t(n, e), n.prototype.Ln = function(t) {
        var e = this, n = [];
...
var Mi = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.eT = new pr, this.targetCount = 0, this.sT = cn.nh();
    }
    return t.prototype.js = function(t, e) {
        ...
        return Me.resolve(this.tT);
    }, t.prototype.oh = function(t) {
        return this.highestTargetId = this.sT.next(), Me.resolve(this.highestTargetId);
    }, t.prototype.dh = function(t, e, n) {
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.sT = new cn(e), this.highestTargetId = e), t.sequenceNumber > this.tT && (this.tT = t.sequenceNumber);
    }, t.prototype.fh = function(t, e) {
        return this.Th(e), this.targetCount += 1, Me.resolve();
    }, t.prototype.Ih = function(t, e) {
        return this.Th(e), Me.resolve();
    }, t.prototype.wh = function(t, e) {
        ...
        return this.eT.tc(e, n), Me.resolve();
    }, t.prototype.bh = function(t, e, n) {
        this.eT.sc(e, n);
        ...
        return this.eT.ic(e), Me.resolve();
    }, t.prototype.Sh = function(t, e) {
        var n = this.eT.rc(e);
        return Me.resolve(n);
    }, t.prototype.Ch = function(t, e) {
        return Me.resolve(this.eT.Ch(e));
    }, t;
}(), Fi = /** @class */ function() {
    /**
    ...
    function t(t) {
        ...
        this.Jh = new Mi(this), this.jn = new Ze, this.Qn = new ji(this.jn, (function(t) {
            return e.hh.nT(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this.iT[t.s()];
        return e || (e = new qi(this.jn, this.hh), this.iT[t.s()] = e), e;
    }, t.prototype.Fo = function() {
        return this.Jh;
    }, t.prototype.No = function() {
        return this.Qn;
        ...
        var r = this;
        _e("MemoryPersistence", "Starting transaction:", t);
        var i = new Bi(this.qh.next());
        ...
        return Me.Sn(Object.values(this.iT).map((function(n) {
            return function() {
                return n.Ch(t, e);
            };
        })));
    ...
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).Oh = t, n;
    }
    return t(n, e), n;
}(ze), zi = /** @class */ function() {
    function t(t) {
        this.persistence = t, 
    ...
    return t.cT = function(e) {
        ...
        return this.aT.yh(n, e), this._T.delete(n), Me.resolve();
    }, t.prototype.vh = function(t, e, n) {
        return this.aT.vh(n, e), this._T.add(n), Me.resolve();
    }, t.prototype.Uo = function(t, e) {
        return this._T.add(e), Me.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        ...
        // Remove newly orphaned documents.
                return Me.forEach(this._T, (function(r) {
...
}(), Gi = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", Wi = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.sent(), this.TT = this.ET(t), this.x_ = this.IT(t), this.Wd = this.wT(t), 
                    this.cl = this.RT(t), this.AT = this.mT(t), this.jd.b_ = function(t) {
                        return e.cl.Nd(t, 1 /* SharedClientState */);
                    }, this.Wd.cl = this.cl, [ 4 /*yield*/ , this.x_.start() ];

                  case 2:
                    return n.sent(), [ 4 /*yield*/ , this.jd.start() ];

                  case 3:
                    return n.sent(), [ 4 /*yield*/ , this.Wd.start() ];

                  case 4:
                    return n.sent(), [ 4 /*yield*/ , this.Wd.yl(this.cl.if) ];
        ...
        return new Li(this.cl);
    }, t.prototype.ET = function(t) {
        return null;
    }, t.prototype.IT = function(t) {
        return new hr(this.persistence, new Ci, t.PT);
    }, t.prototype.fT = function(t) {
        if (t.gT.VT) throw new I(T.FAILED_PRECONDITION, Gi);
        return new Fi(zi.cT);
    }, t.prototype.wT = function(t) {
        var e = this;
        return new yi(this.x_, t.w_, t.Ra, (function(t) {
            return e.cl.Nd(t, 0 /* RemoteStore */);
        }), t.platform.pT());
    }, t.prototype.dT = function(t) {
        return new _i;
    }, t.prototype.RT = function(t) {
        return new Pi(this.x_, this.Wd, t.w_, this.jd, t.PT, t.Kd);
    }, t.prototype.clearPersistence = function(t) {
        throw new I(T.FAILED_PRECONDITION, Gi);
    }, t;
}(), Qi = /** @class */ function(r) {
    function i() {
    ...
    return t(i, r), i.prototype.initialize = function(t) {
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  ...
                  case 1:
                    ...
                    return o.sent(), [ 4 /*yield*/ , this.persistence.ro((function(t) {
                        return e(i, void 0, void 0, (function() {
                            return n(this, (function(e) {
                                switch (e.label) {
                                  case 0:
        ...
        return new fr(this.persistence, new Ci, t.PT);
    }, i.prototype.RT = function(t) {
        var e = new Vi(this.x_, this.Wd, t.w_, this.jd, t.PT, t.Kd);
        return this.jd instanceof Ni && (this.jd.cl = e), e;
    }, i.prototype.ET = function(t) {
        var e = this.persistence.hh.$o;
        return new ar(e, t.Ra);
    }, i.prototype.fT = function(t) {
        var e = mn.xo(t.yT), n = t.platform.Cc(t.yT.ii);
        return new mn(t.gT.synchronizeTabs, e, t.clientId, t.platform, ur.nu(t.gT.cacheSizeBytes), t.Ra, n, this.jd, t.gT.Bh);
    }, i.prototype.dT = function(t) {
        if (t.gT.VT && t.gT.synchronizeTabs) {
            if (!Ni.zh(t.platform)) throw new I(T.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
            var e = mn.xo(t.yT);
            return new Ni(t.Ra, t.platform, e, t.clientId, t.PT);
        }
        return new _i;
    }, i.prototype.clearPersistence = function(t) {
        var e = mn.xo(t);
        return mn.clearPersistence(e);
    }, i;
}(Wi), Ki = /** @class */ function() {
    function t(t, e, n, 
    /**
     ...
     */
    r) {
        this.platform = t, this.yT = e, this.credentials = n, this.Ra = r, this.clientId = ke.cn()
        /**
    ...
    return t.prototype.start = function(t, e) {
        ...
        return this.credentials.l((function(s) {
            if (!o) return o = !0, _e("FirestoreClient", "Initializing. user=", s.uid), n.bT(t, e, s, i).then(r.resolve, r.reject);
            n.Ra.lo((function() {
                return n.pl(s);
            }));
        })), 
     ...
     *     succeeded.
     */
    t.prototype.bT = function(t, r, i, o) {
        return e(this, void 0, void 0, (function() {
            var s, u, a, c, h = this;
            return n(this, (function(f) {
                switch (f.label) {
                  case 0:
                    return f.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , this.platform.vT(this.yT) ];

                  case 1:
                    return s = f.sent(), u = this.platform.Cc(this.yT.ii), a = function(t, e, n) {
                        return new li(t, e, n);
                  ...
                  case 2:
                    return f.sent(), this.persistence = t.persistence, this.jd = t.jd, this.x_ = t.x_, 
    ...
    t.prototype.T_ = function() {
        if (this.Ra.Ma) throw new I(T.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.pl = function(t) {
        return this.Ra.Ua(), _e("FirestoreClient", "Credential Changed. Current user: " + t.uid), 
        this.cl.pl(t);
    }, 
    ...
    t.prototype.waitForPendingWrites = function() {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return this.T_(), r = new Ke, [ 4 /*yield*/ , this.Ra.enqueue((function() {
                        return e(i, void 0, void 0, (function() {
                            var e, i, o;
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.x_.qu(t) ];

                                  case 1:
                                    return (e = n.sent()) instanceof St ? r.resolve(e) : e instanceof xt ? r.resolve(null) : r.reject(new I(T.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                    [ 3 /*break*/ , 3 ];

                                  case 2:
                                    return i = n.sent(), o = rr(i, "Failed to get document '" + t + " from cache"), 
                    ...
                    return this.T_(), r = new Ke, [ 4 /*yield*/ , this.Ra.enqueue((function() {
                        return e(i, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.x_.Wu(t, 
                                    /* usePreviousResults= */ !0) ];

                                  case 1:
                                    return e = n.sent(), i = new Si(t, e.ju), o = i.yd(e.documents), s = i.Ln(o, 
                                    /* updateLimboDocuments= */ !1), r.resolve(s.snapshot), [ 3 /*break*/ , 3 ];

                                  case 2:
                                    return u = n.sent(), a = rr(u, "Failed to execute query '" + t + " against cache"), 
...
var Xi = /** @class */ function() {
    ...
    return t.prototype.OT = function(t) {
        ...
        return new Yr(Z(t.latitude), Z(t.longitude));
        ...
        var e = $(t), n = new x(e.seconds, e.nanos);
        return this.timestampsInSnapshots ? n : n.toDate();
    }, t.prototype.qT = function(t) {
        var e = P.K(t);
        xe(be(e));
        var n = new Ue(e.get(1), e.get(3)), r = new L(e.M(5));
...
}(), Hi = ur.ou, $i = /** @class */ function() {
    function t(t) {
        var e, n, r, i;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new I(T.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else br("settings", "non-empty string", "host", t.host), this.host = t.host, Tr("settings", "boolean", "ssl", t.ssl), 
        this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (xr("settings", t, [ "host", "ssl", "credentials", "timestampsInSnapshots", "cacheSizeBytes", "experimentalForceLongPolling", "ignoreUndefinedProperties" ]), 
        Tr("settings", "object", "credentials", t.credentials), this.credentials = t.credentials, 
        Tr("settings", "boolean", "timestampsInSnapshots", t.timestampsInSnapshots), Tr("settings", "boolean", "ignoreUndefinedProperties", t.ignoreUndefinedProperties), 
        ...
        Tr("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = ur.uu; else {
            if (t.cacheSizeBytes !== Hi && t.cacheSizeBytes < ur.au) throw new I(T.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + ur.au);
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        Tr("settings", "boolean", "experimentalForceLongPolling", t.experimentalForceLongPolling), 
    ...
    function t(r, i, o) {
        var s = this;
        if (void 0 === o && (o = new Wi), this.jT = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.KT = new nr, this.INTERNAL = {
            delete: function() {
            ...
            var u = r;
            this.jT = u, this.mc = t.HT(u), this.YT = u.name, this.JT = new A(i);
        } else {
            var a = r;
            if (!a.projectId) throw new I(T.INVALID_ARGUMENT, "Must provide projectId");
            this.mc = new Ue(a.projectId, a.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.YT = "[DEFAULT]", this.JT = new _;
        }
        this.XT = o, this.ZT = new $i({});
    }
    return Object.defineProperty(t.prototype, "tE", {
        get: function() {
            return this.eE || (
            // Lazy initialize UserDataReader once the settings are frozen
            this.eE = new ei(this.mc, this.ZT.ignoreUndefinedProperties)), this.eE;
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.settings = function(t) {
        vr("Firestore.settings", arguments, 1), wr("Firestore.settings", "object", 1, t);
        var e = new $i(t);
        if (this.zT && !this.ZT.isEqual(e)) throw new I(T.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
            ...
            switch (t.type) {
              case "gapi":
                ...
                // Make sure this really is a Gapi client.
                                return xe(!("object" != typeof e || null === e || !e.auth || !e.auth.getAuthHeaderValueForFirstParty)), 
                new S(e, t.V || "0");
        ...
        var e, n;
        if (this.zT) throw new I(T.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1, i = !1;
        ...
        i = !!t.experimentalForceOwningTab && t.experimentalForceOwningTab, r && i)) throw new I(T.INVALID_ARGUMENT, "The 'experimentalForceOwningTab' setting cannot be used with 'synchronizeTabs'.");
        ...
        return e(this, void 0, void 0, (function() {
            var t, r = this;
            return n(this, (function(i) {
                if (void 0 !== this.zT && !this.zT.CT) throw new I(T.FAILED_PRECONDITION, "Persistence cannot be cleared after this Firestore instance is initialized.");
                return t = new Ke, [ 2 /*return*/ , (this.KT.xa((function() {
                    return e(r, void 0, void 0, (function() {
                        var e, r;
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return n.trys.push([ 0, 2, , 3 ]), e = this.nE(), [ 4 /*yield*/ , this.XT.clearPersistence(e) ];
        ...
        if (this.GT(), Ji(t)) return this.hE(t);
        ...
        return new Le(this.mc, this.YT, this.ZT.host, this.ZT.ssl, this.ZT.forceLongPolling);
    }, t.prototype.iE = function(t, e) {
        var n = this.nE();
        return this.zT = new Ki(Te.nt(), n, this.JT, this.KT), this.zT.start(t, e);
    }, t.HT = function(t) {
 ...
 */        if (!n || "string" != typeof n) throw new I(T.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        get: function() {
            if (!this.jT) throw new I(T.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.jT;
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.collection = function(t) {
        return vr("Firestore.collection", arguments, 1), wr("Firestore.collection", "non-empty string", 1, t), 
        this.GT(), new ao(P.K(t), this, 
        /* converter= */ null);
    }, t.prototype.doc = function(t) {
        return vr("Firestore.doc", arguments, 1), wr("Firestore.doc", "non-empty string", 1, t), 
        this.GT(), no.oE(P.K(t), this, 
        /* converter= */ null);
    }, t.prototype.collectionGroup = function(t) {
        if (vr("Firestore.collectionGroup", arguments, 1), wr("Firestore.collectionGroup", "non-empty string", 1, t), 
        ...
        return this.GT(), new so(new Pt(P.G, t), this, 
        /* converter= */ null);
    }, t.prototype.runTransaction = function(t) {
        var e = this;
        return vr("Firestore.runTransaction", arguments, 1), wr("Firestore.runTransaction", "function", 1, t), 
        this.GT().transaction((function(n) {
            return t(new to(e, n));
        }));
    }, t.prototype.batch = function() {
        return this.GT(), new eo(this);
        ...
        var e;
        vr("Firestore.setLogLevel", arguments, 1), Nr("setLogLevel", [ "debug", "error", "silent", "warn", "info", "verbose" ], 1, t), 
        e = t, Ie.setLogLevel(e);
    }, 
    ...
    return t.prototype.get = function(t) {
        ...
        var n = lo("Transaction.get", t, this.uE);
        return this.cE.V_([ n.Pc ]).then((function(t) {
            if (!t || 1 !== t.length) return Se();
            var r = t[0];
            if (r instanceof xt) return new io(e.uE, n.Pc, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Vc);
            if (r instanceof St) return new io(e.uE, n.Pc, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Vc);
            throw Se();
        }));
        ...
        var r = lo("Transaction.set", t, this.uE);
        n = co("Transaction.set", n);
        var i = yo(r.Vc, e, "Transaction.set"), o = i[0], s = i[1], u = this.uE.tE.Fc(s, o, n);
        return this.cE.set(r.Pc, u), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return "string" == typeof e || e instanceof qr ? (mr("Transaction.update", arguments, 3), 
        r = lo("Transaction.update", t, this.uE), i = this.uE.tE.Mc("Transaction.update", e, n, o)) : (vr("Transaction.update", arguments, 2), 
        r = lo("Transaction.update", t, this.uE), i = this.uE.tE.kc("Transaction.update", e)), 
        this.cE.update(r.Pc, i), this;
    }, t.prototype.delete = function(t) {
        vr("Transaction.delete", arguments, 1);
        var e = lo("Transaction.delete", t, this.uE);
    ...
    return t.prototype.set = function(t, e, n) {
        gr("WriteBatch.set", arguments, 2, 3), this.dE();
        var r = lo("WriteBatch.set", t, this.uE);
        n = co("WriteBatch.set", n);
        var i = yo(r.Vc, e, "WriteBatch.set"), o = i[0], s = i[1], u = this.uE.tE.Fc(s, o, n);
        return this._E = this._E.concat(u.gc(r.Pc, yt.ft())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.dE(), "string" == typeof e || e instanceof qr ? (mr("WriteBatch.update", arguments, 3), 
        r = lo("WriteBatch.update", t, this.uE), i = this.uE.tE.Mc("WriteBatch.update", e, n, o)) : (vr("WriteBatch.update", arguments, 2), 
        r = lo("WriteBatch.update", t, this.uE), i = this.uE.tE.kc("WriteBatch.update", e)), 
        this._E = this._E.concat(i.gc(r.Pc, yt.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        vr("WriteBatch.delete", arguments, 1), this.dE();
        var e = lo("WriteBatch.delete", t, this.uE);
        return this._E = this._E.concat(new Et(e.Pc, yt.ft())), this;
    }, t.prototype.commit = function() {
        return this.dE(), this.lE = !0, this._E.length > 0 ? this.uE.GT().write(this._E) : Promise.resolve();
    }, t.prototype.dE = function() {
        if (this.lE) throw new I(T.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), no = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, n.mc, t, r) || this).Pc = t, i.firestore = n, i.Vc = r, 
        i.zT = i.firestore.GT(), i;
    }
    return t(n, e), n.oE = function(t, e, r) {
        if (t.length % 2 != 0) throw new I(T.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t.j() + " has " + t.length);
        ...
        get: function() {
            return new ao(this.Pc.path.$(), this.firestore, this.Vc);
        },
        enumerable: !0,
        configurable: !0
        ...
        if (vr("DocumentReference.collection", arguments, 1), wr("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new I(T.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = P.K(t);
        return new ao(this.Pc.path.child(e), this.firestore, 
        /* converter= */ null);
    }, n.prototype.isEqual = function(t) {
        if (!(t instanceof n)) throw Rr("isEqual", "DocumentReference", 1, t);
        return this.firestore === t.firestore && this.Pc.isEqual(t.Pc) && this.Vc === t.Vc;
    }, n.prototype.set = function(t, e) {
        gr("DocumentReference.set", arguments, 1, 2), e = co("DocumentReference.set", e);
        var n = yo(this.Vc, t, "DocumentReference.set"), r = n[0], i = n[1], o = this.firestore.tE.Fc(i, r, e);
        return this.zT.write(o.gc(this.Pc, yt.ft()));
    }, n.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof qr ? (mr("DocumentReference.update", arguments, 2), 
        n = this.firestore.tE.Mc("DocumentReference.update", t, e, r)) : (vr("DocumentReference.update", arguments, 1), 
        n = this.firestore.tE.kc("DocumentReference.update", t)), this.zT.write(n.gc(this.Pc, yt.exists(!0)));
    }, n.prototype.delete = function() {
        return vr("DocumentReference.delete", arguments, 0), this.zT.write([ new Et(this.Pc, yt.ft()) ]);
        ...
        "object" != typeof t[i] || Ji(t[i]) || (xr("DocumentReference.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        Tr("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++);
        var o = {
            includeMetadataChanges: r.includeMetadataChanges
        };
        return Ji(t[i]) ? n = t[i] : (wr("DocumentReference.onSnapshot", "function", i, t[i]), 
        Er("DocumentReference.onSnapshot", "function", i + 1, t[i + 1]), Er("DocumentReference.onSnapshot", "function", i + 2, t[i + 2]), 
        n = {
            next: t[i],
            error: t[i + 1],
            complete: t[i + 2]
        ...
        var i = new Yi({
            next: function(t) {
                if (e.next) {
                    ...
                    e.next(new io(n.firestore, n.Pc, r, t.fromCache, t.hasPendingWrites, n.Vc));
                }
            },
            error: r
        }), o = this.zT.listen(Pt.Wt(this.Pc.path), i, t);
        return function() {
            i.MT(), n.zT.al(o);
        };
    }, n.prototype.get = function(t) {
        var e = this;
        return gr("DocumentReference.get", arguments, 0, 1), fo("DocumentReference.get", t), 
        new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.GT().FT(e.Pc).then((function(t) {
                n(new io(e.firestore, e.Pc, t, 
                /*fromCache=*/ !0, t instanceof St && t.At, e.Vc));
            }), r) : e.TE(n, r, t);
        }));
    ...
    return t.prototype.data = function(t) {
        var e = this;
        if (gr("DocumentSnapshot.data", arguments, 0, 1), t = ho("DocumentSnapshot.data", t), 
        this.EE) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.Vc) {
                var n = new oo(this.uE, this.Pc, this.EE, this.IE, this.wE, 
                /* converter= */ null);
                return this.Vc.fromFirestore(n, t);
            }
            return new Xi(this.uE.mc, this.uE.aE(), t.serverTimestamps || "none", (function(t) {
                return new no(t, e.uE, /* converter= */ null);
            })).OT(this.EE.xt());
        }
    }, t.prototype.get = function(t, e) {
        var n = this;
        if (gr("DocumentSnapshot.get", arguments, 1, 2), e = ho("DocumentSnapshot.get", e), 
        this.EE) {
            var r = this.EE.data().field(si("DocumentSnapshot.get", t));
            if (null !== r) return new Xi(this.uE.mc, this.uE.aE(), e.serverTimestamps || "none", (function(t) {
                return new no(t, n.uE, n.Vc);
            })).OT(r);
        }
        ...
        get: function() {
            return new no(this.Pc, this.uE, this.Vc);
        },
        enumerable: !0,
        configurable: !0
        ...
        get: function() {
            return new ro(this.wE, this.IE);
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw Rr("isEqual", "DocumentSnapshot", 1, e);
...
}(io), so = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, n.mc, n.tE, t) || this).RE = t, i.firestore = n, i.Vc = r, 
        i;
    }
    return t(n, e), n.prototype.where = function(t, e, r) {
        vr("Query.where", arguments, 3), Sr("Query.where", 3, r);
        // Enumerated from the WhereFilterOp type in index.d.ts.
        var i = Nr("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ ], 2, e), o = si("Query.where", t), s = this.AE(o, i, r);
        return new n(this.RE.Gt(s), this.firestore, this.Vc);
    }, n.prototype.orderBy = function(t, e) {
        var r;
        if (gr("Query.orderBy", arguments, 1, 2), Er("Query.orderBy", "non-empty string", 2, e), 
        void 0 === e || "asc" === e) r = "asc" /* ASCENDING */; else {
            if ("desc" !== e) throw new I(T.INVALID_ARGUMENT, "Function Query.orderBy() has unknown direction '" + e + "', expected 'asc' or 'desc'.");
            r = "desc" /* DESCENDING */;
        }
        var i = si("Query.orderBy", t), o = this.gE(i, r);
        return new n(this.RE.zt(o), this.firestore, this.Vc);
    }, n.prototype.limit = function(t) {
        return vr("Query.limit", arguments, 1), wr("Query.limit", "number", 1, t), kr("Query.limit", 1, t), 
        new n(this.RE.Ht(t), this.firestore, this.Vc);
    }, n.prototype.limitToLast = function(t) {
        return vr("Query.limitToLast", arguments, 1), wr("Query.limitToLast", "number", 1, t), 
        kr("Query.limitToLast", 1, t), new n(this.RE.Yt(t), this.firestore, this.Vc);
    }, n.prototype.startAt = function(t) {
        for (var e = [], r = 1; r < arguments.length; r++) e[r - 1] = arguments[r];
        mr("Query.startAt", arguments, 1);
        var i = this.DE("Query.startAt", t, e, 
        /*before=*/ !0);
        return new n(this.RE.Jt(i), this.firestore, this.Vc);
    }, n.prototype.startAfter = function(t) {
        for (var e = [], r = 1; r < arguments.length; r++) e[r - 1] = arguments[r];
        mr("Query.startAfter", arguments, 1);
        var i = this.DE("Query.startAfter", t, e, 
        /*before=*/ !1);
        return new n(this.RE.Jt(i), this.firestore, this.Vc);
    }, n.prototype.endBefore = function(t) {
        for (var e = [], r = 1; r < arguments.length; r++) e[r - 1] = arguments[r];
        mr("Query.endBefore", arguments, 1);
        var i = this.DE("Query.endBefore", t, e, 
        /*before=*/ !0);
        return new n(this.RE.Xt(i), this.firestore, this.Vc);
    }, n.prototype.endAt = function(t) {
        for (var e = [], r = 1; r < arguments.length; r++) e[r - 1] = arguments[r];
        mr("Query.endAt", arguments, 1);
        var i = this.DE("Query.endAt", t, e, 
        /*before=*/ !1);
        return new n(this.RE.Xt(i), this.firestore, this.Vc);
    }, n.prototype.isEqual = function(t) {
        if (!(t instanceof n)) throw Rr("isEqual", "Query", 1, t);
        return this.firestore === t.firestore && this.RE.isEqual(t.RE) && this.Vc === t.Vc;
    }, n.prototype.withConverter = function(t) {
        return new n(this.RE, this.firestore, t);
    }, 
    /** Helper function to create a bound from a document or fields */ n.prototype.DE = function(t, e, n, i) {
        if (Sr(t, 1, e), e instanceof io) return vr(t, r([ e ], n), 1), this.yE(t, e.EE, i);
        var o = [ e ].concat(n);
        ...
        var n, r = {}, i = 0;
        return "object" != typeof t[i] || Ji(t[i]) || (xr("Query.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        Tr("Query.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++), Ji(t[i]) ? n = t[i] : (wr("Query.onSnapshot", "function", i, t[i]), Er("Query.onSnapshot", "function", i + 1, t[i + 1]), 
        Er("Query.onSnapshot", "function", i + 2, t[i + 2]), n = {
            next: t[i],
            error: t[i + 1],
            complete: t[i + 2]
        ...
        var i = new Yi({
            next: function(t) {
                e.next && e.next(new uo(n.firestore, n.RE, t, n.Vc));
            },
            error: r
        ...
        var e = this;
        return gr("Query.get", arguments, 0, 1), fo("Query.get", t), this.vE(this.RE), new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.GT().NT(e.RE).then((function(t) {
                n(new uo(e.firestore, e.RE, t, e.Vc));
            }), r) : e.TE(n, r, t);
        }));
    }, n.prototype.TE = function(t, e, n) {
        var r = this.fE({
    ...
    return t.prototype.AE = function(t, e, n) {
        var r;
        if (t.Y()) {
            if ("array-contains" /* ARRAY_CONTAINS */ === e || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e) throw new I(T.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + e + "' queries on FieldPath.documentId().");
            if ("in" /* IN */ === e) {
                this.mE(n, e);
        ...
        /** allowArrays = */ "in" /* IN */ === e);
        var a = Vt.create(t, e, r);
        return this.VE(a), a;
    }, t.prototype.gE = function(t, e) {
        if (null !== this.RE.startAt) throw new I(T.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.RE.endAt) throw new I(T.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
        var n = new Mt(t, e);
        return this.pE(n), n;
    }, 
    /**
    ...
    t.prototype.yE = function(t, e, n) {
        if (!e) throw new I(T.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + t + "().");
        ...
        for (var r = [], i = 0, o = this.RE.orderBy; i < o.length; i++) {
            var s = o[i];
            if (s.field.Y()) r.push(et(this.mc, e.key)); else {
                var u = e.field(s.field);
                if (z(u)) throw new I(T.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + s.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === u) {
                    var a = s.field.j();
                    throw new I(T.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + a + "' (used as the orderBy) does not exist.");
                }
                r.push(u);
            }
        }
    ...
    t.prototype.bE = function(t, e, n) {
        ...
        for (var i = [], o = 0; o < e.length; o++) {
            ...
            if (r[o].field.Y()) {
                ...
                if (!this.RE._e() && -1 !== s.indexOf("/")) throw new I(T.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + t + "() must be a plain document ID, but '" + s + "' contains a slash.");
                var u = this.RE.path.child(P.K(s));
                ...
                var c = this.tE.xc(t, s);
                i.push(c);
            }
        }
        return new jt(i, n);
    }, t.prototype.vE = function(t) {
        if (t.ae() && 0 === t.Lt.length) throw new I(T.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
    }, 
    /**
    ...
    t.prototype.PE = function(t) {
        if ("string" == typeof t) {
            ...
            if (!this.RE._e() && -1 !== t.indexOf("/")) throw new I(T.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + t + "' contains a '/' character.");
            var e = this.RE.path.child(P.K(t));
            ...
            return et(this.mc, new L(e));
        }
        if (t instanceof Xr) return et(this.mc, t.Pc);
    ...
    function t(t, e, n, r) {
        ...
        this.metadata = new ro(n.hasPendingWrites, n.fromCache);
    }
    return Object.defineProperty(t.prototype, "docs", {
        ...
        var n = this;
        gr("QuerySnapshot.forEach", arguments, 1, 2), wr("QuerySnapshot.forEach", "function", 1, t), 
        this.FE.docs.forEach((function(r) {
            t.call(e, n.ME(r));
        }));
    }, Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new so(this.CE, this.uE, this.Vc);
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.docChanges = function(t) {
        t && (xr("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), Tr("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
        var e = !(!t || !t.includeMetadataChanges);
        if (e && this.FE.hs) throw new I(T.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function(t, e, n, r) {
            if (n.ss.B()) {
                ...
                return n.docChanges.map((function(e) {
                    var o = new oo(t, e.doc.key, e.doc, n.fromCache, n.ns.has(e.doc.key), r);
                    return e.doc, {
                        type: "added",
                        doc: o,
                        oldIndex: -1,
            ...
            return n.docChanges.filter((function(t) {
                ...
                var i = new oo(t, e.doc.key, e.doc, n.fromCache, n.ns.has(e.doc.key), r), s = -1, u = -1;
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw Rr("isEqual", "QuerySnapshot", 1, e);
        return this.uE === e.uE && this.CE.isEqual(e.CE) && this.FE.isEqual(e.FE) && this.Vc === e.Vc;
    }, t.prototype.ME = function(t) {
        return new oo(this.uE, t.key, t, this.metadata.fromCache, this.FE.ns.has(t.key), this.Vc);
    }, t;
}(), ao = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, Pt.Wt(t), n, r) || this).xE = t, t.length % 2 != 1) throw new I(T.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.j() + " has " + t.length);
        return i;
    }
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            var t = this.RE.path.$();
            return t.B() ? null : new no(new L(t), this.firestore, 
            /* converter= */ null);
        },
        enumerable: !0,
        configurable: !0
        ...
        gr("CollectionReference.doc", arguments, 0, 1), 
        // We allow omission of 'pathString' but explicitly prohibit passing in both
        // 'undefined' and 'null'.
        0 === arguments.length && (t = ke.cn()), wr("CollectionReference.doc", "non-empty string", 1, t);
        var e = P.K(t);
        return no.oE(this.RE.path.child(e), this.firestore, this.Vc);
    }, n.prototype.add = function(t) {
        vr("CollectionReference.add", arguments, 1), wr("CollectionReference.add", "object", 1, this.Vc ? this.Vc.toFirestore(t) : t);
        var e = this.doc();
...
function co(t, e) {
    ...
    if (xr(t, e, [ "merge", "mergeFields" ]), Tr(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
...
function ho(t, e) {
    return void 0 === e ? {} : (xr(t, e, [ "serverTimestamps" ]), Ir(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function fo(t, e) {
    Er(t, "object", 1, e), e && (xr(t, e, [ "source" ]), Ir(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
function lo(t, e, n) {
    ...
    throw Rr(t, "DocumentReference", 1, e);
}
...
var mo = vo(Zi, "Use firebase.firestore() instead."), go = vo(to, "Use firebase.firestore().runTransaction() instead."), wo = vo(eo, "Use firebase.firestore().batch() instead."), Eo = vo(no, "Use firebase.firestore().doc() instead."), bo = vo(io), To = vo(oo), Io = vo(so), No = vo(uo), _o = vo(ao, "Use firebase.firestore().collection() instead."), Ao = vo(Qr, "Use FieldValue.<field>() instead."), Do = vo(Ur, "Use Blob.fromUint8Array() or Blob.fromBase64String() instead."), So = {
    Firestore: mo,
    GeoPoint: Yr,
    Timestamp: x,
    Blob: Do,
    ...
    return t.prototype.Q_ = function(t) {
        ...
        _e("ConnectivityMonitor", "Network connectivity changed: AVAILABLE");
        for (var t = 0, e = this.qE; t < e.length; t++) {
            (0, e[t])(0 /* AVAILABLE */);
        }
    }, t.prototype.BE = function() {
        _e("ConnectivityMonitor", "Network connectivity changed: UNAVAILABLE");
        for (var t = 0, e = this.qE; t < e.length; t++) {
            (0, e[t])(1 /* UNAVAILABLE */);
        }
    }, 
    ...
    Commit: "commit"
}, Vo = "gl-js/ fire/" + E, Oo = /** @class */ function() {
    function t(t) {
        this.ii = t.ii;
     ...
     */    return t.prototype.XE = function(t, e) {
                ...
                try {
                    switch (u.getLastErrorCode()) {
                      case m.NO_ERROR:
                        ...
                        _e("Connection", "XHR received:", JSON.stringify(e)), o(e);
                        break;

                      case m.TIMEOUT:
                        _e("Connection", 'RPC "' + t + '" timed out'), s(new I(T.DEADLINE_EXCEEDED, "Request time out"));
                        break;

                      case m.HTTP_ERROR:
                        var n = u.getStatus();
                        if (_e("Connection", 'RPC "' + t + '" failed with status:', n, "response text:", u.getResponseText()), 
                        n > 0) {
                        ...
                        _e("Connection", 'RPC "' + t + '" failed'), s(new I(T.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var n = [ this.JE, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], i = g(), o = {
        ...
        this.XE(o.initMessageHeaders, e), 
        ...
        var u = n.join("");
        _e("Connection", "Creating WebChannel: " + u + " " + o);
        var d = i.createWebChannel(u, o), y = !1, v = !1, m = new ko({
            QE: function(t) {
                v ? _e("Connection", "Not sending because WebChannel is closed:", t) : (y || (_e("Connection", "Opening WebChannel transport."), 
                d.open(), y = !0), _e("Connection", "WebChannel sending:", t), d.send(t));
            },
            WE: function() {
                return d.close();
            }
        ...
        return b(w.EventType.OPEN, (function() {
            v || _e("Connection", "WebChannel transport opened.");
        })), b(w.EventType.CLOSE, (function() {
            v || (v = !0, _e("Connection", "WebChannel transport closed"), m.HE());
        })), b(w.EventType.ERROR, (function(t) {
            v || (v = !0, function(t) {
                for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
                if (Ie.logLevel <= s.WARN) {
                    var i = e.map(De);
                    Ie.warn.apply(Ie, r([ "Firestore (" + E + "): " + t ], i));
                }
            }("Connection", "WebChannel transport errored:", t), m.HE(new I(T.UNAVAILABLE, "The operation could not be completed")));
        })), b(w.EventType.MESSAGE, (function(t) {
            var e;
            if (!v) {
                var n = t.data[0];
                xe(!!n);
                ...
                if (i) {
                    _e("Connection", "WebChannel received error:", i);
                    ...
                    v = !0, m.HE(new I(s, u)), d.close();
                } else _e("Connection", "WebChannel received:", n), m.YE(n);
            }
        })), setTimeout((function() {
 ...
 */
    !function(t, e) {
        t.INTERNAL.registerComponent(new d("firestore", (function(t) {
            return function(t, e) {
                return new Zi(t, e, new Qi);
            }(t.getProvider("app").getImmediate(), t.getProvider("auth-internal"));
        }), "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, So)));
    }(t), t.registerVersion("@firebase/firestore", "1.15.2")
    /**
 * @license
 * Copyright 2017 Google LLC
 *
...
Te.an(new (/** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "document", {
        ...
        return Promise.resolve(new Oo(t));
    }, t.prototype.pT = function() {
        return Ro.zh() ? new Ro : new xo;
...
export { Lo as __PRIVATE_registerFirestore };
